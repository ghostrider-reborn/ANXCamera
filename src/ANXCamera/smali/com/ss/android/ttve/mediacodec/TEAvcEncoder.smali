...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->FORCE_FAILED:Z

    const-class v1, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;

    invoke-virtual {v1}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v1

    sput-object v1, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->TAG:Ljava/lang/String;

    const/4 v1, 0x7

    sput v1, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->MIN_FRAME_RATE:I

    const/16 v1, 0x7d0

    sput v1, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->MAX_FRAME_RATE:I
...
.method private addOutputData([BLandroid/media/MediaCodec$BufferInfo;)V
    ...
    const-string p2, "encode: no available pts!!!"
    ...
    iput-wide v6, v2, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder$CodecData;->pts:J
    ...
    invoke-virtual {p1, v2}, Ljava/util/concurrent/ArrayBlockingQueue;->add(Ljava/lang/Object;)Z
    :try_end_0
...
.method private drainOutputBuffer(J)I
    ...
    :goto_1
    invoke-direct {p0, v2, v0}, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->addOutputData([BLandroid/media/MediaCodec$BufferInfo;)V
...
.method private reconfigureMediaFormat(Landroid/media/MediaCodecInfo;)I
    ...
    iget v3, p0, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->m_height:I
    ...
    iget v3, p0, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->m_colorFormat:I
    ...
    const-string/jumbo v0, "width:[%d] height:[%d] frameRate:[%d] iFrameInternal:[%d] bitRate:[%d] colorFormat:[%d]"
    ...
    iget v4, p0, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->m_frameRate:I
...
.method public encodeVideoFromTexture(IJZ)I
    ...
    const-string/jumbo v6, "video-bitrate"

    iget v7, v1, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->m_bitRate:I
...
.method public getInfoByFlag([II)I
    ...
    iget-object p2, p0, Lcom/ss/android/ttve/mediacodec/TEAvcEncoder;->m_lastCodecData:Lcom/ss/android/ttve/mediacodec/TEAvcEncoder$CodecData;
...
.method public startEncoder()I
    ...
    const-string/jumbo v1, "startEncoder..."
