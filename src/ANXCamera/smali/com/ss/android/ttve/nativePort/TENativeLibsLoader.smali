...
.method public static declared-synchronized loadLibrary()V
    ...
    const-string/jumbo v2, "ttyuv"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string/jumbo v2, "tt_effect"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string/jumbo v2, "ttvebase"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string/jumbo v2, "ttvideorecorder"
    ...
    const-string v2, "ffmpeg-invoker"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string v2, "ffmpeg-main"
    ...
    const-string/jumbo v2, "ttffmpeg-main"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string/jumbo v2, "ttSDL2"

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string/jumbo v2, "ttmain"
    ...
    const-string/jumbo v2, "ttvideoeditor-import"
    ...
    :cond_3
    const-string/jumbo v2, "ttvideoeditor"
