...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/ss/android/medialib/FaceBeautyInvoker;->sSlamDetectListeners:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iget-object v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mAVCEncoderInterface:Lcom/ss/android/medialib/AVCEncoderInterface;
...
.method private isRenderReady()Z
    ...
    iget-boolean v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mIsRenderRady:Z
...
.method private onNativeCallback_Init(I)V
    ...
    :goto_0
    iget-object v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mNativeInitListener:Lcom/ss/android/medialib/listener/NativeInitListener;
...
.method public createEncoder()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/medialib/AVCEncoder;->createEncoder()V
...
.method public destroyMessageCenter()V
    ...
    :try_start_0
    sput-object v1, Lcom/ss/android/medialib/FaceBeautyInvoker;->sMessageListener:Lcom/bef/effectsdk/message/MessageCenter$Listener;
...
.method public getEnigmaResult()Lcom/ss/android/medialib/model/EnigmaResult;
    ...
    invoke-direct {p0, v0, v1}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeGetEnigmaResult(J)Lcom/ss/android/medialib/model/EnigmaResult;
...
.method public getTextureDeltaTime(Z)J
    ...
    iget-object v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mTextureTimeListener:Lcom/ss/android/medialib/listener/TextureTimeListener;
...
.method public initAudioPlayer(Landroid/content/Context;Ljava/lang/String;JZZ)I
    ...
    invoke-direct {p1, p6, v0}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_1
    const-string p6, "FaceBeautyInvoker"

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "nativeSampleRate ? "
    ...
    const-string v1, " nativeSamleBufferSize? "
    ...
    invoke-static {p6, v0}, Lcom/ss/android/vesdk/VELogUtil;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public initDuet(Ljava/lang/String;FFFZ)V
    ...
    invoke-direct/range {v1 .. v8}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeInitDuet(JLjava/lang/String;FFFZ)I
...
.method public initFaceBeautyPlay(IILjava/lang/String;IILjava/lang/String;IZ)I
    ...
    invoke-direct {v13}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeCreate()J

    move-result-wide v0

    iput-wide v0, v13, Lcom/ss/android/medialib/FaceBeautyInvoker;->mHandler:J

    invoke-virtual {v13}, Lcom/ss/android/medialib/FaceBeautyInvoker;->initMessageCenter()V
    ...
    invoke-direct {v13, v1, v2, v3}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeExpandPreviewAndRecordInterval(JZ)I
...
.method public onDuetVideoComplete()V
    ...
    iget-object v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mDuetCompleteRunable:Ljava/lang/Runnable;
    ...
    :cond_0
    sget-object v0, Lcom/ss/android/medialib/FaceBeautyInvoker;->sDuetCompleteRunable:Ljava/lang/Runnable;
...
.method public onFirstFrameRenderInfo(ID)V
    ...
    const-string/jumbo p1, "te_preview_first_frame_screen_time"
    ...
    const-string v1, "Camera Preview First Frame Cost: "
    ...
    invoke-static {p1, p2}, Lcom/ss/android/medialib/common/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo p1, "te_preview_switch_camera_screen_time"
    ...
    const-string v1, "Camera Change Cost: "
...
.method public onMessageReceived(IIILjava/lang/String;)V
    ...
    :try_start_0
    sget-object v1, Lcom/ss/android/medialib/FaceBeautyInvoker;->sMessageListener:Lcom/bef/effectsdk/message/MessageCenter$Listener;
...
.method public onNativeCallback_onFaceDetect(II)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mFaceDetectListener:Lcom/ss/android/medialib/listener/FaceDetectListener;
...
.method public onNativeCallback_onOpenGLRunning(D)I
    ...
    const-string v2, "onNativeCallback_onOpenGLRunning, timestamp = "
    ...
    :goto_0
    iget-object v1, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mGetTimestampCallback:Lcom/ss/android/medialib/common/Common$IGetTimestampCallback;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mGetTimestampCallback:Lcom/ss/android/medialib/common/Common$IGetTimestampCallback;

    invoke-interface {v1, p1, p2}, Lcom/ss/android/medialib/common/Common$IGetTimestampCallback;->getTimestamp(D)V
...
.method public onNativeCallback_onSlamDetect(Z)V
    ...
    const-class v1, Lcom/ss/android/medialib/FaceBeautyInvoker;

    monitor-enter v1

    :try_start_0
    sget-object v2, Lcom/ss/android/medialib/FaceBeautyInvoker;->sSlamDetectListeners:Ljava/util/List;
...
.method public onNativeRecordStop()V
    ...
    sget-object v0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mRecordStopCallback:Lcom/ss/android/medialib/FaceBeautyInvoker$RecordStopCallback;

    if-eqz v0, :cond_0

    sget-object v0, Lcom/ss/android/medialib/FaceBeautyInvoker;->mRecordStopCallback:Lcom/ss/android/medialib/FaceBeautyInvoker$RecordStopCallback;

    invoke-interface {v0}, Lcom/ss/android/medialib/FaceBeautyInvoker$RecordStopCallback;->onStop()V
...
.method public recoverCherEffect([Ljava/lang/String;[D[Z)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeRecoverCherEffect(J[Ljava/lang/String;[D[Z)V
...
.method public sendEffectMsg(IJJLjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeSendEffectMsg(JIJJLjava/lang/String;)V
...
.method public setReactionPosMargin(IIII)V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeSetReactionPosMargin(JIIII)V
...
.method public slamProcessIngestAcc(DDDD)I
    ...
    invoke-direct {v0}, Lcom/ss/android/medialib/FaceBeautyInvoker;->isRenderReady()Z
    ...
    invoke-direct/range {v0 .. v10}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeSlamProcessIngestAcc(JDDDD)I
...
.method public slamProcessIngestGra(DDDD)I
    ...
    invoke-direct/range {v0 .. v10}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeSlamProcessIngestGra(JDDDD)I
...
.method public slamProcessIngestGyr(DDDD)I
    ...
    invoke-direct/range {v0 .. v10}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeSlamProcessIngestGyr(JDDDD)I
...
.method public startPlay(Landroid/view/Surface;Ljava/lang/String;II)I
    ...
    invoke-direct/range {v0 .. v6}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeStartPlay(JLandroid/view/Surface;IILjava/lang/String;)I
...
.method public startRecord(DZFII)I
    ...
    invoke-direct/range {v0 .. v8}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeStartRecord(JDZIII)I
...
.method public updateRotation(FFF)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/ss/android/medialib/FaceBeautyInvoker;->nativeUpdateRotation(JFFF)V
