...
.field private static mGLVersion:I
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/ss/android/medialib/common/SharedContext;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/ss/android/medialib/common/SharedContext;->LOG_TAG:Ljava/lang/String;

    const/16 v0, 0x8

    sput v0, Lcom/ss/android/medialib/common/SharedContext;->mBitsR:I

    sput v0, Lcom/ss/android/medialib/common/SharedContext;->mBitsG:I

    sput v0, Lcom/ss/android/medialib/common/SharedContext;->mBitsB:I

    sput v0, Lcom/ss/android/medialib/common/SharedContext;->mBitsA:I

    const/4 v0, 0x3

    sput v0, Lcom/ss/android/medialib/common/SharedContext;->mGLVersion:I
...
.method private initEGL(Landroid/opengl/EGLContext;IIILjava/lang/Object;)Z
    ...
    const-string v1, "eglGetDisplay() returned error 0x%x"
    ...
    const-string v1, "eglInitialize() returned error 0x%x"
    ...
    const-string v11, "eglInitialize - major: %d, minor: %d"
    ...
    :cond_5
    sget-object v7, Lcom/ss/android/medialib/common/SharedContext;->LOG_TAG:Ljava/lang/String;

    const-string v10, "Config num: %d, has sharedContext: %s"
    ...
    invoke-static {v7, v3}, Lcom/ss/android/vesdk/VELogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v7, v0, Lcom/ss/android/medialib/common/SharedContext;->mConfig:Landroid/opengl/EGLConfig;

    invoke-static {v3, v7, v2, v4, v6}, Landroid/opengl/EGL14;->eglCreateContext(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;
    ...
    iget-object v2, v0, Lcom/ss/android/medialib/common/SharedContext;->mSurface:Landroid/opengl/EGLSurface;

    iget-object v3, v0, Lcom/ss/android/medialib/common/SharedContext;->mSurface:Landroid/opengl/EGLSurface;
...
.method public getConfigAttrib(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/ss/android/medialib/common/SharedContext;->mConfig:Landroid/opengl/EGLConfig;

    const/4 v3, 0x0

    invoke-static {v1, v2, p1, v0, v3}, Landroid/opengl/EGL14;->eglGetConfigAttrib(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;I[II)Z
...
.method public makeCurrent()V
    ...
    iget-object v2, p0, Lcom/ss/android/medialib/common/SharedContext;->mSurface:Landroid/opengl/EGLSurface;

    iget-object v3, p0, Lcom/ss/android/medialib/common/SharedContext;->mContext:Landroid/opengl/EGLContext;
