...
.field private mRecorderInterface:Lorg/a/a/a;
...
# direct methods
.method public constructor <init>(Lorg/a/a/a;Lcom/ss/android/medialib/audio/AudioDataProcessThread$OnProcessDataListener;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/ss/android/medialib/audio/AudioDataProcessThread;->mRecorderInterface:Lorg/a/a/a;
...
.method private handleStartFeeding(IID)V
    ...
    iget-object v0, p0, Lcom/ss/android/medialib/audio/AudioDataProcessThread;->mRecorderInterface:Lorg/a/a/a;
    ...
    const-string v2, "handleStartFeeding() called with: sampleRateInHz = ["
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lorg/a/a/a;->initWavFile(IID)I
...
.method private handleStopFeeding()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/ss/android/medialib/audio/AudioDataProcessThread;->mRecorderInterface:Lorg/a/a/a;
    ...
    invoke-interface {v1, v2}, Lorg/a/a/a;->closeWavFile(Z)I
...
.method public feed([BI)V
    ...
    invoke-virtual {v2, v3, p2, v4, p1}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public start()V
    ...
    const-string/jumbo v2, "thread already running"
...
.method public startFeeding(ID)V
    ...
    const-string/jumbo v1, "startFeeding"
    ...
    invoke-virtual {v2, v1, p1, p3, p2}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public stop()V
    ...
    invoke-virtual {v2, v3}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public stopFeeding()V
    ...
    const-string/jumbo v1, "stopFeeding"
    ...
    invoke-virtual {v1, v2}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public waitUtilAudioProcessDone()V
    ...
    invoke-virtual {v2, v3}, Lcom/ss/android/medialib/audio/AudioDataProcessThread$ProcessHandler;->hasMessages(I)Z
    ...
    const-string/jumbo v2, "waiting audio process start"
    ...
    const-string/jumbo v2, "waiting audio process done"
