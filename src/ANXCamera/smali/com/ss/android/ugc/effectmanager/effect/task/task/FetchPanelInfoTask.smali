...
.method private buildEffectListRequest()Lcom/ss/android/ugc/effectmanager/common/EffectRequest;
    ...
    iget-object v2, p0, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->category:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "cursor"

    iget v2, p0, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->cursor:I
    ...
    iget v2, p0, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->count:I
...
.method private saveEffectList(Lcom/ss/android/ugc/effectmanager/effect/model/net/PanelInfoResponse;)V
    ...
    invoke-static {v1}, Lcom/ss/android/ugc/effectmanager/common/utils/EffectCacheKeyGenerator;->generatePanelInfoVersionKey(Ljava/lang/String;)Ljava/lang/String;
...
.method public execute()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->isCanceled()Z
    ...
    invoke-virtual {p0, v2, v4}, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->sendMessage(ILcom/ss/android/ugc/effectmanager/common/task/BaseTaskResult;)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->sendMessage(ILcom/ss/android/ugc/effectmanager/common/task/BaseTaskResult;)V
    :try_end_0
    ...
    invoke-virtual {p0, v2, v0}, Lcom/ss/android/ugc/effectmanager/effect/task/task/FetchPanelInfoTask;->sendMessage(ILcom/ss/android/ugc/effectmanager/common/task/BaseTaskResult;)V
