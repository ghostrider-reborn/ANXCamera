...
.method public isCanceled()Z
    ...
    iget-boolean v0, p0, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;->mCanceled:Z
...
.method public onFailed(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;Lcom/ss/android/ugc/effectmanager/common/task/ExceptionResult;)V
    ...
    iget-object v0, p0, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;->mSyncTaskListener:Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;->mSyncTaskListener:Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;

    invoke-interface {v0, p1, p2}, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;->onFailed(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;Lcom/ss/android/ugc/effectmanager/common/task/ExceptionResult;)V
...
.method public onFinally(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;)V
    ...
    invoke-interface {v0, p1}, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;->onFinally(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;)V
...
.method public onResponse(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;->onResponse(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;Ljava/lang/Object;)V
...
.method public onStart(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;)V
    ...
    invoke-interface {v0, p1}, Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTaskListener;->onStart(Lcom/ss/android/ugc/effectmanager/effect/sync/SyncTask;)V
