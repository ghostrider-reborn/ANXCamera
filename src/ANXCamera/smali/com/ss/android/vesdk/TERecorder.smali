...
.field private mAudioRecorder:Lorg/a/a/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/vesdk/TERecorder;->TAG:Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Landroid/content/Context;Landroid/os/Handler;)V
    ...
    const-string/jumbo p2, "workspace can\'t be null or empty String"
...
.method private attachNativeInvoker()V
    ...
    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder;->mSlamDetectListener:Lcom/ss/android/medialib/listener/SlamDetectListener;

    invoke-static {v0}, Lcom/ss/android/medialib/FaceBeautyInvoker;->addSlamDetectListener(Lcom/ss/android/medialib/listener/SlamDetectListener;)V
...
.method private checkCameraSettingsChange(Lcom/ss/android/vesdk/VECameraSettings;)Z
    ...
    invoke-virtual {v1}, Lcom/ss/android/vesdk/VECameraSettings;->getSize()Lcom/ss/android/vesdk/VESize;
...
.method private detachNavieInvoer()V
    ...
    invoke-static {v0}, Lcom/ss/android/medialib/FaceBeautyInvoker;->removeSlamDetectListener(Lcom/ss/android/medialib/listener/SlamDetectListener;)V
...
.method private determineCurrentAudioOption()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder;->mBGMPath:Ljava/lang/String;
...
.method private getRotation(Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FACING_ID;)I
    ...
    iget-object p1, p0, Lcom/ss/android/vesdk/TERecorder;->mCameraSettings:Lcom/ss/android/vesdk/VECameraSettings;
...
.method private initAudioPlayerIfNeed(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/ss/android/medialib/FaceBeautyInvoker;->setUseMusic(I)V
    ...
    const-string v0, "Illegal state. BGM path is empty. when current audio option is PLAY_OPENSL"
...
.method private initAudioRecorderIfNeed(I)V
    ...
    iget-object p1, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;
    ...
    invoke-direct {p1, p0}, Lorg/a/a/b;-><init>(Lorg/a/a/a;)V

    iput-object p1, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    iget-object p1, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    invoke-virtual {p1, v0}, Lorg/a/a/b;->init(I)V
...
.method private initNativeInvokerWithSettings(Lcom/ss/android/vesdk/VEVideoEncodeSettings;Lcom/ss/android/vesdk/VEPreviewSettings;)I
    ...
    const-string v1, "NativeInvoker init Failed. ret = "
...
.method private releaseAudioComponentIfNeed()V
    ...
    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    invoke-virtual {v0}, Lorg/a/a/b;->unInit()V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;
...
.method private startAudioRecorderIfNeed(FI)V
    ...
    iget-object p2, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    float-to-double v1, p1

    invoke-virtual {p2, v1, v2, v0}, Lorg/a/a/b;->a(DZ)V
...
.method public addPCMData([BI)I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/ss/android/medialib/FaceBeautyInvoker;->onAudioCallback([BI)V
...
.method public closeWavFile(Z)I
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/medialib/FaceBeautyInvoker;->closeWavFile(Z)I
...
.method public initAudioConfig(II)I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/ss/android/medialib/FaceBeautyInvoker;->initAudioConfig(II)I
...
.method public lackPermission()V
    ...
    const-string v1, "Failed. AudioRecorder open failed. Lack permission."
...
.method public recordStatus(Z)V
    ...
    const-string v2, "Failed. AudioRecorder record error. isRecording = "
...
.method public declared-synchronized setRecordBGM(Ljava/lang/String;IIZ)I
    ...
    const-string/jumbo v1, "stopPreview() can only be invoked after init()"
...
.method public declared-synchronized shotScreen(Ljava/lang/String;[IZLandroid/graphics/Bitmap$CompressFormat;Lcom/ss/android/medialib/common/Common$IShotScreenCallback;)I
    ...
    const-string/jumbo p2, "shotScreen() can only be invoked after startRecord() invoked successfully"
...
.method public declared-synchronized startPreview(Landroid/view/Surface;)I
    ...
    const-string/jumbo v2, "startPreview() can only be invoked after init()"
...
.method public declared-synchronized startRecord(FJ)I
    ...
    const-string/jumbo v2, "startRecord() can only be invoked after startPreview()"
    ...
    invoke-virtual {v2}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;->ordinal()I
...
.method public declared-synchronized stopRecord()I
    ...
    const-string/jumbo v1, "stopRecord() can only be invoked after startRecord() invoked successfully"
    ...
    iget-object v1, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/ss/android/vesdk/TERecorder;->mAudioRecorder:Lorg/a/a/b;

    invoke-virtual {v1}, Lorg/a/a/b;->kJ()Z
