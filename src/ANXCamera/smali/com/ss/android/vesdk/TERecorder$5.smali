...
.method public onNativeInitCallBack(I)V
    ...
    iget-object v2, p0, Lcom/ss/android/vesdk/TERecorder$5;->this$0:Lcom/ss/android/vesdk/TERecorder;

    invoke-static {v2}, Lcom/ss/android/vesdk/TERecorder;->access$1000(Lcom/ss/android/vesdk/TERecorder;)Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;

    move-result-object v2

    invoke-direct {v1, v2, p1}, Lcom/ss/android/vesdk/TERecorder$NativeInitListenerInvoker;-><init>(Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;I)V
    ...
    invoke-interface {v0, p1, v1}, Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;->onNativeInit(ILjava/lang/String;)V
...
.method public onNativeInitHardEncoderRetCallback(II)V
    ...
    iget-object v3, p0, Lcom/ss/android/vesdk/TERecorder$5;->this$0:Lcom/ss/android/vesdk/TERecorder;

    invoke-static {v3}, Lcom/ss/android/vesdk/TERecorder;->access$1000(Lcom/ss/android/vesdk/TERecorder;)Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;
    ...
    :cond_0
    invoke-direct {v2, v3, v0}, Lcom/ss/android/vesdk/TERecorder$NativeHardEncoderInitListenerInvoker;-><init>(Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;Z)V
    ...
    :cond_2
    invoke-interface {p2, v0}, Lcom/ss/android/vesdk/VEListener$VERecorderNativeInitListener;->onHardEncoderInit(Z)V
