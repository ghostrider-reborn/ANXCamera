...
.method private initConfig()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/vesdk/runtime/VERuntime$3;->start()V
...
.method public getAssetManager()Landroid/content/res/AssetManager;
    ...
    const-string v1, "disable use AssetManager!"
...
.method public isUseCloudConfig()Z
    ...
    iget-boolean v0, p0, Lcom/ss/android/vesdk/runtime/VERuntime;->mUseCloudConfig:Z
...
.method public needUpdateEffectModelFiles()I
    ...
    const-string v2, "Use resource finder. Do not need update effect model files!"
    ...
    const-string v2, "Enable assetManager. Do not need update effect model files!"
    ...
    invoke-virtual {v2}, Lcom/ss/android/vesdk/runtime/VEEnv;->getEffectModelResourceDirPath()Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v2}, Lcom/bef/effectsdk/EffectSDKUtils;->needUpdate(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v0, v2}, Lcom/ss/android/vesdk/runtime/VEEffectConfig;->configEffect(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setAssetManagerEnable(Z)Z
    ...
    invoke-static {p1}, Lcom/ss/android/vesdk/runtime/VEEffectConfig;->enableAssetManager(Landroid/content/res/AssetManager;)Z

    const/4 p1, 0x0

    const-string v0, "nexus"

    invoke-static {p1, v0}, Lcom/ss/android/vesdk/runtime/VEEffectConfig;->configEffect(Ljava/lang/String;Ljava/lang/String;)V
