...
.method public onImage([III)V
    ...
    iget-object p3, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    invoke-direct {p2, p3, v0}, Lcom/ss/android/vesdk/TERecorder$RenderPictureOnImageListenerInvoker;-><init>(Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;Landroid/graphics/Bitmap;)V
    ...
    :cond_2
    iget-object p2, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    if-eqz p2, :cond_3

    iget-object p2, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    invoke-interface {p2, p1}, Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;->onImage(Landroid/graphics/Bitmap;)V
...
.method public onResult(II)V
    ...
    iget-object v2, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    invoke-direct {v1, v2, p1, p2}, Lcom/ss/android/vesdk/TERecorder$RenderPictureOnResultListenerInvoker;-><init>(Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;II)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/ss/android/vesdk/TERecorder$2;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;

    invoke-interface {v0, p1, p2}, Lcom/ss/android/vesdk/TERecorder$OnPictureRenderListener;->onResult(II)V
