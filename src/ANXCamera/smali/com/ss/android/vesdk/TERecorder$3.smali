...
.method public run()V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/ss/android/medialib/FaceBeautyInvoker;->concat(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v3, p0, Lcom/ss/android/vesdk/TERecorder$3;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;

    invoke-direct {v2, v3, v0}, Lcom/ss/android/vesdk/TERecorder$ConcatResultListenerInvoker;-><init>(Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;I)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/ss/android/vesdk/TERecorder$3;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/ss/android/vesdk/TERecorder$3;->val$listener:Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;

    invoke-interface {v1, v0}, Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;->onConcatFinished(I)V
