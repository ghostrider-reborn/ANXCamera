...
.method private verifyTexture(I)Z
    ...
    const-string v0, "OpenGL has created but encounter getting invalid textureID from render Callback"
...
.method public onOpenGLCreate()V
    ...
    const-string v1, "Couldn\'t find render callback. Consider set render callback first"
    ...
    const-string v1, "Didn\'t attach render routine to texture due to invalid texture."
    ...
    invoke-static {v1}, Lcom/ss/android/vesdk/TERecorder;->access$300(Lcom/ss/android/vesdk/TERecorder;)Lcom/ss/android/vesdk/TERecorder$IRenderCallback;

    move-result-object v1

    invoke-interface {v1, v0}, Lcom/ss/android/vesdk/TERecorder$IRenderCallback;->onTextureCreated(Lcom/ss/android/vesdk/TERecorder$Texture;)V
...
.method public onOpenGLDestroy()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/vesdk/TERecorder$Texture;->release()V
...
.method public onOpenGLRunning()I
    ...
    const-string v2, "Couldn\'t find source texture"
    ...
    const-string v2, "Couldn\'t find surfaceTexture from source texture"
