...
.method private getShareIntent()Landroid/content/Intent;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mSavedUri:Landroid/net/Uri;
...
.method private initTextureView()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->getActivity()Landroid/support/v4/app/FragmentActivity;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/TextureVideoView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public static synthetic lambda$initView$0(Lcom/android/camera/fragment/vv/FragmentVVProcess;Lcom/android/camera/data/observeable/RxData$DataWrap;)V
    .locals 0
...
.method private onProcessingSateChanged(I)V
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCombineProgress:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p1, v0}, Lcom/android/camera/ui/TextureVideoView;->setVisibility(I)V
...
.method private pausePlay(ZZ)V
    ...
    const-string/jumbo p2, "vv\u9884\u89c8\u5168\u90e8\u6682\u505c"

    invoke-static {p2}, Lcom/android/camera/statistic/CameraStatUtil;->trackLiveClick(Ljava/lang/String;)V

    :cond_4
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$LiveConfigVV;->pausePlay()V
...
.method private previewLastSegment()V
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera/ui/TextureVideoView;->setVisibility(I)V
    ...
    invoke-interface {v0, v2}, Lcom/android/camera/protocol/ModeProtocol$LiveConfigVV;->getSegmentPath(I)Ljava/lang/String;
...
.method private resumePlay()V
    ...
    invoke-interface {v0}, Lcom/android/camera/protocol/ModeProtocol$LiveConfigVV;->resumePlay()V
...
.method private shareMore()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->getString(I)Ljava/lang/String;
...
.method private showShareSheet()V
    ...
    invoke-virtual {v0}, Lcom/android/camera/fragment/vv/VVShareAdapter;->notifyDataSetChanged()V
    ...
    invoke-virtual {v0, v6}, Lcom/android/camera/fragment/vv/page/PageIndicatorView;->setVisibility(I)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera/fragment/vv/page/PageIndicatorView;->setVisibility(I)V
...
.method private startPlay(Landroid/view/Surface;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/camera/protocol/ModeProtocol$LiveConfigVV;->startPlay(Landroid/view/Surface;)V
...
.method private startShare(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->getString(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mSavedUri:Landroid/net/Uri;
...
.method private stopSegmentPreview(Z)V
    ...
    const-string/jumbo p1, "vv\u9884\u89c8\u7247\u6bb5\u9000\u51fa"
...
.method protected initView(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/ui/vv/VVProgressView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->getResources()Landroid/content/res/Resources;
...
.method public onClick(Landroid/view/View;)V
    ...
    :sswitch_6
    const-string/jumbo p1, "vv\u9884\u89c8\u5168\u90e8\u7ee7\u7eed"
    ...
    .sparse-switch
        ...
        0x7f0e011a -> :sswitch_6
        0x7f0e011f -> :sswitch_5
        0x7f0e0120 -> :sswitch_4
        0x7f0e0122 -> :sswitch_3
        0x7f0e0123 -> :sswitch_2
        0x7f0e0125 -> :sswitch_1
        0x7f0e0127 -> :sswitch_0
    .end sparse-switch
.end method
...
.method public onSnapClick()V
    ...
    :cond_4
    iget v1, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCurrentMode:I
    ...
    :cond_6
    const-string/jumbo v1, "vv\u5f00\u59cb\u5f55\u5236\u7247\u6bb5"
...
.method public prepare(Lcom/android/camera/fragment/vv/VVItem;)V
    ...
    iput v0, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCurrentMode:I

    iget-object v0, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCameraSnapView:Lcom/android/camera/ui/CameraSnapView;

    iget v2, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCurrentMode:I
...
.method public processingPause()V
    ...
    iget v0, p0, Lcom/android/camera/fragment/vv/FragmentVVProcess;->mCurrentMode:I
...
.method protected register(Lcom/android/camera/protocol/ModeProtocol$ModeCoordinator;)V
    ...
    invoke-virtual {p0, p1, p0}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->registerBackStack(Lcom/android/camera/protocol/ModeProtocol$ModeCoordinator;Lcom/android/camera/protocol/ModeProtocol$HandleBackTrace;)V
...
.method public showExitConfirm()V
    ...
    const-string/jumbo v0, "vv\u5f55\u5236\u5b8c\u6210\u540e\u9000\u51fa"
...
.method protected unRegister(Lcom/android/camera/protocol/ModeProtocol$ModeCoordinator;)V
    ...
    invoke-virtual {p0, p1, p0}, Lcom/android/camera/fragment/vv/FragmentVVProcess;->unRegisterBackStack(Lcom/android/camera/protocol/ModeProtocol$ModeCoordinator;Lcom/android/camera/protocol/ModeProtocol$HandleBackTrace;)V
