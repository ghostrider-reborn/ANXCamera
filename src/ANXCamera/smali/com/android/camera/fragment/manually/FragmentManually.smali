...
.method private performFocusValueChangedViberator(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;->performFocusValueLargeChangedInManual()V
    ...
    invoke-virtual {p1}, Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;->performFocusValueLightChangedInManual()V
    :try_end_0
...
.method public onClick(Landroid/view/View;)V
    ...
    iget v5, p0, Lcom/android/camera/fragment/manually/FragmentManually;->mCurrentMode:I

    move-object v0, p0

    invoke-virtual/range {v0 .. v5}, Lcom/android/camera/fragment/manually/FragmentManually;->onManuallyDataChanged(Lcom/android/camera/data/data/ComponentData;Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/manually/FragmentManually;->mFragmentManuallyExtra:Lcom/android/camera/fragment/manually/FragmentManuallyExtra;
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->setmFragmentManually(Lcom/android/camera/fragment/manually/FragmentManually;)V
    ...
    invoke-virtual {v0, v1, v2, v3, p0}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->setComponentData(Lcom/android/camera/data/data/ComponentData;IZLcom/android/camera/fragment/manually/ManuallyListener;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/fragment/manually/adapter/ManuallyAdapter;->setSelectedTitle(I)V
...
.method public onManuallyDataChanged(Lcom/android/camera/data/data/ComponentData;Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    check-cast p5, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;
    ...
    iget p3, p0, Lcom/android/camera/fragment/manually/FragmentManually;->mCurrentMode:I

    invoke-interface {p5, p2, p3}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onDualLensSwitch(Lcom/android/camera/data/data/config/ComponentManuallyDualLens;I)V
    ...
    invoke-interface {p5, p4, p2, p3}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onFocusValueChanged(Lcom/android/camera/data/data/config/ComponentManuallyFocus;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p5, p2, p3}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onETValueChanged(Lcom/android/camera/data/data/config/ComponentManuallyET;Ljava/lang/String;)V
    ...
    invoke-interface {p5, p2, p3}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onISOValueChanged(Lcom/android/camera/data/data/config/ComponentManuallyISO;Ljava/lang/String;)V
    ...
    check-cast v0, Lcom/android/camera/data/data/config/ComponentManuallyWB;

    invoke-virtual {p2, v0}, Lcom/android/camera/fragment/manually/FragmentManuallyExtra;->showCustomWB(Lcom/android/camera/data/data/config/ComponentManuallyWB;)V
    ...
    invoke-interface {p5, p2, p3, p4}, Lcom/android/camera/protocol/ModeProtocol$ManuallyValueChanged;->onWBValueChanged(Lcom/android/camera/data/data/config/ComponentManuallyWB;Ljava/lang/String;Z)V
    ...
    .sparse-switch
        ...
        0x7f0900b2 -> :sswitch_3
        0x7f090141 -> :sswitch_2
        0x7f090169 -> :sswitch_1
        0x7f09019c -> :sswitch_0
    .end sparse-switch
.end method
...
.method public resetManually()V
    ...
    :cond_2
    iget v7, p0, Lcom/android/camera/fragment/manually/FragmentManually;->mCurrentMode:I
