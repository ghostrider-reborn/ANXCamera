...
.method private isGradienterEnabled()Z
    .locals 2
...
.method private isMiMovieOpen()Z
    .locals 1
...
.method private isSquareModule()Z
    .locals 1
...
.method private updateReferenceGradienterSwitched()V
    ...
    invoke-direct {p0}, Lcom/android/camera/fragment/FragmentMainContent;->isGradienterEnabled()Z

    move-result v2

    invoke-direct {p0}, Lcom/android/camera/fragment/FragmentMainContent;->isSquareModule()Z

    move-result v3

    invoke-virtual {v1, v0, v2, v3}, Lcom/android/camera/ui/V6PreviewFrame;->updateReferenceGradienterSwitched(ZZZ)V
...
.method public lightingStart()V
    ...
    invoke-static {v1}, Lcom/android/camera/CameraSettings;->isMiMovieOpen(I)Z

    move-result v1

    invoke-virtual {v0, v1}, Lcom/android/camera/ui/LightingView;->setMiMovie(Z)V
...
.method public notifyAfterFrameAvailable(I)V
    ...
    invoke-direct {p0}, Lcom/android/camera/fragment/FragmentMainContent;->isMiMovieOpen()Z

    move-result p1

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/FragmentMainContent;->updateMiMovieSwitched(Z)V
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-virtual {p0, v4, p3}, Lcom/android/camera/fragment/FragmentMainContent;->setSnapNumVisible(ZZ)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/ui/V6PreviewFrame;->hidePreviewReferenceLine()V

    iget-object v3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mPreviewFrame:Lcom/android/camera/ui/V6PreviewFrame;

    invoke-virtual {v3}, Lcom/android/camera/ui/V6PreviewFrame;->hidePreviewGradienter()V
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mMimojiLightingView:Lcom/android/camera/ui/LightingView;
    ...
    invoke-virtual {v1}, Lcom/android/camera/fragment/FragmentMainContent$CoverState;->ordinal()I
    ...
    iget v3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mNormalCoverHeight:I
    ...
    invoke-static {p1, v1}, Lcom/android/camera/animation/type/SlideInOnSubscribe;->directSetResult(Landroid/view/View;I)V

    iget-object p1, p0, Lcom/android/camera/fragment/FragmentMainContent;->mBottomCover:Landroid/view/View;

    invoke-static {p1, v0}, Lcom/android/camera/animation/type/SlideInOnSubscribe;->directSetResult(Landroid/view/View;I)V
    ...
    invoke-direct {p1, p3, v1}, Lcom/android/camera/animation/type/SlideInOnSubscribe;-><init>(Landroid/view/View;I)V
    ...
    iget-object p3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mBottomCover:Landroid/view/View;

    invoke-direct {p1, p3, v0}, Lcom/android/camera/animation/type/SlideInOnSubscribe;-><init>(Landroid/view/View;I)V
    ...
    invoke-direct {p1, v4, v1}, Lcom/android/camera/animation/type/SlideOutOnSubscribe;-><init>(Landroid/view/View;I)V

    invoke-virtual {p1, v3}, Lcom/android/camera/animation/type/SlideOutOnSubscribe;->setDurationTime(I)Lcom/android/camera/animation/type/BaseOnSubScribe;
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentMainContent;->mRightCover:Landroid/view/View;
...
.method public setCenterHint(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {p2, p3}, Lcom/bumptech/glide/i;->n(Ljava/lang/String;)Lcom/bumptech/glide/h;
...
.method public updateMiMovieSwitched(Z)V
    .locals 3
    ...
    const-string/jumbo v2, "updateMiMovieSwitched isSwitchOn : "
