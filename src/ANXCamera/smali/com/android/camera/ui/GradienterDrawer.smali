...
.method private init(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/GradienterDrawer;->getChildCount()I

    move-result v0

    if-lez v0, :cond_0

    invoke-virtual {p0}, Lcom/android/camera/ui/GradienterDrawer;->removeAllViews()V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/ui/GradienterDrawer;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method private invalidateView()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/GradienterDrawer;->invalidate()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/ui/GradienterDrawer;->postInvalidate()V
...
.method private resetMargin()V
    ...
    new-array v1, v4, [Landroid/widget/LinearLayout$LayoutParams;
    ...
    invoke-direct {p0, v1, v9}, Lcom/android/camera/ui/GradienterDrawer;->setViewVisible(Landroid/view/View;I)V
    ...
    iget-object v9, p0, Lcom/android/camera/ui/GradienterDrawer;->mCurrentDirect:Lcom/android/camera/ui/GradienterDrawer$Direct;

    invoke-virtual {v9}, Lcom/android/camera/ui/GradienterDrawer$Direct;->ordinal()I
    ...
    iget v7, p0, Lcom/android/camera/ui/GradienterDrawer;->mParentWidth:I
    ...
    iget v5, p0, Lcom/android/camera/ui/GradienterDrawer;->mParentWidth:I
    ...
    iget-object v9, p0, Lcom/android/camera/ui/GradienterDrawer;->mLineRightView:Landroid/view/View;
    ...
    new-array v10, v7, [Landroid/widget/LinearLayout$LayoutParams;
    ...
    invoke-direct {p0, v10}, Lcom/android/camera/ui/GradienterDrawer;->resetParams([Landroid/widget/LinearLayout$LayoutParams;)V

    iget-object v10, p0, Lcom/android/camera/ui/GradienterDrawer;->mLineRightView:Landroid/view/View;

    invoke-direct {p0, v10, v5}, Lcom/android/camera/ui/GradienterDrawer;->setViewVisible(Landroid/view/View;I)V

    iget-object v10, p0, Lcom/android/camera/ui/GradienterDrawer;->mLineLeftView:Landroid/view/View;

    invoke-direct {p0, v10, v5}, Lcom/android/camera/ui/GradienterDrawer;->setViewVisible(Landroid/view/View;I)V

    sget-object v10, Lcom/android/camera/ui/GradienterDrawer$1;->$SwitchMap$com$android$camera$ui$GradienterDrawer$Direct:[I

    iget-object v11, p0, Lcom/android/camera/ui/GradienterDrawer;->mCurrentDirect:Lcom/android/camera/ui/GradienterDrawer$Direct;

    invoke-virtual {v11}, Lcom/android/camera/ui/GradienterDrawer$Direct;->ordinal()I
    ...
    iget v3, p0, Lcom/android/camera/ui/GradienterDrawer;->mLineLongWidth:I
...
.method private updateView()V
    ...
    iget v1, p0, Lcom/android/camera/ui/GradienterDrawer;->mDeviceRotation:F
    ...
    iput v1, p0, Lcom/android/camera/ui/GradienterDrawer;->mDeviceRotation:F
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/ui/GradienterDrawer;->setLineShortColor(I)V
    ...
    sget-object v0, Lcom/android/camera/ui/GradienterDrawer;->TAG:Ljava/lang/String;
