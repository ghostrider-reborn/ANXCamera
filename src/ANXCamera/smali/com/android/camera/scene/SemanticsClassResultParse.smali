...
.method static synthetic lambda$updateASDScene$0(Lcom/android/camera/module/Camera2Module;)V
    .locals 0
...
.method private updateASDScene(Lcom/android/camera2/vendortag/struct/MarshalQueryableASDScene$ASDScene;)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/module/BaseModule;->getBogusCameraId()I

    move-result p1

    invoke-static {p1}, Lcom/android/camera/statistic/CameraStatUtil;->trackAsdDirtyTip(I)V

    goto/16 :goto_3

    :pswitch_2
    invoke-virtual {p0}, Lcom/android/camera/scene/SemanticsClassResultParse;->isIntercept()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/scene/SemanticsClassResultParse;->closeTip()Z
    :try_end_0
    ...
    new-instance v3, Lcom/android/camera/scene/-$$Lambda$SemanticsClassResultParse$piIzMhxylZlzJf5-SLv5u97iiMQ;

    invoke-direct {v3, v2}, Lcom/android/camera/scene/-$$Lambda$SemanticsClassResultParse$piIzMhxylZlzJf5-SLv5u97iiMQ;-><init>(Lcom/android/camera/module/Camera2Module;)V

    invoke-virtual {v1, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const-string v1, "counter"

    invoke-static {v1}, Lcom/android/camera/statistic/CameraStatUtil;->trackBacklitTip(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v3, p1}, Lcom/android/camera/scene/SemanticsClassResultParse;->showTip(III)Z
    ...
    invoke-static {p1, v6}, Lcom/android/camera/scene/MiAlgoAsdSceneProfile;->setTipEnable(IZ)V

    const-string p1, "counter"

    invoke-static {p1}, Lcom/android/camera/statistic/CameraStatUtil;->trackPortraitTip(Ljava/lang/String;)V
