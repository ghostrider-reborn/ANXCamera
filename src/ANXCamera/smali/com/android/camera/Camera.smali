...
.method private checkLocationPermission()Z
    ...
    invoke-direct {p0, v2}, Lcom/android/camera/Camera;->setLocationPreference(Z)V
...
.method private parseLocationPermission([Ljava/lang/String;[I)V
    ...
    invoke-direct {p0, v0}, Lcom/android/camera/Camera;->setLocationPreference(Z)V
    ...
    const-string v3, "onRequestPermissionsResult: is location granted = "
...
.method private resumeCamera()V
    ...
    iput-boolean v12, p0, Lcom/android/camera/Camera;->mJumpedToGallery:Z
    ...
    iput-boolean v12, p0, Lcom/android/camera/Camera;->mReleaseByModule:Z
...
.method private setupCamera(Lcom/android/camera/module/loader/StartControl;)V
    ...
    const-string/jumbo v0, "setupCamera: activity is paused!"
    ...
    const-string/jumbo v0, "setupCamera: waiting for permissions to be granted"
...
.method public handleScreenSlideKeyEvent(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->hw()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/android/camera/Camera;->checkLocationPermission()Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    :cond_2
    invoke-direct {p0, p2}, Lcom/android/camera/Camera;->isFromOneShotKeyPressed(Landroid/view/KeyEvent;)Z
    ...
    const-string v1, "onKeyDown: isFromOneShotKeyPressed and return! keyCode is "
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    const-string v1, "onKeyUp: key is lastIgnore key   keyCode : "
...
.method public onModeSelected(Lcom/android/camera/module/loader/StartControl;)V
    ...
    const-string/jumbo v0, "skip caz request runtime permission."
...
.method public onPause()V
    ...
    iput-wide v1, p0, Lcom/android/camera/Camera;->mAppStartTime:J
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/Camera;->controlScreenNailDraw(Z)V
...
.method protected onRestart()V
    ...
    iget-boolean v0, p0, Lcom/android/camera/Camera;->mStartFromKeyguard:Z
...
.method public onResume()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/Camera;->showBlurCover()V
    ...
    const-string/jumbo v1, "start request documents permission"
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/ui/CameraRootView;->post(Ljava/lang/Runnable;)Z
...
.method public onStop()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/Camera;->isGotoSettings()Z
...
.method public onWindowFocusChanged(Z)V
    ...
    const-string/jumbo v1, "setupCamera in onWindowFocusChanged"
...
.method public showGuide(I)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->hW()Z
    ...
    :cond_0
    const-string v2, "pref_camera_first_ultra_tele_use_hint_shown_key"
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/camera/data/data/global/DataItemGlobal;->getBoolean(Ljava/lang/String;Z)Z
...
.method public showNewBie(I)Z
    ...
    const-string v0, "pref_camera_first_ultra_tele_use_hint_shown_key"
    ...
    const-string v0, "pref_camera_first_vv_hint_shown_key"
    ...
    const-string v0, "pref_camera_first_macro_mode_use_hint_shown_key"
    ...
    const-string v0, "pref_camera_first_ai_scene_use_hint_shown_key"
