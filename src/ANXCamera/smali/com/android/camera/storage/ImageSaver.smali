...
.method private dealExif(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;)V
    ...
    sget-object v1, Lcom/android/camera2/vendortag/CaptureResultVendorTags;->HDR_CHECKTER_EV_VALUES:Lcom/android/camera2/vendortag/VendorTag;
    ...
    :cond_1
    sget-object v1, Lcom/android/camera2/vendortag/CaptureResultVendorTags;->SUPER_RESOLUTION_ENABLED:Lcom/android/camera2/vendortag/VendorTag;
    ...
    invoke-virtual {p1, v1}, Lcom/xiaomi/camera/core/PictureInfo;->setCaptureResult(Ljava/lang/String;)V
...
.method private processIntentResult(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/storage/ImageSaveRequest;->setSaverCallback(Lcom/android/camera/storage/SaverCallback;)V

    invoke-virtual {v0}, Lcom/android/camera/storage/ImageSaveRequest;->parserParallelTaskData()V

    iget v1, v0, Lcom/android/camera/storage/ImageSaveRequest;->width:I

    iget v0, v0, Lcom/android/camera/storage/ImageSaveRequest;->orientation:I
...
.method private processParallelIntentResult(Lcom/xiaomi/camera/core/ParallelTaskData;)V
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/storage/ParallelSaveRequest;->setSaverCallback(Lcom/android/camera/storage/SaverCallback;)V

    invoke-virtual {v0}, Lcom/android/camera/storage/ParallelSaveRequest;->parserParallelTaskData()V

    iget v1, v0, Lcom/android/camera/storage/ParallelSaveRequest;->width:I

    iget v0, v0, Lcom/android/camera/storage/ParallelSaveRequest;->orientation:I
...
.method public onModuleDestroy()V
    ...
    iget-object v0, p0, Lcom/android/camera/storage/ImageSaver;->mbModuleSwitch:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public onParallelProcessFinish(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    const-string v2, "onParallelProcessFinish: memory[-]: "
...
.method public varargs processorJpegSync(Z[Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;)V
    ...
    const-string p2, "processorJpegSync(): mEffectProcessor is null"
