...
.field public static final DATA_CONFIG_RATIO_MIMOVIE:Ljava/lang/String; = "is_mimovie"
...
.field private mComponentConfigMiMovie:Lcom/android/camera/data/data/config/ComponentConfigMiMovie;
...
.method public constructor <init>(II)V
    ...
    new-instance p1, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;

    invoke-direct {p1, p0}, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;-><init>(Lcom/android/camera/data/data/config/DataItemConfig;)V

    iput-object p1, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentConfigMiMovie:Lcom/android/camera/data/data/config/ComponentConfigMiMovie;
    ...
    new-instance p1, Lcom/android/camera/data/data/config/ComponentManuallyWB;

    invoke-direct {p1, p0}, Lcom/android/camera/data/data/config/ComponentManuallyWB;-><init>(Lcom/android/camera/data/data/config/DataItemConfig;)V

    iput-object p1, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentManuallyWB:Lcom/android/camera/data/data/config/ComponentManuallyWB;

    new-instance p1, Lcom/android/camera/data/data/config/ComponentManuallyET;

    invoke-direct {p1, p0}, Lcom/android/camera/data/data/config/ComponentManuallyET;-><init>(Lcom/android/camera/data/data/config/DataItemConfig;)V

    iput-object p1, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentManuallyET:Lcom/android/camera/data/data/config/ComponentManuallyET;

    new-instance p1, Lcom/android/camera/data/data/config/ComponentManuallyISO;

    invoke-direct {p1, p0}, Lcom/android/camera/data/data/config/ComponentManuallyISO;-><init>(Lcom/android/camera/data/data/config/DataItemConfig;)V

    iput-object p1, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentManuallyISO:Lcom/android/camera/data/data/config/ComponentManuallyISO;
...
.method public getComponentConfigMiMovie()Lcom/android/camera/data/data/config/ComponentConfigMiMovie;
    .locals 1

    iget-object v0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentConfigMiMovie:Lcom/android/camera/data/data/config/ComponentConfigMiMovie;
...
.method public reConfigMovieIfRatioChanged(ILjava/lang/String;)Z
    .locals 2

    invoke-virtual {p0}, Lcom/android/camera/data/data/config/DataItemConfig;->getComponentConfigMiMovie()Lcom/android/camera/data/data/config/ComponentConfigMiMovie;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;->isMiMovieOn(I)Z
    ...
    invoke-virtual {p2, p1, v1}, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;->setMiMovie(IZ)V
...
.method public reInitComponent(IILcom/android/camera2/CameraCapabilities;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;->reInit(IILcom/android/camera2/CameraCapabilities;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/camera/data/data/config/ComponentManuallyWB;->reInit(IILcom/android/camera2/CameraCapabilities;)Ljava/util/List;

    iget-object v0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentManuallyET:Lcom/android/camera/data/data/config/ComponentManuallyET;

    invoke-virtual {v0, p1, p2, p3}, Lcom/android/camera/data/data/config/ComponentManuallyET;->reInit(IILcom/android/camera2/CameraCapabilities;)Ljava/util/List;

    iget-object v0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentManuallyISO:Lcom/android/camera/data/data/config/ComponentManuallyISO;

    invoke-virtual {v0, p1, p2, p3}, Lcom/android/camera/data/data/config/ComponentManuallyISO;->reInit(IILcom/android/camera2/CameraCapabilities;)Ljava/util/List;
...
.method public supportMeter()Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/data/data/config/ComponentConfigMeter;->isEmpty()Z
...
.method public supportMiMovie()Z
    .locals 1

    iget-object v0, p0, Lcom/android/camera/data/data/config/DataItemConfig;->mComponentConfigMiMovie:Lcom/android/camera/data/data/config/ComponentConfigMiMovie;

    invoke-virtual {v0}, Lcom/android/camera/data/data/config/ComponentConfigMiMovie;->isEmpty()Z
...
.method public supportVideoQuality()Z
    ...
    invoke-virtual {v0}, Lcom/android/camera/data/data/config/ComponentConfigVideoQuality;->isEmpty()Z
