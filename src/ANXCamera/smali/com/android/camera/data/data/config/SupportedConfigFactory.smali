...
.field public static final MIMOVIE:I = 0xfb
...
.method public static final getSupportedExtraConfigs(IILcom/android/camera/data/cloud/DataCloud$CloudFeature;Lcom/android/camera2/CameraCapabilities;Z)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->ig()Z
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->ik()Z
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->hw()Z
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->gw()Z

    move-result v0

    if-eqz v0, :cond_13

    invoke-virtual {v5}, Lcom/mi/config/a;->iy()Z
    ...
    :cond_13
    :goto_1
    invoke-virtual {v5}, Lcom/mi/config/a;->gG()Z
    ...
    const-string v0, "ro.camera.subtitle.opened"
...
.method public static final getSupportedTopConfigs(IIZ)Lcom/android/camera/data/data/config/SupportedConfigs;
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->id()Z
    ...
    invoke-static {v11, v7}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
    ...
    :cond_7
    invoke-virtual {v4}, Lcom/mi/config/a;->ga()Z
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->ih()Z
    ...
    :cond_f
    invoke-virtual {v4}, Lcom/mi/config/a;->gz()Z
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->iw()Z
    ...
    :cond_13
    invoke-virtual {v4}, Lcom/mi/config/a;->ix()Z

    move-result v1

    if-eqz v1, :cond_14

    invoke-virtual {v4}, Lcom/mi/config/a;->gw()Z
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->gF()Z
    ...
    invoke-static {v10, v7}, Lcom/android/camera/data/data/config/SupportedConfigFactory;->createConfigItem(II)Lcom/android/camera/data/data/config/TopConfigItem;
