...
.method private constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/ActivityBase;->getMainLooper()Landroid/os/Looper;
...
.method private deleteLastSegment()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/vesdk/TERecorder;->deleteLastFrag()I
...
.method private updateRecordingTime(J)V
    ...
    iget p2, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mCurrentSpeed:F
...
.method public closeBGM()V
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/ss/android/vesdk/TERecorder;->setRecordBGM(Ljava/lang/String;II)I
...
.method public getAuthResult()I
    ...
    iget-object v0, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mAuthResult:Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;
    ...
    iget-object v2, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mAuthResult:Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;

    invoke-virtual {v2}, Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;->ordinal()I
...
.method public getRecordSpeed()F
    ...
    iget v0, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mCurrentSpeed:F
...
.method public initPreview(IIZI)V
    ...
    iget-object p2, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mRecordSegmentTimeInfo:Ljava/util/List;

    invoke-interface {p2}, Ljava/util/List;->size()I

    move-result p2

    invoke-virtual {p1, p2}, Lcom/ss/android/vesdk/TERecorder;->tryRestore(I)I
...
.method public initResource()V
    ...
    invoke-static {v3, v1, v0, v2}, Lcom/ss/android/vesdk/runtime/VERuntime;->activate(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mAuthResult:Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;
    ...
    invoke-virtual {v2}, Lcom/ss/android/vesdk/runtime/oauth/TEOAuthResult;->name()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/camera/module/impl/component/FileUtils;->CONCAT_VIDEO_DIR:Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/camera/module/impl/component/FileUtils;->RESOURCE_LIST_GLOBAL:Ljava/util/List;
    ...
    sget-object v2, Lcom/android/camera/module/impl/component/FileUtils;->RESOURCE_LIST_CN:Ljava/util/List;
    ...
    sget-object v4, Lcom/android/camera/module/impl/component/FileUtils;->MUSIC_LOCAL:Ljava/lang/String;

    invoke-static {v3, v1, v4, v0}, Lcom/android/camera/Util;->verifyAssetZip(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    :cond_6
    sget-object v0, Lcom/android/camera/module/impl/component/FileUtils;->MODELS_DIR:Ljava/lang/String;
...
.method public onBGMChanged(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/ss/android/vesdk/TERecorder;->setRecordBGM(Ljava/lang/String;II)I
...
.method public onDeviceRotationChange([F)V
    ...
    invoke-virtual {v1, p1}, Lcom/ss/android/vesdk/TERecorder;->setDeviceRotation([F)V
...
.method public onRecordConcat(Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;)Z
    ...
    const-string v0, "record segments is empty, stop concat"
    ...
    iget-object v2, p0, Lcom/android/camera/module/impl/component/LiveConfigChangeTTImpl;->mConcatWavPath:Ljava/lang/String;

    invoke-virtual {v0, v1, v2, p1}, Lcom/ss/android/vesdk/TERecorder;->concatAsync(Ljava/lang/String;Ljava/lang/String;Lcom/ss/android/vesdk/TERecorder$OnConcatFinishedListener;)V
...
.method public onRecordStart()V
    ...
    invoke-virtual {v0, v2, v1, v3}, Lcom/ss/android/vesdk/TERecorder;->setRecordBGM(Ljava/lang/String;II)I
...
.method public onRecordStop()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/vesdk/TERecorder;->clearEnv()I
...
.method public setEffectAudio(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/ss/android/vesdk/TERecorder;->pauseEffectAudio(Z)V
...
.method public startPreview(Landroid/view/Surface;)V
    ...
    const-string/jumbo v0, "startPreview return"
...
.method public updateRotation(FFF)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/ss/android/vesdk/TERecorder;->updateRotation(FFF)V
