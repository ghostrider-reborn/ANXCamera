...
.method private handleTempVideoFile()V
    ...
    invoke-virtual {v1}, Lcom/android/camera/Camera;->getCacheDir()Ljava/io/File;
...
.method private isEisOn()Z
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/android/camera/module/VideoModule;->isStandaloneMacroCamera()Z
...
.method private onStartRecorderSucceed()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/data/data/runing/ComponentRunningSubtitle;->isEnabled(I)Z
    ...
    invoke-interface {v0, v2}, Lcom/android/camera/protocol/ModeProtocol$SubtitleRecording;->handleSubtitleRecordingStart(Ljava/lang/String;)V
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/android/camera/module/VideoModule;->isAuxCamera()Z
...
.method private postProcessVideo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/storage/Storage;->generateFilepath(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0}, Lcom/android/camera/module/VideoModule;->getModuleIndex()I

    move-result v5

    invoke-static {v5}, Lcom/android/camera/CameraSettings;->is960WatermarkOn(I)Z
    ...
    invoke-static {v5}, Lcom/android/camera/Util;->load960fpsCameraWatermark(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v5, v7}, Lcom/android/camera/module/VideoModule;->getResourceFloat(IF)F
    ...
    invoke-direct {p0, v8, v7}, Lcom/android/camera/module/VideoModule;->getResourceFloat(IF)F

    move-result v8

    const v9, 0x7f0d018c

    invoke-direct {p0, v9, v7}, Lcom/android/camera/module/VideoModule;->getResourceFloat(IF)F
    ...
    invoke-virtual {v5}, Lcom/mi/config/a;->gy()Z

    move-result v9

    invoke-static/range {v7 .. v12}, Lcom/miui/extravideo/interpolation/VideoInterpolator;->doDecodeAndEncodeSyncWithWatermark(Ljava/lang/String;Ljava/lang/String;ZLandroid/graphics/Bitmap;[FZ)Z
    ...
    const-string v7, "postProcessVideo: start "
    ...
    invoke-virtual {v8}, Lcom/mi/config/a;->gy()Z

    move-result v8

    invoke-static {v5, v7, v8, v12}, Lcom/miui/extravideo/interpolation/VideoInterpolator;->doDecodeAndEncodeSync(Ljava/lang/String;Ljava/lang/String;ZZ)Z
...
.method private setupRecorder(Landroid/media/MediaRecorder;)V
    ...
    invoke-virtual {v3}, Lcom/mi/config/a;->hs()Z
    ...
    invoke-virtual {p1, v6, v7}, Landroid/media/MediaRecorder;->setVideoSize(II)V
    ...
    invoke-direct {p0, v5}, Lcom/android/camera/module/VideoModule;->getHevcVideoEncoderBitRate(Landroid/media/CamcorderProfile;)I
...
.method private startRecordSession()V
    ...
    const-string/jumbo v1, "startRecordSession: operatingMode = 0x%x"
...
.method private startRecorder()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->is()Z
...
.method private stopRecorder()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->is()Z
...
.method public varargs consumePreference([I)V
    ...
    :sswitch_0
    invoke-virtual {p0}, Lcom/android/camera/module/VideoModule;->updateBackSoftLightPreference()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->hs()Z
...
.method public onNewUriArrived(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2}, Lcom/android/camera/module/VideoBase;->onNewUriArrived(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iget p2, p0, Lcom/android/camera/module/VideoModule;->mModuleIndex:I
    ...
    invoke-interface {p1}, Lcom/android/camera/protocol/ModeProtocol$SubtitleRecording;->saveSubtitle()V
...
.method public onZoomingActionStart(I)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->ii()Z
...
.method public reShowMoon()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->iy()Z
...
.method protected readVideoPreferences()V
    ...
    iget v3, p0, Lcom/android/camera/module/VideoModule;->mActualCameraId:I
    ...
    iget v4, p0, Lcom/android/camera/module/VideoModule;->mActualCameraId:I

    iget v5, p0, Lcom/android/camera/module/VideoModule;->mModuleIndex:I
    ...
    invoke-virtual {v1, v4, v6}, Lcom/android/camera/data/data/global/DataItemGlobal;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v4}, Lcom/android/camera/data/data/config/ComponentConfigSlowMotion;->getComponentValue(I)Ljava/lang/String;
    ...
    iput v5, p0, Lcom/android/camera/module/VideoModule;->mMaxVideoDurationInMs:I
...
.method public stopObjectTracking(Z)V
    ...
    const-string/jumbo v1, "stopObjectTracking: started="
...
.method public stopVideoRecording(ZZ)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->ii()Z
    ...
    :cond_5
    invoke-virtual {v0, v7}, Lcom/android/camera/module/VideoModule;->setMinZoomRatio(F)V

    iget-object v2, v0, Lcom/android/camera/module/VideoModule;->mCameraCapabilities:Lcom/android/camera2/CameraCapabilities;
    ...
    invoke-virtual {v0, v7}, Lcom/android/camera/module/VideoModule;->setMaxZoomRatio(F)V
    ...
    iget v3, v0, Lcom/android/camera/module/VideoModule;->mModuleIndex:I
    ...
    iget-object v9, v0, Lcom/android/camera/module/VideoModule;->mBeautyValues:Lcom/android/camera/fragment/beauty/BeautyValues;
    ...
    iget-object v0, v0, Lcom/android/camera/module/VideoModule;->mSlowModeFps:Ljava/lang/String;

    invoke-static {v0}, Lcom/android/camera/statistic/CameraStatUtil;->trackSlowMotionMacroCapture(Ljava/lang/String;)V
...
.method protected updateRecordingTime()V
    ...
    invoke-virtual {v6}, Lcom/mi/config/a;->hs()Z
