...
.method private addImageAsApplication(Ljava/lang/String;Ljava/lang/String;III)V
    ...
    invoke-static {v10, v4, v2, v5, v6}, Lcom/android/camera/ExifHelper;->writeExifByFilePath(Ljava/lang/String;ILandroid/location/Location;J)V

    goto :goto_1

    :cond_0
    :try_start_0
    invoke-static {v10, v12}, Lcom/android/camera/FileCompat;->getParcelFileDescriptor(Ljava/lang/String;Z)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v0, v4, v2, v5, v6}, Lcom/android/camera/ExifHelper;->writeExifByFd(Ljava/io/FileDescriptor;ILandroid/location/Location;J)V
    :try_end_1
    ...
    :try_start_2
    invoke-static {v11, v3}, Lcom/android/camera/module/Panorama3Module;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    ...
    :try_start_4
    invoke-static {v5, v3}, Lcom/android/camera/module/Panorama3Module;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    iget-object v7, v1, Lcom/android/camera/module/Panorama3Module;->mLocation:Landroid/location/Location;
    ...
    invoke-static/range {v2 .. v9}, Lcom/android/camera/storage/Storage;->addImageForGroupOrPanorama(Landroid/content/Context;Ljava/lang/String;IJLandroid/location/Location;II)Landroid/net/Uri;
    ...
    invoke-static {v2, v10}, Lcom/android/camera/storage/MediaProviderUtil;->getContentUriFromPath(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, v12, v0}, Lcom/android/camera/module/Panorama3Module;->trackGeneralInfo(IZ)V

    new-instance v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;

    invoke-direct {v3}, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;-><init>()V

    iput v12, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->takenNum:I

    iput-boolean v0, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->burst:Z

    iput-boolean v13, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->location:Z

    iput-object v11, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->aiSceneName:Ljava/lang/String;

    iput-boolean v0, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isEnteringMoon:Z

    iput-boolean v0, v3, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isSelectMoonMode:Z

    invoke-virtual {v1, v3}, Lcom/android/camera/module/Panorama3Module;->trackPictureTaken(Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;)V

    iget-object v3, v1, Lcom/android/camera/module/Panorama3Module;->mActivity:Lcom/android/camera/Camera;

    invoke-virtual {v1}, Lcom/android/camera/module/Panorama3Module;->isCreated()Z
    ...
    invoke-virtual {v3, v2, v1}, Lcom/android/camera/Camera;->onNewUriArrived(Landroid/net/Uri;Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/android/camera/Camera;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    invoke-static {v1, v2, v0}, Lcom/android/camera/Thumbnail;->createThumbnailFromUri(Landroid/content/ContentResolver;Landroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-virtual {v2, v1, v0, v0}, Lcom/android/camera/ThumbnailUpdater;->setThumbnail(Lcom/android/camera/Thumbnail;ZZ)V
...
.method private configMorphoPanoramaGP3()Z
    ...
    const-string/jumbo v5, "setShrinkRatio error ret:0x%08X"
    ...
    const-string/jumbo v5, "setUseDeform error ret:0x%08X"
    ...
    const-string/jumbo v5, "setUseLuminanceCorrection error ret:0x%08X"
    ...
    const-string/jumbo v5, "setSeamsearchRatio error ret:0x%08X"
    ...
    const-string/jumbo v5, "setZrotationCoeff error ret:0x%08X"
    ...
    const-string/jumbo v5, "setRotationRatio error ret:0x%08X"
    ...
    const-string/jumbo v5, "setSensorUseMode error ret:0x%08X"
    ...
    const-string/jumbo v5, "setProjectionMode error ret:0x%08X"
...
.method private registerGravitySensorListener()V
    ...
    iget-object v2, p0, Lcom/android/camera/module/Panorama3Module;->mSensorEventListener:Landroid/hardware/SensorEventListener;
...
.method private savePanoramaFile(Ljava/lang/String;II)Z
    ...
    invoke-static {v15}, Lcom/android/camera/module/Panorama3Module;->getJpegQuality(Z)I
...
.method private unregisterGravitySensorListener()V
    ...
    iget-object v1, p0, Lcom/android/camera/module/Panorama3Module;->mSensorEventListener:Landroid/hardware/SensorEventListener;
...
.method private updatePictureAndPreviewSize()V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hV()I
    ...
    iget v2, p0, Lcom/android/camera/module/Panorama3Module;->mBogusCameraId:I
...
.method public onCreate(II)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->gB()F
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/camera/module/Panorama3Module;->getString(I)Ljava/lang/String;
...
.method public startPanoramaShooting()V
    ...
    invoke-virtual {v4}, Lcom/mi/config/a;->hO()Z
