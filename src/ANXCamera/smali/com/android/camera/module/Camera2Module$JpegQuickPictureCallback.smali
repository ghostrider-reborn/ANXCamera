...
.method public onPictureTaken([B)V
    ...
    new-instance v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;

    invoke-direct {v1}, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;-><init>()V

    iget v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->mSavedJpegCallbackNum:I

    iput v2, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->takenNum:I

    iput-boolean v3, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->burst:Z
    ...
    :cond_2
    iput-boolean v15, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->location:Z

    iget-object v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->this$0:Lcom/android/camera/module/Camera2Module;

    invoke-static {v2}, Lcom/android/camera/module/Camera2Module;->access$2700(Lcom/android/camera/module/Camera2Module;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->aiSceneName:Ljava/lang/String;

    iget-object v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->this$0:Lcom/android/camera/module/Camera2Module;

    invoke-static {v2}, Lcom/android/camera/module/Camera2Module;->access$2800(Lcom/android/camera/module/Camera2Module;)Z

    move-result v2

    iput-boolean v2, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isEnteringMoon:Z

    iget-object v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->this$0:Lcom/android/camera/module/Camera2Module;

    invoke-static {v2}, Lcom/android/camera/module/Camera2Module;->access$2900(Lcom/android/camera/module/Camera2Module;)Z

    move-result v2

    iput-boolean v2, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isSelectMoonMode:Z

    iget-object v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->this$0:Lcom/android/camera/module/Camera2Module;

    invoke-static {v2}, Lcom/android/camera/module/Camera2Module;->access$3000(Lcom/android/camera/module/Camera2Module;)Z

    move-result v2

    iput-boolean v2, v1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isSuperNightInCaptureMode:Z

    iget-object v2, v0, Lcom/android/camera/module/Camera2Module$JpegQuickPictureCallback;->this$0:Lcom/android/camera/module/Camera2Module;

    invoke-virtual {v2, v1}, Lcom/android/camera/module/Camera2Module;->trackPictureTaken(Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;)V
    ...
    invoke-virtual {v2}, Lcom/android/camera/module/Camera2Module;->getActivity()Lcom/android/camera/Camera;
    ...
    invoke-static {v2}, Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;->getInstance(Landroid/content/Context;)Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/camera/lib/compatibility/related/vibrator/ViberatorContext;->performBurstCapture()V
