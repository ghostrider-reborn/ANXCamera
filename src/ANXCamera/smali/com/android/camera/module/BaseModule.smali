...
.field protected volatile mIsSatFallback:Z
...
.method public accept([I)V
    ...
    const-string v1, "begin to consumePreference.."
    ...
    iput-boolean p1, p0, Lcom/android/camera/module/BaseModule;->mIsSatFallback:Z

    iput-boolean v2, p0, Lcom/android/camera/module/BaseModule;->mFallbackProcessed:Z
    ...
    const-string v1, "lastFallbackRequestId = "
    ...
    const-string/jumbo v1, "skip resumePreview on accept. isAlive = "
...
.method public final getDeviceBasedZoomRatio()F
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->iu()Ljava/lang/String;
...
.method public initByCapability(Lcom/android/camera2/CameraCapabilities;)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->ip()Z
...
.method protected initializeZoomRatio()V
    ...
    const-string v1, "resetZoomRatio(): set zoom ratio to 0.6"
    ...
    sget v3, Lcom/android/camera/HybridZoomingSystem;->sDefaultStandaloneMacroOpticalZoomRatio:F
...
.method public onCreate(II)V
    ...
    invoke-virtual {p1}, Lcom/mi/config/a;->gK()Z
...
.method public onDestroy()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/LocalParallelService$LocalBinder;->stopPostProcessor(I)V
...
.method public onEvChanged(II)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/Camera;->getApplicationContext()Landroid/content/Context;
...
.method protected setFlashMode(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->hP()Z
...
.method trackPictureTaken(Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;)V
    .locals 6
    ...
    :cond_0
    iget v0, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->takenNum:I

    iget-boolean v1, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->burst:Z
    ...
    iget-boolean v4, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->location:Z

    iget-object v5, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->aiSceneName:Ljava/lang/String;

    invoke-static/range {v0 .. v5}, Lcom/android/camera/statistic/CameraStatUtil;->trackPictureTaken(IZIZZLjava/lang/String;)V

    iget v0, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->takenNum:I

    invoke-virtual {p0, v0}, Lcom/android/camera/module/BaseModule;->trackModeCustomInfo(I)V

    iget-boolean v0, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isEnteringMoon:Z

    iget-boolean v1, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isSelectMoonMode:Z

    invoke-static {v0, v1}, Lcom/android/camera/statistic/CameraStatUtil;->trackMoonMode(ZZ)V

    iget-boolean p1, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isSuperNightInCaptureMode:Z

    invoke-static {p1}, Lcom/android/camera/statistic/CameraStatUtil;->trackSuperNightInCaptureMode(Z)V

    return-void
.end method

.method trackTouchShutterButtom(Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;)V
    .locals 1
    ...
    :cond_0
    iget-boolean v0, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isASDPortraitTip:Z

    if-eqz v0, :cond_1

    const-string v0, "capture"

    invoke-static {v0}, Lcom/android/camera/statistic/CameraStatUtil;->trackPortraitTip(Ljava/lang/String;)V

    :cond_1
    iget-boolean p1, p1, Lcom/android/camera/statistic/CameraStat$PictureTakenParameter;->isASDBacklitTip:Z

    if-eqz p1, :cond_2

    const-string p1, "capture"

    invoke-static {p1}, Lcom/android/camera/statistic/CameraStatUtil;->trackBacklitTip(Ljava/lang/String;)V
...
.method public final varargs updatePreferenceInWorkThread([I)V
    ...
    const-string/jumbo v1, "the mUpdateWorkThreadDisposable is not available."
