...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/camera/CameraPreferenceActivity;->mKeyguardLocked:Z
...
.method private filterByConfig()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->gl()Z
...
.method private filterByDeviceID()V
    ...
    sget-boolean v0, Lcom/mi/config/b;->sR:Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->hv()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->in()Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hF()Z
...
.method private filterByFrom()V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/camera/CameraPreferenceActivity;->removePreference(Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    const-string v2, "category_camcorder_setting"
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->iq()Z
...
.method private installQRCodeReceiver()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/CameraPreferenceActivity$2;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    return-void
.end method

.method public static synthetic lambda$P7zT6BehQCTvdikl6tbzG3qHopM(Lcom/android/camera/CameraPreferenceActivity;)V
    .locals 0
...
.method public static synthetic lambda$Vs3W0Pv-jSO-xLYnn5tEjxrS-dA(Lcom/android/camera/CameraPreferenceActivity;)V
    .locals 0
...
.method public static synthetic lambda$onRequestPermissionsResult$0(Lcom/android/camera/CameraPreferenceActivity;Landroid/content/DialogInterface;I)V
    .locals 0
...
.method public static synthetic lambda$onRequestPermissionsResult$1(Lcom/android/camera/CameraPreferenceActivity;Landroid/content/DialogInterface;I)V
    .locals 2
...
.method private static readKeptValues(Z)Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v1}, Lcom/android/camera/data/data/global/DataItemGlobal;->contains(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1, v3}, Lcom/android/camera/data/data/global/DataItemGlobal;->getBoolean(Ljava/lang/String;Z)Z
...
.method private static rewriteKeptValues(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/android/camera/data/data/global/DataItemGlobal;->putBoolean(Ljava/lang/String;Z)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
...
.method private updateEntries()V
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera/ui/PreviewListPreference;->setValue(Ljava/lang/String;)V

    invoke-virtual {v0, v4}, Lcom/android/camera/ui/PreviewListPreference;->setDefaultValue(Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v6}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->remove(Ljava/lang/String;)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;

    move-result-object v4

    invoke-interface {v4}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->apply()V

    invoke-direct {p0, v5}, Lcom/android/camera/CameraPreferenceActivity;->getSnapBoolValue(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v8}, Lcom/android/camera/ui/PreviewListPreference;->setEntries([Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v7}, Lcom/android/camera/ui/PreviewListPreference;->setEntryValues([Ljava/lang/CharSequence;)V

    invoke-virtual {v3, v2}, Lcom/android/camera/ui/PreviewListPreference;->setDefaultValue(Ljava/lang/Object;)V

    invoke-virtual {v3, v4}, Lcom/android/camera/ui/PreviewListPreference;->setValue(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/mi/config/b;->s(Z)Z
...
.method protected getKeyguardFlag()Z
    ...
    invoke-direct {p0}, Lcom/android/camera/CameraPreferenceActivity;->getAndroidOneKeyguardFlag()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/CameraPreferenceActivity;->getKeyguardFlag()Z

    move-result p1

    iput-boolean p1, p0, Lcom/android/camera/CameraPreferenceActivity;->mKeyguardLocked:Z

    iget-boolean p1, p0, Lcom/android/camera/CameraPreferenceActivity;->mKeyguardLocked:Z

    if-eqz p1, :cond_0

    const-string p1, "keyguard"

    invoke-virtual {p0, p1}, Lcom/android/camera/CameraPreferenceActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/CameraPreferenceActivity;->setShowWhenLocked(Z)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/CameraPreferenceActivity;->getString(I)Ljava/lang/String;
    ...
    :cond_7
    const-string p2, "public_transportation_shortcuts"
    ...
    invoke-static {p1, p2, v1}, Landroid/provider/Settings$Secure;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    new-instance v7, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$Vs3W0Pv-jSO-xLYnn5tEjxrS-dA;

    invoke-direct {v7, p0}, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$Vs3W0Pv-jSO-xLYnn5tEjxrS-dA;-><init>(Lcom/android/camera/CameraPreferenceActivity;)V
    ...
    invoke-static {}, Lcom/android/camera/statistic/CameraStatUtil;->trackPhotoAssistanceTip()V
    :try_end_0
    ...
    new-instance v7, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$P7zT6BehQCTvdikl6tbzG3qHopM;

    invoke-direct {v7, p0}, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$P7zT6BehQCTvdikl6tbzG3qHopM;-><init>(Lcom/android/camera/CameraPreferenceActivity;)V
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/android/camera/BasePreferenceActivity;->onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    new-instance p3, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$Ot4QKb9daY2y59rmzjk9yn1OC8g;

    invoke-direct {p3, p0}, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$Ot4QKb9daY2y59rmzjk9yn1OC8g;-><init>(Lcom/android/camera/CameraPreferenceActivity;)V
    ...
    new-instance p3, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$8de-ZJzOzaGmCrc0vWpppEx-2cY;

    invoke-direct {p3, p0}, Lcom/android/camera/-$$Lambda$CameraPreferenceActivity$8de-ZJzOzaGmCrc0vWpppEx-2cY;-><init>(Lcom/android/camera/CameraPreferenceActivity;)V
...
.method public updatePreferences(Landroid/preference/PreferenceGroup;Landroid/content/SharedPreferences;)V
    ...
    iget-boolean v5, p0, Lcom/android/camera/CameraPreferenceActivity;->mKeyguardLocked:Z
    ...
    invoke-interface {v3, v4, v1}, Lcom/android/camera/data/provider/DataProvider$ProviderEditor;->putBoolean(Ljava/lang/String;Z)Lcom/android/camera/data/provider/DataProvider$ProviderEditor;
