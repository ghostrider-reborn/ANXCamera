...
.method private convert(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0, v2}, Lcom/android/camera/HybridZoomingSystem;->toCropRegion(FLandroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method private sendReprocessRequest()V
    ...
    invoke-virtual {v0, v1, v2, v4, v3}, Lcom/arcsoft/supernight/SuperNightProcess;->init(IIII)I
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/arcsoft/supernight/SuperNightProcess;->addAllInputInfo(Ljava/util/ArrayList;Ljava/util/ArrayList;ILandroid/media/Image;Landroid/graphics/Rect;)I

    iget-object v1, p0, Lcom/android/camera2/SuperNightReprocessHandler;->mSuperNightProcess:Lcom/arcsoft/supernight/SuperNightProcess;

    invoke-virtual {v1}, Lcom/arcsoft/supernight/SuperNightProcess;->unInit()I

    const-string v1, "SNReprocessHandler"

    const-string v2, "sendReprocessRequest:<SNP>: X"
    ...
    const-string v3, "sendReprocessRequest:<CROP>: E "
    ...
    invoke-direct {p0, v7}, Lcom/android/camera2/SuperNightReprocessHandler;->convert(Landroid/graphics/Rect;)Z
    ...
    const-string v3, "sendReprocessRequest:<CROP>: X "
    ...
    iget v2, p0, Lcom/android/camera2/SuperNightReprocessHandler;->mMaxInputImageCount:I
    ...
    invoke-virtual {v1, v0}, Lcom/android/camera2/MiCamera2;->applySettingsForJpeg(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-object v3, p0, Lcom/android/camera2/SuperNightReprocessHandler;->mCaptureStateHandler:Landroid/os/Handler;
    ...
    const-string v1, "sendReprocessRequest:<CAM>: CANCELLED"
...
.method public cancel()V
    ...
    invoke-virtual {v0}, Lcom/arcsoft/supernight/SuperNightProcess;->cancelSuperNight()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera2/SuperNightReprocessHandler;->obtainMessage(I)Landroid/os/Message;
...
.method public prepare(Lcom/android/camera2/MiCamera2ShotRawBurst;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera2/SuperNightReprocessHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
