...
.method public constructor <init>(Landroid/hardware/camera2/CameraDevice;ILcom/android/camera2/CameraCapabilities;Landroid/os/Handler;Landroid/os/Handler;Landroid/os/Handler;)V
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->hd()Z
...
.method private applyCommonSettings(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {p1, p2, v0, v1}, Lcom/android/camera2/CaptureRequestBuilder;->applyMiMovie(Landroid/hardware/camera2/CaptureRequest$Builder;ILcom/android/camera2/CameraCapabilities;Lcom/android/camera2/CameraConfigs;)V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->iv()Z
...
.method private applyFlashMode(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v6, p0, Lcom/android/camera2/MiCamera2;->mPreviewControl:Lcom/android/camera2/MiCamera2Preview;

    invoke-virtual {v6}, Lcom/android/camera2/MiCamera2Preview;->needForCapture()Z
    ...
    iget-object v9, p0, Lcom/android/camera2/MiCamera2;->mCapabilities:Lcom/android/camera2/CameraCapabilities;
    ...
    :goto_5
    invoke-static {v9, p1, v11}, Lcom/android/camera2/CaptureRequestBuilder;->applyScreenLightHint(Lcom/android/camera2/CameraCapabilities;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    const-string/jumbo v11, "tucana"

    sget-object v12, Lcom/mi/config/b;->rp:Ljava/lang/String;
    ...
    :goto_7
    invoke-static {v11, p1, v0}, Lcom/android/camera2/CaptureRequestBuilder;->applyBackSoftLight(Lcom/android/camera2/CameraCapabilities;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    :goto_8
    invoke-static {v0, p1, v11}, Lcom/android/camera2/CaptureRequestBuilder;->applyBackSoftLight(Lcom/android/camera2/CameraCapabilities;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-static {p1, v7}, Lcom/android/camera2/compat/MiCameraCompat;->applySnapshotTorch(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-interface {v8}, Lcom/android/camera2/Camera2Proxy$ScreenLightCallback;->stopScreenLight()V
    ...
    new-instance p2, Lcom/android/camera2/-$$Lambda$MiCamera2$EweFkTTvq0luG1llGAWijdFmQCY;

    invoke-direct {p2, v8}, Lcom/android/camera2/-$$Lambda$MiCamera2$EweFkTTvq0luG1llGAWijdFmQCY;-><init>(Lcom/android/camera2/Camera2Proxy$ScreenLightCallback;)V
    ...
    :cond_16
    :goto_b
    invoke-interface {v8, p1, v0}, Lcom/android/camera2/Camera2Proxy$ScreenLightCallback;->startScreenLight(II)V
...
.method private assertRemoteSurfaceIndexIsValid(I)V
    ...
    const-string v2, "invalid remote surface index "
...
.method private captureStillPicture()V
    ...
    invoke-virtual {p0}, Lcom/android/camera2/MiCamera2;->getParallelCallback()Lcom/xiaomi/camera/core/ParallelCallback;
...
.method private configMaxParallelRequestNumberLock()V
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->if()I
    ...
    :cond_0
    iget v1, p0, Lcom/android/camera2/MiCamera2;->MAX_PARALLEL_REQUEST_NUMBER:I
...
.method private getCaptureInterval()J
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->ho()J
...
.method static synthetic lambda$applyFlashMode$3(Lcom/android/camera2/Camera2Proxy$ScreenLightCallback;)V
    .locals 0
...
.method public static synthetic lambda$preparePreviewImageReader$1(Lcom/android/camera2/MiCamera2;Landroid/media/ImageReader;)V
    .locals 2
...
.method public static synthetic lambda$setCaptureEnable$2(Lcom/android/camera2/MiCamera2;Z)V
    .locals 4
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hp()I
...
.method private lockFocus()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/MiCamera2$PictureCaptureCallback;->getFocusTask()Lcom/android/camera/module/loader/camera2/FocusTask;
    ...
    invoke-virtual {v1}, Lcom/android/camera2/MiCamera2$PictureCaptureCallback;->showAutoFocusStart()V

    iget-object v1, p0, Lcom/android/camera2/MiCamera2;->mCaptureCallback:Lcom/android/camera2/MiCamera2$PictureCaptureCallback;

    iget-object v3, p0, Lcom/android/camera2/MiCamera2;->mCameraHandler:Landroid/os/Handler;

    invoke-direct {p0, v0, v1, v3}, Lcom/android/camera2/MiCamera2;->capture(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;Landroid/os/Handler;)I
    ...
    invoke-direct {p0, v2}, Lcom/android/camera2/MiCamera2;->setAFModeToPreview(I)V
...
.method private prepareRemoteImageReader(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v10}, Lcom/android/camera2/CameraConfigs;->getUltraWidePhotoSize()Lcom/android/camera/CameraSize;
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->hW()Z
    ...
    const-string v7, "[3SAT]prepareRemoteImageReader:uwSize = %s wideSize = %s teleSize = %s"
...
.method private triggerPrecapture()V
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->hB()Z
...
.method private unlockFocusForCapture()V
    ...
    const-string/jumbo v1, "unlockFocusForCapture"
    ...
    const-string/jumbo v3, "unlockFocusForCapture: "
...
.method applySettingsForCapture(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-virtual {p2}, Lcom/mi/config/a;->it()Z
...
.method public close()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/SuperNightReprocessHandler;->getLooper()Landroid/os/Looper;
...
.method public getSATSubCameraIds()[I
    ...
    new-instance v3, Lcom/android/camera2/-$$Lambda$MiCamera2$ZR6_xcFcODN7zPElZlKtti9-NKU;

    invoke-direct {v3, v2}, Lcom/android/camera2/-$$Lambda$MiCamera2$ZR6_xcFcODN7zPElZlKtti9-NKU;-><init>(Ljava/util/HashMap;)V
...
.method public isConfigRawStream()Z
    ...
    iget-boolean v0, p0, Lcom/android/camera2/MiCamera2;->mIsConfigRawStream:Z
...
.method public sendSatFallbackRequest()I
    ...
    const-string v3, "sendSatFallbackRequest: X. requestId = "
...
.method public setAsdDirtyEnable(Z)V
    ...
    invoke-static {p1, v0, v1}, Lcom/android/camera2/CaptureRequestBuilder;->applyAsdDityEnable(Lcom/android/camera2/CameraCapabilities;Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/CameraConfigs;)V
...
.method public setCaptureEnable(Z)V
    ...
    new-instance v1, Lcom/android/camera2/-$$Lambda$MiCamera2$NnFYGlR6ZuZILnhT3UOLXKbCqLY;

    invoke-direct {v1, p0, p1}, Lcom/android/camera2/-$$Lambda$MiCamera2$NnFYGlR6ZuZILnhT3UOLXKbCqLY;-><init>(Lcom/android/camera2/MiCamera2;Z)V
...
.method public setForceBackSoftLight(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera2/CameraConfigs;->setForceBackSoftLight(Z)Z
...
.method public setMiMovie(Z)V
    .locals 1

    iget-object v0, p0, Lcom/android/camera2/MiCamera2;->mConfigs:Lcom/android/camera2/CameraConfigs;

    invoke-virtual {v0, p1}, Lcom/android/camera2/CameraConfigs;->setMiMovieEnabled(Z)V
...
.method public setSuperResolution(Z)V
    ...
    invoke-virtual {v3}, Lcom/mi/config/a;->iv()Z

    move-result v3

    invoke-static {p1, v0, v1, v2, v3}, Lcom/android/camera2/CaptureRequestBuilder;->applySuperResolution(Landroid/hardware/camera2/CaptureRequest$Builder;ILcom/android/camera2/CameraCapabilities;Lcom/android/camera2/CameraConfigs;Z)V
...
.method public startHighSpeedRecordSession(Landroid/view/Surface;Landroid/view/Surface;Landroid/util/Range;Lcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    const-string/jumbo v2, "startHighSpeedRecordSession: previewSurface = "
    ...
    const-string/jumbo v1, "startHighSpeedRecordSession: turns smvrmode to "
    ...
    const-string/jumbo p3, "startHighSpeedRecordSession: turns smvrmode to 240"
...
.method public startPreviewSession(Landroid/view/Surface;ZZZIZLcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    const-string/jumbo v5, "startPreviewSession"
    ...
    const-string/jumbo v7, "startPreviewSession: opMode=0x%x previewCallback=%b configRawStream=%b"
    ...
    iput-boolean v2, v1, Lcom/android/camera2/MiCamera2;->mIsConfigRawStream:Z
    ...
    iget-object v9, v1, Lcom/android/camera2/MiCamera2;->mParallelCaptureSurfaceList:Ljava/util/List;
    ...
    invoke-direct {v15, v14}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/view/Surface;)V
    ...
    invoke-virtual {v7}, Lcom/android/camera2/CameraConfigs;->isParallelDualShotType()Z

    move-result v7

    if-eqz v7, :cond_5

    iget-object v7, v1, Lcom/android/camera2/MiCamera2;->mCapabilities:Lcom/android/camera2/CameraCapabilities;

    invoke-virtual {v7}, Lcom/android/camera2/CameraCapabilities;->getFacing()I
    ...
    check-cast v7, Lcom/xiaomi/protocol/IImageReaderParameterSets;

    iget v7, v7, Lcom/xiaomi/protocol/IImageReaderParameterSets;->targetCamera:I
    ...
    sget-object v14, Lcom/android/camera2/MiCamera2;->TAG:Ljava/lang/String;

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Binds main output stream to camera "
    ...
    invoke-static {v15, v10}, Lcom/android/camera/lib/compatibility/util/CompatibilityUtils;->setPhysicalCameraId(Landroid/hardware/camera2/params/OutputConfiguration;Ljava/lang/String;)V
    ...
    const-string v14, "Binds sub output stream to camera "
    ...
    invoke-virtual {v4, v11}, Landroid/hardware/camera2/CameraDevice;->createCaptureRequest(I)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    const-string/jumbo v8, "startPreviewSession: needsRawStream = "
    ...
    const-string/jumbo v12, "startPreviewSession: setup input configuration: w = "
    ...
    invoke-direct {v0, v1, v4, v7}, Lcom/android/camera2/MiCamera2$CaptureSessionStateCallback;-><init>(Lcom/android/camera2/MiCamera2;ILcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    invoke-virtual {v4, v7, v0}, Landroid/graphics/SurfaceTexture;->setDefaultBufferSize(II)V
    ...
    invoke-direct {v4, v7, v0}, Landroid/hardware/camera2/params/OutputConfiguration;-><init>(Landroid/util/Size;Ljava/lang/Class;)V
    ...
    const-string/jumbo v7, "startPreviewSession: add preview surface to HAL: "
    ...
    invoke-static {v0, v11}, Lcom/android/camera2/compat/MiCameraCompat;->applyZsd(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    sget-object v2, Lcom/android/camera2/vendortag/CaptureRequestVendorTags;->CONTROL_QUICK_PREVIEW:Lcom/android/camera2/vendortag/VendorTag;

    sget-object v3, Lcom/android/camera2/vendortag/CaptureRequestVendorTags;->CONTROL_QUICK_PREVIEW_ON:[I

    invoke-virtual {v0, v2, v3}, Lcom/android/camera2/CaptureSessionConfigurations;->set(Lcom/android/camera2/vendortag/VendorTag;Ljava/lang/Object;)V

    iget-object v0, v1, Lcom/android/camera2/MiCamera2;->mPreviewRequestBuilder:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-static {v0, v11}, Lcom/android/camera2/compat/MiCameraCompat;->applyQuickPreview(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-static {v0, v2, v11}, Lcom/android/camera2/CaptureRequestBuilder;->applySmoothTransition(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/android/camera2/CameraCapabilities;Z)V
...
.method public startRecordPreview()V
    ...
    const-string/jumbo v1, "startRecordPreview"
...
.method public startRecordSession(Landroid/view/Surface;Landroid/view/Surface;ZILcom/android/camera2/Camera2Proxy$CameraPreviewCallback;)V
    ...
    const-string/jumbo v0, "startRecordSession"
    ...
    const-string/jumbo p3, "startRecordSession: operatingMode is "
    ...
    const-string/jumbo p2, "startRecordSession: turns hfpsmode on"
