...
.method private onRepeatingEnd(ZI)V
    ...
    invoke-virtual {p0}, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->getPictureCallback()Lcom/android/camera2/Camera2Proxy$PictureCallback;
...
.method protected generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->isIn3OrMoreSatMode()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->getMainCaptureSurface()Landroid/view/Surface;
    ...
    invoke-direct {v1, v5}, Lcom/android/camera/CameraSize;-><init>(Landroid/util/Size;)V

    iput-object v1, p0, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->mCapturedImageSize:Lcom/android/camera/CameraSize;

    goto :goto_2

    :cond_1
    iget-object v3, p0, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->mMiCamera:Lcom/android/camera2/MiCamera2;
...
.method protected startSessionCapture()V
    ...
    iget-object v4, p0, Lcom/android/camera2/MiCamera2ShotParallelRepeating;->mCameraHandler:Landroid/os/Handler;
