...
.method public constructor <init>(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-virtual {p0, p2}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setEGLContextClientVersion(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setRenderMode(I)V

    invoke-virtual {p0, v0}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setDebugFlags(I)V
    ...
    const-string v0, " get screen resolution:"

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->screenWidth:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    const-string v5, " get screen resolution:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->screenWidth:I
    ...
    iget v5, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->screenHeight:I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setEGLContextClientVersion(I)V

    invoke-virtual {p0, p0}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setRenderer(Landroid/opengl/GLSurfaceView$Renderer;)V

    invoke-virtual {p0, v2}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setRenderMode(I)V

    invoke-virtual {p0, v1}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->setDebugFlags(I)V
...
.method private drawRectangle([ILjava/nio/FloatBuffer;)V
    ...
    iget p1, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->posLocation:I
...
.method private texImage2D(Lcom/xiaomi/rendermanager/videoRender/VideoRenderer$I420Frame;[I)V
    ...
    const-string/jumbo p2, "totalAngle: "
...
.method public CalcRatioViewPort(III)I
    ...
    iget v5, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_oriViewWidth:I
    ...
    iput v3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioHeight:I
    ...
    iput v3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioWidth:I
    ...
    const-string v3, " showsize:"

    invoke-virtual {v8, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, " wRatio:"

    invoke-virtual {v8, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v1}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v3, " hRatio:"

    invoke-virtual {v8, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v2}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v3, " rotateImageWidth:"

    invoke-virtual {v8, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, p3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, " rotateImageHeight:"
    ...
    iget-object v3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->renderModel:Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView$RenderModel;
    ...
    :cond_4
    const-string v3, "VideoStreamsView"
    ...
    iput v1, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->canvasToFrameRatio:F
    ...
    iget v0, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_shiftUpVideoRatio:F
    ...
    iget v0, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_shiftUpVideoRatioDelta:F

    cmpg-float p3, p3, v0

    if-gez p3, :cond_8

    iget p3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_shiftUpViewRatio:F
    ...
    iget v0, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_shiftUpViewRatioDelta:F

    cmpg-float p3, p3, v0

    if-gez p3, :cond_8

    iget p3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioY:I

    int-to-float p3, p3

    iget v0, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_shiftUpVideoValue:F
    ...
    iput p3, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioY:I

    :cond_8
    const-string p3, "VideoStreamsView"

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "VideoStreamView: VideoStreamView opengl setting _RatioX: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioX:I

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, " _RatioY:"
    ...
    const-string v1, " _RatioWidth:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioWidth:I

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, " _RatioHeight:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->_RatioHeight:I
...
.method public onDrawFrame(Ljavax/microedition/khronos/opengles/GL10;)V
    ...
    const-string/jumbo v1, "updateFrames: frame is null !"
    ...
    iget v4, p1, Lcom/xiaomi/rendermanager/videoRender/VideoRenderer$I420Frame;->rotateAngle:I
    ...
    :cond_8
    iget-wide v4, p0, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->numFramesSinceLastLog:J
...
.method public onSurfaceChanged(Ljavax/microedition/khronos/opengles/GL10;II)V
    ...
    const-string v1, "VideoStreamView: On Surface changed with with:"
...
.method public onSurfaceCreated(Ljavax/microedition/khronos/opengles/GL10;Ljavax/microedition/khronos/egl/EGLConfig;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, p1}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->generateTexture(II)V
    :try_end_0
    ...
    const-string p2, "VideoStreamsView"
    ...
    const-string/jumbo v1, "width_stride"
    ...
    const-string/jumbo v1, "sharpCoff"
    ...
    const-string/jumbo v1, "sharpStrength"
    ...
    const-string/jumbo v1, "sourceCoff"
...
.method public renderFrame(Lcom/xiaomi/rendermanager/videoRender/VideoRenderer$I420Frame;)V
    ...
    const-string v0, "VideoStreamView: The render thread is not running, so we discard this frame."
    ...
    const-string/jumbo v1, "updateFrame renderFrame framesToRender is null"
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/rendermanager/videoRender/VideoStreamsView;->queueEvent(Ljava/lang/Runnable;)V
...
.method public surfaceCreated(Landroid/view/SurfaceHolder;)V
    ...
    const-string/jumbo v2, "surfaceCreated, this pointer is  "
...
.method public surfaceDestroyed(Landroid/view/SurfaceHolder;)V
    ...
    const-string/jumbo v2, "surfaceDestroyed, this pointer is  "
