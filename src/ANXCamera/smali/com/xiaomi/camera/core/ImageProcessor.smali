...
.method protected doFilter(Lcom/xiaomi/camera/core/ImageProcessor$FilterTaskData;)V
    ...
    invoke-virtual {v5, v7}, Landroid/hardware/camera2/TotalCaptureResult;->get(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :goto_0
    invoke-static {v0, v6, v5}, Lcom/xiaomi/camera/algoup/NoiseReduction;->doChromaNR(Landroid/media/Image;II)I
...
.method public startWork()V
    ...
    const-string/jumbo v2, "startWork: %s started"
...
.method public declared-synchronized stopWork()V
    ...
    const-string/jumbo v2, "stopWork: %s stopped"
...
.method public declared-synchronized stopWorkWhenIdle()V
    ...
    const-string/jumbo v1, "stopWorkWhenIdle"
