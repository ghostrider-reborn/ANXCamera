...
.method private getAudioManagerMode()I
    ...
    invoke-virtual {v0}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->getAECType()I
...
.method public addVideoStream(IILcom/xiaomi/conferencemanager/ConferenceManager$VideoContentTypeT;)J
    ...
    invoke-virtual {p3}, Lcom/xiaomi/conferencemanager/ConferenceManager$VideoContentTypeT;->ordinal()I
    ...
    const-string p1, "ConferenceManageraddVideoStream error, please init the engine first"
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->addVideoStream(III)J
...
.method public enableCameraRotation(Z)V
    ...
    const-string p1, "ConferenceManagerenableCameraRotation error, please init the engine first"
    ...
    const-string p1, "set camera rotate done"

    invoke-static {p1}, Lcom/xiaomi/utils/Logger;->LogI(Ljava/lang/String;)V
...
.method public enableMonitorTraffic(Z)V
    ...
    const-string/jumbo v1, "setting enableMonitorTraffic "
...
.method public getUserPlayoutVolume(Ljava/lang/String;)I
    ...
    const-string p1, "ConferenceManager getParticipantsVolume error, please init the engine first"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->getUserPlayoutVolume(Ljava/lang/String;)I
...
.method public init(Landroid/content/Context;JLjava/lang/String;Lcom/xiaomi/conferencemanager/callback/ConferenceCallback;)Z
    ...
    const-string p1, "ConferenceManagerinit error, please destroy the engine first"
    ...
    invoke-interface {p5, p1}, Lcom/xiaomi/conferencemanager/callback/ConferenceCallback;->onLoad(Z)V
...
.method public isInConference()Z
    ...
    const-string v0, "ConferenceManager isInConference error, please init the engine first"
    ...
    invoke-virtual {v0}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->isInConference()Z
...
.method public joinRoom(Ljava/lang/String;Ljava/lang/String;ZZZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/conferencemanager/ConferenceManager$ConferenceManagerRole;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p9 .. p9}, Lcom/xiaomi/conferencemanager/ConferenceManager$ConferenceManagerRole;->ordinal()I
...
.method public localParticipantSetDynamicViewPolicy(Lcom/xiaomi/conferencemanager/ConferenceManager$DynamicViewPolicyT;)V
    ...
    const-string/jumbo v0, "setting local participant dynamic view policy"
    ...
    const-string p1, "ConferenceManagerlocalParticipantSetDynamicViewPolicy error, please init the engine first"
    ...
    const-string p1, "set local participant dynamic view policy done"
...
.method public muteMicrophone()Z
    ...
    invoke-virtual {v0, v1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->MuteMicrophone(Z)V

    const-string v0, "mute Microphone succeeded"
...
.method public muteUserAudio(Ljava/lang/String;Z)V
    ...
    const-string p1, "ConferenceManager muteUserAudio error, please init the engine first"
...
.method public muteVideo()Z
    ...
    const-string v0, "ConferenceManagermuteVideo error, please init the engine first"
    ...
    invoke-virtual {v0, v2}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->MuteVideo(Z)Z

    move-result v0

    if-nez v0, :cond_1

    const-string v0, "ConferenceManagermute video failed"
...
.method public removeVideoStream(J)V
    ...
    const-string p1, "ConferenceManagerremoveVideoStream error, please init the engine first"
    ...
    invoke-virtual {v0, p1, p2}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->removeVideoStream(J)V
...
.method public setAutoStartDevice(Z)V
    ...
    const-string p1, "ConferenceManagerset AutoStart Device error, please init the engine first"
...
.method public setCallResolutionMode(II)V
    ...
    const-string p1, "ConferenceManager setCallResolutionMode error, please init the engine first"
...
.method public setEncoderMaxBitRate(I)I
    ...
    const-string/jumbo v1, "setting encoder max bitrate to "
    ...
    const-string p1, "ConferenceManagersetEncoderMaxBitRate error, please init the engine first"
    ...
    const-string p1, "set encoder max bitrate done"
...
.method public setGslbConfig([B)Z
    ...
    const-string p1, "ConferenceManager setGslbConfig, please init the engine first"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->SetGslbConfig([B)Z

    move-result p1

    if-nez p1, :cond_1

    const-string p1, "ConferenceManagersetGslbConfig failed"
    ...
    :cond_1
    const-string p1, "setGslbConfig succeeded"
...
.method public setLocalNetWork(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "setting local netWork to "
    ...
    const-string p1, "ConferenceManagersetLocalNetwork error, please init the engine first"
    ...
    const-string p1, "set local netWork done"
...
.method public setMirrorCamera(Z)V
    ...
    const-string p1, "ConferenceManager setMirrorCamera error, please init the engine first"
...
.method public setPlayoutVolume(I)V
    ...
    const-string p1, "ConferenceManager setVolume error, please init the engine first"
...
.method public setPowerStatus(IZ)I
    ...
    const-string/jumbo v1, "setting power status: power left to "
    ...
    const-string p1, "ConferenceManagersetPowerStatus error, please init the engine first"
    ...
    const-string p1, "set power status done"
...
.method public setRemoteNetWork(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "setting remotel netWork to "
    ...
    const-string p1, "ConferenceManagersetRemoteNetwork error, please init the engine first"
    ...
    const-string p1, "set remote netWork done"
...
.method public setScreenFps(I)Z
    ...
    const-string p1, "ConferenceManagersetScreenFps error, please init the engine first"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->setScreenFps(I)Z

    move-result p1

    if-nez p1, :cond_1

    const-string p1, "ConferenceManagerset screen fps false"
    ...
    :cond_1
    const-string p1, "set screen fps done"
...
.method public setScreenResolution(II)Z
    ...
    const-string p1, "ConferenceManagersetScreenResolution error, please init the engine first"
    ...
    invoke-virtual {v0, p1, p2}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->setScreenResolution(II)Z

    move-result p1

    if-nez p1, :cond_1

    const-string p1, "ConferenceManagerset screen resolution false"
    ...
    :cond_1
    const-string p1, "set screen resolution done"
...
.method public startSpeakingMonitor()V
    ...
    const-string v0, "ConferenceManager startSpeakingMonitor error, please init the engine first"
    ...
    invoke-virtual {v0}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->startSpeakingMonitor()V
...
.method public startVideo()Z
    ...
    const-string/jumbo v0, "starting video..."
    ...
    const-string v0, "ConferenceManagerstartVideo error, please init the engine first"
    ...
    invoke-virtual {v0, v2}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->StartVideo(Z)Z

    move-result v0

    if-nez v0, :cond_1

    const-string v0, "ConferenceManagerstart video failed"
    ...
    :cond_1
    const-string/jumbo v0, "start video succeeded"
...
.method public startVolumeMonitor(I)V
    ...
    const-string p1, "ConferenceManager startVolumeMonitor error, please init the engine first"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->startVolumeMonitor(I)V
...
.method public stopSpeakingMonitor()V
    ...
    const-string v0, "ConferenceManager stopSpeakingMonitor error, please init the engine first"
    ...
    invoke-virtual {v0}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->stopSpeakingMonitor()V
...
.method public stopVideo()Z
    ...
    const-string/jumbo v0, "stopping video..."
    ...
    const-string v0, "ConferenceManagerstopVideo error, please init the engine first"
    ...
    invoke-virtual {v0, v1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->StartVideo(Z)Z

    move-result v0

    if-nez v0, :cond_1

    const-string v0, "ConferenceManagerstop video failed"
    ...
    :cond_1
    const-string/jumbo v0, "stop video succeeded"
...
.method public stopVolumeMonitor()V
    ...
    const-string v0, "ConferenceManager stopVolumeMonitor error, please init the engine first"
    ...
    invoke-virtual {v0}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->stopVolumeMonitor()V
...
.method public switchVideoContent(Lcom/xiaomi/conferencemanager/ConferenceManager$VideoContentTypeT;)Z
    ...
    const-string/jumbo v1, "switch video content type to:"
    ...
    const-string p1, "ConferenceManagerswitch video content error, please init the engine first"
    ...
    invoke-virtual {v0, p1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->switchVideoContent(Lcom/xiaomi/conferencemanager/ConferenceManager$VideoContentTypeT;)Z

    move-result p1

    if-nez p1, :cond_1

    const-string p1, "ConferenceManagerswitch video content false"
    ...
    :cond_1
    const-string/jumbo p1, "switch video content done"
...
.method public unMuteMicrophone()Z
    ...
    const-string/jumbo v0, "unmuting unMuteMicrophone..."
    ...
    const-string v0, "ConferenceManagerunMuteMic error, please init the engine first"
    ...
    const-string/jumbo v0, "unmute unMuteMicrophone succeeded"
...
.method public unMuteVideo()Z
    ...
    const-string/jumbo v0, "unmuting video..."
    ...
    const-string v0, "ConferenceManagerunMuteVideo error, please init the engine first"
    ...
    invoke-virtual {v0, v1}, Lcom/xiaomi/conferencemanager/ConferenceEngine;->MuteVideo(Z)Z

    move-result v0

    if-nez v0, :cond_1

    const-string v0, "ConferenceManagerunmute video failed"
    ...
    :cond_1
    const-string/jumbo v0, "unmute video succeeded"
