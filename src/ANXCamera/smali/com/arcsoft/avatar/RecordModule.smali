...
.method private a(IIIZ)V
    ...
    iget p2, p0, Lcom/arcsoft/avatar/RecordModule;->r:I
    ...
    const-string/jumbo p2, "video_test_log"
    ...
    iput-boolean p2, p0, Lcom/arcsoft/avatar/RecordModule;->J:Z
    ...
    iget-object p2, p0, Lcom/arcsoft/avatar/RecordModule;->N:Lcom/arcsoft/avatar/RecordModule$MediaResultCallback;

    if-eqz p2, :cond_1

    iget-object p2, p0, Lcom/arcsoft/avatar/RecordModule;->N:Lcom/arcsoft/avatar/RecordModule$MediaResultCallback;

    invoke-interface {p2, p1}, Lcom/arcsoft/avatar/RecordModule$MediaResultCallback;->onCaptureResult(Ljava/nio/ByteBuffer;)V
...
.method private c()Z
    ...
    const-string/jumbo v2, "shelterFlags == null"
...
.method public changeHumanTemplate(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "test_log_c"
    ...
    const-string/jumbo p1, "test_log_c"
...
.method public startProcess(Lcom/arcsoft/avatar/util/ASVLOFFSCREEN;IZ)Z
    ...
    const-string/jumbo p2, "startProcess_1() failed, engine is not inited. "
...
.method public startRender(IZIIZ[I[BZ)V
    ...
    check-cast v15, Lcom/arcsoft/avatar/util/ASVLOFFSCREEN;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-virtual {v15}, Lcom/arcsoft/avatar/util/ASVLOFFSCREEN;->getHeight()I

    move-result v2

    if-lez v2, :cond_6

    invoke-virtual {v15}, Lcom/arcsoft/avatar/util/ASVLOFFSCREEN;->getWidth()I
    ...
    invoke-virtual {v3, v15, v4, v5, v0}, Lcom/arcsoft/avatar/AvatarEngine;->renderBackgroundWithImageData(Lcom/arcsoft/avatar/util/ASVLOFFSCREEN;IZ[I)I
    ...
    invoke-virtual {v3, v4, v14, v14}, Lcom/arcsoft/avatar/AvatarEngine;->renderBackgroundWithTexture(IIZ)I
    ...
    invoke-direct {v1, v3, v4, v2, v13}, Lcom/arcsoft/avatar/RecordModule;->a(IIIZ)V
    ...
    const-string/jumbo v4, "startRender meet error = "
    ...
    const-string/jumbo v2, "startRender() failed, engine is not inited or startRender process not ready! "
