...
public class VideoCaptureAndroid implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    public void isVideoZoomSupportedOnCameraThread(Exchanger<Boolean> exchanger) {
        ...
        } else if (this.camera.getParameters().isZoomSupported()) {
    ...
    public void setPreviewRotationOnCameraThread(int i) {
        ...
        if (this.camera != null) {
            int i2 = this.info.facing == 1 ? (360 - this.info.orientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT : this.info.orientation;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0108, code lost:
        ...
        exchange(r6, false);
     */
    /* JADX WARNING: Removed duplicated region for block: B:27:0x00ee A[ExcHandler: RuntimeException (e java.lang.RuntimeException), Splitter:B:1:0x0030] */
