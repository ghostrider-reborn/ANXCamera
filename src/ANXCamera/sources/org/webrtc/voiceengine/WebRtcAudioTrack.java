...
class WebRtcAudioTrack {
    ...
    private int GetPlayoutVolume() {
        if (this._audioManager == null && this._context != null) {
            this._audioManager = (AudioManager) this._context.getSystemService(VEEditor.MVConsts.TYPE_AUDIO);
        }
    ...
    private int InitPlayback(int i, int i2, int i3) {
        ...
        try {
            AudioTrack audioTrack = new AudioTrack(i3, i, i2, 2, i4, 1);
            ...
            return this._audioManager.getStreamMaxVolume(i3);
        } catch (Exception e) {
            DoLog(e.getMessage());
            return -1;
        }
