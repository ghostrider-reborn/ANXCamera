...
public class TrackFragmentHeaderBox extends FullBox {
    ...
    public static class Factory {
        ...
        public Factory baseDataOffset(long j) {
            this.box.flags |= 1;
            long unused = this.box.baseDataOffset = (long) ((int) j);
            return this;
        }
        ...
        public Factory defaultSampleDuration(long j) {
            this.box.flags |= 8;
            int unused = this.box.defaultSampleDuration = (int) j;
            return this;
        }

        public Factory defaultSampleFlags(long j) {
            this.box.flags |= 32;
            int unused = this.box.defaultSampleFlags = (int) j;
            return this;
        }

        public Factory defaultSampleSize(long j) {
            this.box.flags |= 16;
            int unused = this.box.defaultSampleSize = (int) j;
            return this;
        }

        public Factory sampleDescriptionIndex(long j) {
            this.box.flags |= 2;
            int unused = this.box.sampleDescriptionIndex = (int) j;
            return this;
        }
    }
