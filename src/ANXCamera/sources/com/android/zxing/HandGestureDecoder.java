...
public class HandGestureDecoder extends Decoder {
    ...
    public int decode(PreviewImage previewImage) {
        ...
        return this.mHandGesture.detectGesture(previewImage.getData(), previewImage.getWidth(), previewImage.getHeight(), this.mCameraId == 1 ? 270 - orientation : (90 + orientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT);
    }
