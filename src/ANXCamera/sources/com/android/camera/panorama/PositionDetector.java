...
public class PositionDetector {
    ...
    public PositionDetector(MorphoPanoramaGP3.InitParam initParam, ViewGroup viewGroup, boolean z, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        switch (this.direction) {
            case 0:
                if ((this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 90 || (this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 180) {
                    this.peak = (double) i5;
                } else {
                    this.peak = 0.0d;
                }
    ...
    private boolean isComplete() {
        ...
        return (i3 == 1 || i3 == 3) ? (this.mInitParam.output_rotation == 90 || this.mInitParam.output_rotation == 0) ? d > ((double) (i2 - (i / 2))) : d < ((double) (i / 2)) : (this.mInitParam.output_rotation == 90 || this.mInitParam.output_rotation == 0) ? d < ((double) (i / 2)) : d > ((double) (i2 - (i / 2)));
    }
    ...
    private boolean isReverse() {
        ...
        boolean z2 = false;
        if (i2 == 1 || i2 == 3 ? !((this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 90 || (this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 180) : !((this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 0 || (this.mInitParam.output_rotation + this.mCameraOrientation) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 270)) {
    ...
    private void updateFrame() {
        ...
        if (rect.width() > 0) {
            if (this.mInitParam.output_rotation == 90) {
                ...
                float f7 = (float) (((double) this.output_width) - this.cur_x);
                f2 = (float) ((this.cur_y / ((double) this.output_height)) * ((double) rect.height()));
                ...
                f2 = (float) ((this.cur_x / ((double) this.output_width)) * ((double) rect.height()));
                float f8 = (float) (((double) this.output_height) - this.cur_y);
