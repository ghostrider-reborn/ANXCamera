...
public class EffectController {
    ...
    private FilterFactory.FilterScene convertToFilterScene(int i) {
        switch (i) {
            ...
            case 6:
                return FilterFactory.FilterScene.LIGHTING;
            default:
    ...
    private RenderGroup getPrivateRender(GLCanvas gLCanvas, RenderGroup renderGroup, boolean z, boolean z2, int i) {
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_TILTSHIFT) == null && b.jH() && (z || i2 == FilterInfo.FILTER_ID_TILTSHIFT || (i2 < 0 && !z3))) {
        ...
        if (d.getBoolean(d.wX, false) || renderGroup2.getRender(FilterInfo.FILTER_ID_GAUSSIAN) != null || (!z && i2 != FilterInfo.FILTER_ID_GAUSSIAN && (i2 >= 0 || z3))) {
            z4 = z3;
        ...
        if (renderGroup2.getRender(FilterInfo.FILTER_ID_PEAKINGMF) == null && b.jw() && !z2 && (z || i2 == FilterInfo.FILTER_ID_PEAKINGMF || (i2 < 0 && !z4))) {
        ...
        synchronized (this) {
            ...
            if (!isDualCameraWaterMarkOpen && !isFrontCameraWaterMarkOpen && !isTimeWaterMarkOpen && !isAgeGenderWaterMarkOpen) {
                if (!isMagicMirrorWaterMarkOpen) {
                    z2 = false;
                    boolean z4 = !fQ && z2;
                    if (iH && (z3 || isSquareModule || isTiltShiftOn || z4)) {
                        z = true;
                    }
                }
            }
