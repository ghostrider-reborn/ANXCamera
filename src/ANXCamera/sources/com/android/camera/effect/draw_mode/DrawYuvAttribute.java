...
public class DrawYuvAttribute extends DrawAttribute {
    ...
    public DrawYuvAttribute(Image image, Size size, Size size2, int i, int i2, int i3, float f, long j, boolean z, boolean z2, String str, String str2, EffectController.EffectRectAttribute effectRectAttribute, List<WaterMarkData> list) {
        this.mImage = image;
    ...
    public boolean isOutputSquare() {
        return this.mOutputSize != null && this.mOutputSize.getWidth() == this.mOutputSize.getHeight();
    }
}
