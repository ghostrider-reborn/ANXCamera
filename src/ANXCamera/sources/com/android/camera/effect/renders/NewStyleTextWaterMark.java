...
public class NewStyleTextWaterMark extends WaterMark {
    ...
    public NewStyleTextWaterMark(String str, int i, int i2, int i3, boolean z) {
        ...
        double d2 = 43.687002653d;
        if (this.mIsMiMovie) {
            int miMovieMargin = Util.getMiMovieMargin();
            if (i3 == 90 || i3 == 270) {
                double d3 = ((double) miMovieMargin) + 43.687002653d;
                d = 43.687002653d;
                d2 = d3;
            } else {
                d = ((double) miMovieMargin) + 43.687002653d;
            }
        } else {
            d = 43.687002653d;
        }
        ...
        this.mPaddingX = ((int) Math.round(d2 * d4)) & -2;
        this.mPaddingY = (((int) Math.round(d * d4)) - this.mCharMargin) & -2;
        calcCenterAxis();
        if (Util.sIsDumpLog) {
            print();
        }
