    ...
    private class EGLHandler extends Handler {
        ...
        private byte[] applyEffect(DrawJPEGAttribute drawJPEGAttribute, int i, boolean z, Size size, Size size2) {
            ...
            if (thumbnailBytes == null) {
                ...
                return null;
            } else if (!z2 && drawJPEGAttribute3.mEffectIndex == FilterInfo.FILTER_ID_NONE && !CameraSettings.isAgeGenderAndMagicMirrorWaterOpen() && !CameraSettings.isTiltShiftOn()) {
                ...
                if (drawJPEGAttribute2.mApplyWaterMark) {
                    ...
                    i7 = i10;
                    eGLHandler.drawTimeWaterMark(drawJPEGAttribute2, i10, i8, i6, i2, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
                    if (!DataRepository.dataItemFeature().hE() || drawJPEGAttribute2.mInfo == null || !drawJPEGAttribute2.mInfo.isFrontCamera()) {
                        eGLHandler.drawDoubleShotWaterMark(drawJPEGAttribute2, i7, i8, i6, i2, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
                    } else {
                        eGLHandler.drawFrontCameraWaterMark(drawJPEGAttribute2, i7, i8, i6, i2, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
                    }
                    iArr = iArr2;
                    bArr = bArr2;
                } else {
        ...
        private byte[] applyEffectOnlyWatermarkRange(DrawJPEGAttribute drawJPEGAttribute, Size size, Size size2) {
            ...
            drawTimeWaterMark(drawJPEGAttribute2, i15, i16, i12, i11, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
            if (!DataRepository.dataItemFeature().hE() || drawJPEGAttribute2.mInfo == null || !drawJPEGAttribute2.mInfo.isFrontCamera()) {
                drawDoubleShotWaterMark(drawJPEGAttribute2, i19, i17, i12, i11, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
            } else {
                drawFrontCameraWaterMark(drawJPEGAttribute2, i19, i17, i12, i11, drawJPEGAttribute2.mJpegOrientation, (WaterMark) null);
            }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:28:0x018d  */
        /* JADX WARNING: Removed duplicated region for block: B:33:0x01f1  */
        /* JADX WARNING: Removed duplicated region for block: B:37:0x0209  */
        /* JADX WARNING: Removed duplicated region for block: B:53:0x04a6  */
        /* JADX WARNING: Removed duplicated region for block: B:56:0x04b8  */
        /* JADX WARNING: Removed duplicated region for block: B:59:0x04d9  */
        ...
        private void blockSplitApplyEffect(DrawJPEGAttribute drawJPEGAttribute, int i, boolean z, Size size, Size size2) {
            ...
            if (drawJPEGAttribute2.mRequestModuleIdx != 165) {
                ...
                while (i8 < split.size()) {
                    ...
                    rectF2.right = (float) (offset[0] + i14);
                    rectF2.bottom = (float) (offset[1] + i15);
                    int i24 = i22 - offset[0];
                    int i25 = i21 - offset[1];
                    SnapshotEffectRender.this.mGLCanvas.getState().pushState();
                    DrawJPEGAttribute drawJPEGAttribute3 = drawJPEGAttribute;
                    List<WaterMarkData> list = drawJPEGAttribute3.mWaterInfos;
                    int i26 = drawJPEGAttribute3.mJpegOrientation;
                    List<Block> list2 = split;
                    boolean z3 = drawJPEGAttribute3.mIsPortraitRawData;
                    int i27 = i21;
                    int i28 = i23;
                    int i29 = i22;
                    ...
                    drawAgeGenderAndMagicMirrorWater(list, i30, i33, i36, i11, i19, i17, i41, z3);
                    if (drawJPEGAttribute2.mApplyWaterMark) {
                        if (rectangle_collision(rectF4.left, rectF4.top, rectF4.width(), rectF4.height(), rectF5.left, rectF5.top, rectF5.width(), rectF5.height())) {
                            ...
                            if (!DataRepository.dataItemFeature().hE() || drawJPEGAttribute2.mInfo == null || !drawJPEGAttribute2.mInfo.isFrontCamera()) {
                                ...
                                objArr[c] = Integer.valueOf(list3.size());
                                SnapshotEffectRender.this.mFrameCounter.tick(String.format("[loop%d/%d]gl gldraw", objArr));
                                GLES20.glFinish();
                                SnapshotEffectRender.this.mGraphicBuffer.readBuffer(i38, i31, i28);
                                Object[] objArr2 = new Object[i9];
                                objArr2[0] = Integer.valueOf(i42);
                                objArr2[c] = Integer.valueOf(list3.size());
                                ...
                                objArr3[c] = Integer.valueOf(list3.size());
                                ...
                                objArr22[c] = Integer.valueOf(list3.size());
                    ...
                    objArr32[c] = Integer.valueOf(list3.size());
                    ...
                    objArr222[c] = Integer.valueOf(list3.size());
        ...
        private void checkFrameBuffer(int i, int i2) {
            if (SnapshotEffectRender.this.mFrameBuffer == null || SnapshotEffectRender.this.mFrameBuffer.getWidth() < i || SnapshotEffectRender.this.mFrameBuffer.getHeight() < i2) {
                ...
                FrameBuffer unused2 = SnapshotEffectRender.this.mFrameBuffer = new FrameBuffer(SnapshotEffectRender.this.mGLCanvas, i, i2, 0);
            }
        }
        ...
        private WaterMark drawDoubleShotWaterMark(DrawJPEGAttribute drawJPEGAttribute, int i, int i2, int i3, int i4, int i5, WaterMark waterMark) {
            ...
            if (waterMark2 != null) {
                ...
                if (!drawJPEGAttribute2.mIsUtralPixelWatermarkEnabled || DataRepository.dataItemFeature().gU() || !equals) {
                    if (!SnapshotEffectRender.this.mCurrentCustomWaterMarkText.equals(CameraSettings.getCustomWatermark())) {
                        ...
                        Bitmap unused2 = SnapshotEffectRender.this.mDualCameraWaterMarkBitmap = SnapshotEffectRender.this.loadCameraWatermark(SnapshotEffectRender.this.mContext);
                    } else if (SnapshotEffectRender.this.mDualCameraWaterMarkBitmap == null) {
                        Bitmap unused3 = SnapshotEffectRender.this.mDualCameraWaterMarkBitmap = SnapshotEffectRender.this.loadCameraWatermark(SnapshotEffectRender.this.mContext);
                    }
                    ...
                    ImageWaterMark imageWaterMark = new ImageWaterMark(bitmap, i3, i4, i8, SnapshotEffectRender.this.mDualCameraWaterMarkSizeRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingXRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingYRatio, false);
                    drawWaterMark(imageWaterMark, i6, i7, i8);
                    return imageWaterMark;
                }
                if (SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap == null) {
                    Bitmap unused4 = SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap = SnapshotEffectRender.this.loadUltraPixelWatermark(SnapshotEffectRender.this.mContext);
                }
                if (SnapshotEffectRender.this.mUltraPixelCameraWaterMarkBitmap != null) {
        ...
        private boolean drawThumbJpeg(DrawJPEGAttribute drawJPEGAttribute, boolean z) {
            ...
            Size size = new Size();
            byte[] applyEffect = applyEffect(drawJPEGAttribute2, 1, true, size, (Size) null);
            String access$1000 = SnapshotEffectRender.TAG;
            StringBuilder sb = new StringBuilder();
        ...
        private void initEGL(EGLContext eGLContext, boolean z) {
            ...
            if (SnapshotEffectRender.this.mRenderSurface == null) {
                PbufferSurface unused3 = SnapshotEffectRender.this.mRenderSurface = new PbufferSurface(SnapshotEffectRender.this.mEglCore, 1, 1);
            }
            SnapshotEffectRender.this.mRenderSurface.makeCurrent();
        }
                    ...
                    case 2:
                        ...
                        if (drawJPEGAttribute2.mWidth == 0 || drawJPEGAttribute2.mHeight == 0) {
                            ...
                            if (drawJPEGAttribute2.mData != null) {
                                z = drawJPEGAttribute2.mData.length;
                            }
                        ...
                        int unused3 = SnapshotEffectRender.this.mBlockWidth = drawJPEGAttribute2.mWidth;
