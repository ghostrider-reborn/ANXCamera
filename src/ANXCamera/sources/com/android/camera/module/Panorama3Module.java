...
public class Panorama3Module extends BaseModule implements ModeProtocol.CameraAction, Camera2Proxy.CameraPreviewCallback {
    ...
    private class PanoramaFirst extends PanoramaState {
        ...
        public boolean onSaveImage(CaptureImage captureImage) {
            ...
            PanoramaState unused2 = Panorama3Module.this.mPanoramaState = new DecideDirection();
    ...
    private class PanoramaPreview extends PanoramaState {
        ...
        private class PreviewAttach extends AttachRunnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:25:0x01fe, code lost:
                return;
             */
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:35:0x010d, code lost:
                com.android.camera.log.Log.d(com.android.camera.module.Panorama3Module.access$300(), "preview attach end");
             */
                    ...
                    if (Panorama3Module.this.mMorphoPanoramaGP3 == null) {
                        ...
                        if (width != 0) {
                            if (height != 0) {
                                ...
                                String generateFilepath4Jpeg = Storage.generateFilepath4Jpeg(access$1100);
                                if (!Panorama3Module.this.savePanoramaFile(generateFilepath4Jpeg, width, height)) {
                                    Panorama3Module.this.finishEngine();
                                    return;
                                }
                                Panorama3Module.this.addImageAsApplication(generateFilepath4Jpeg, access$1100, width, height, Panorama3Module.this.calibrateRotation(1));
                                Panorama3Module.this.finishEngine();
    ...
    public void addImageAsApplication(String str, String str2, int i, int i2, int i3) {
        ...
        if (!Storage.isUseDocumentMode()) {
            ...
            try {
                ...
                Log.e(TAG, "open file failed, filePath " + str3, e);
            }
        }
        ...
        if (addImageForGroupOrPanorama == null) {
            Log.w(TAG, "insert MediaProvider failed, attempt to find uri by path, " + str3);
            addImageForGroupOrPanorama = MediaProviderUtil.getContentUriFromPath(CameraAppImpl.getAndroidContext(), str3);
        }
        Log.d(TAG, "addImageAsApplication uri = " + addImageForGroupOrPanorama + ", path = " + str3);
    ...
    public boolean createEngine() {
        ...
        String str = TAG;
        Log.d(str, "lensType " + cameraLensType);
    ...
    public void initPreviewLayout() {
        if (isAlive()) {
            ...
            ((ModeProtocol.PanoramaProtocol) ModeCoordinatorImpl.getInstance().getAttachProtocol(176)).initPreviewLayout((width * dimensionPixelSize) / ((int) (((float) cameraScreenNail.getHeight()) * this.mLongSideCropRatio)), dimensionPixelSize, this.mPreviewSize.width, this.mPreviewSize.height);
        }
    }
    ...
    private void onStopShooting(boolean z) {
        ...
        if (this.mDispPreviewImage != null) {
            this.mDispPreviewImage.eraseColor(0);
        }
        onSaveFinish();
    }
    ...
    public boolean savePanoramaFile(String str, int i, int i2) {
        ...
        int jpegQuality = (getJpegQuality(false) * 256) / 100;
        if (Storage.isUseDocumentMode()) {
            try {
                ...
                e = e2;
                i3 = -1;
                Log.e(TAG, "open file failed, filePath " + str2, e);
                r10 = 1;
                if (i3 != 0) {
                }
            }
            ...
            r10 = 1;
            i3 = this.mMorphoPanoramaGP3.savePanorama360(i, i2, str2, jpegQuality, this.mShutterStartTime, this.mShutterEndTime, false, galleryInfoData, false);
        }
        if (i3 != 0) {
    ...
    public void setSensorFusionValue(CaptureImage captureImage) {
        if (this.mMorphoPanoramaGP3 != null && this.mSensorFusion != null) {
            int[] iArr = new int[4];
            int sensorMatrix = this.mSensorFusion.getSensorMatrix((double[]) null, (double[]) null, (double[]) null, iArr);
            if (sensorMatrix != 0) {
    ...
    private void updatePictureAndPreviewSize() {
        CameraSize bestPanoPictureSize = getBestPanoPictureSize(this.mCameraCapabilities.getSupportedOutputSize(256), DataRepository.dataItemFeature().hV());
        this.mPreviewSize = Util.getOptimalPreviewSize(false, this.mBogusCameraId, this.mCameraCapabilities.getSupportedOutputSize(SurfaceTexture.class), (double) CameraSettings.getPreviewAspectRatio(bestPanoPictureSize.width, bestPanoPictureSize.height));
    ...
    public void onCreate(int i, int i2) {
        ...
        this.mGoalAngle = DataRepository.dataItemFeature().gA();
        this.mLongSideCropRatio = DataRepository.dataItemFeature().gB();
    ...
    public void startPanoramaShooting() {
        ...
        synchronized (this.mDeviceLock) {
            ...
            if (this.mAwbLockSupported && DataRepository.dataItemFeature().hO()) {
