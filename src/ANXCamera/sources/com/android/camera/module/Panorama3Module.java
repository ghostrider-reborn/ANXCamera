...
public class Panorama3Module extends BaseModule implements CameraAction, CameraPreviewCallback {
    ...
    private class DecideDirection extends PanoramaState {
        ...
        private class DecideDirectionAttach extends AttachRunnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:52:?, code lost:
                closeSrc();
                com.android.camera.module.Panorama3Module.access$3702(r1.this$1.this$0, r0);
                createDirection(r0);
             */
            /* JADX WARNING: Code restructure failed: missing block: B:53:0x01d5, code lost:
                if (com.android.camera.module.Panorama3Module.access$3800(r1.this$1.this$0).enabled() == false) goto L_0x0002;
             */
            public void run() {
                int i;
                while (true) {
            ...
            if (!Panorama3Module.this.isCreated()) {
                ...
                if (i != 2) {
                    if (i == 17) {
                        ...
                        Panorama3Module panorama3Module3 = Panorama3Module.this;
                        if (uIStyleByPreview != panorama3Module3.mUIStyle) {
                            panorama3Module3.mUIStyle = uIStyleByPreview;
                        }
    ...
    private class PanoramaPreview extends PanoramaState {
        ...
        private class PreviewAttach extends AttachRunnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:34:0x010a, code lost:
                if (r1.mIsAttachEnd == false) goto L_0x0116;
             */
            ...
            /* JADX WARNING: Unknown top exception splitter block from list: {B:49:0x0127=Splitter:B:49:0x0127, B:27:0x00b8=Splitter:B:27:0x00b8} */
            public void run() {
                int i;
                double[] dArr;
        ...
        private class UiUpdateRunnable implements Runnable {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:19:0x0084, code lost:
                com.android.camera.module.Panorama3Module.access$6402(r5.this$1.this$0, java.lang.Math.min(r3, r4) / 2);
    ...
    private void registerSensorListener() {
        if (!this.mIsRegisterSensorListener) {
            ...
            if (sensor != null) {
                this.mSensorManager.registerListener(this.mSensorFusion, sensor, 0, handler);
            }
            Sensor sensor2 = this.mGyroscopeUncalibrated;
            if (sensor2 != null) {
                this.mSensorManager.registerListener(this.mSensorFusion, sensor2, 0, handler);
            }
            Sensor sensor3 = this.mRotationVector;
            if (sensor3 != null) {
                this.mSensorManager.registerListener(this.mSensorFusion, sensor3, 0, handler);
            }
            Sensor sensor4 = this.mAccelerometer;
            if (sensor4 != null) {
                this.mSensorManager.registerListener(this.mSensorFusion, sensor4, 0, handler);
            }
        }
    }
    ...
    private void unRegisterSensorListener() {
        if (this.mIsRegisterSensorListener) {
            ...
            SensorManager sensorManager = this.mSensorManager;
            if (sensorManager != null) {
                sensorManager.unregisterListener(this.mSensorFusion);
    ...
    private void updatePictureAndPreviewSize() {
        CameraSize bestPanoPictureSize = getBestPanoPictureSize(this.mCameraCapabilities.getSupportedOutputSize(256), DataRepository.dataItemFeature().Ha());
    ...
    public void onCameraOpened() {
        ...
        if (b.km.equals("lavender") && this.mViewAngleH > 50.0f) {
            this.mGoalAngle = 291;
        }
    ...
    public void startPanoramaShooting() {
        ...
        synchronized (this.mDeviceLock) {
            ...
            if (this.mAwbLockSupported && DataRepository.dataItemFeature().Za()) {
