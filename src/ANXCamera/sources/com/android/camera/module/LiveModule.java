    ...
    private class MainHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 2) {
                ...
                liveModule2.mHandler.sendEmptyMessageDelayed(2, (long) liveModule2.getScreenDelay());
            } else if (i == 31) {
                LiveModule.this.setOrientationParameter();
            } else if (i == 35) {
                LiveModule liveModule3 = LiveModule.this;
                boolean z = false;
                boolean z2 = message.arg1 > 0;
                if (message.arg2 > 0) {
                    z = true;
                }
                liveModule3.handleUpdateFaceView(z2, z);
            } else if (i == 51 && !LiveModule.this.mActivity.isActivityPaused()) {
                LiveModule liveModule4 = LiveModule.this;
                liveModule4.mOpenCameraFail = true;
                liveModule4.onCameraException();
            }
        }
    }
