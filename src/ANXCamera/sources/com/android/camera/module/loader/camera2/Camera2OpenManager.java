...
public class Camera2OpenManager {
    ...
    private final CameraDevice.StateCallback mCameraOpenCallback = new CameraDevice.StateCallback() {
        public void onClosed(@NonNull CameraDevice cameraDevice) {
            ...
            if (DataRepository.dataItemFeature().gR() && Integer.valueOf(cameraDevice.getId()).intValue() == 1 && Camera2OpenManager.this.mPendingCameraId.get() == -1) {
    ...
    private boolean attachInObservable(Observer<Camera2Result> observer) {
        ...
        synchronized (this.mEmitterLock) {
            ...
            this.mCameraResultObservable = Observable.create(new ObservableOnSubscribe() {
                public final void subscribe(ObservableEmitter observableEmitter) {
                    Camera2OpenManager.this.mCameraResultEmitter = observableEmitter;
                }
            }).timeout(getCameraOpTimeout(), TimeUnit.MILLISECONDS).onErrorResumeNext(new Function() {
                public final Object apply(Object obj) {
                    return Camera2OpenManager.lambda$attachInObservable$1(Camera2OpenManager.this, (Throwable) obj);
                }
    ...
    public static /* synthetic */ ObservableSource lambda$attachInObservable$1(Camera2OpenManager camera2OpenManager, Throwable th) throws Exception {
        String str = TAG;
        Log.d(str, "Exception occurs in camera open or close: " + th);
        if (!camera2OpenManager.mCameraHandler.getLooper().getQueue().isPolling()) {
            Log.d(TAG, "CameraHandlerThread is being stuck...");
        }
        return Observable.just(Camera2Result.create(3).setCameraError(236));
    }

    public static /* synthetic */ void lambda$release$2(Camera2OpenManager camera2OpenManager, boolean z, boolean z2) {
        String str = TAG;
        ...
        switch (message.what) {
            case 1:
                if (this.mCamera2Device != null) {
                    this.mCamera2Device.setCaptureBusyCallback((Camera2Proxy.CaptureBusyCallback) null);
                }
                if (this.mPendingCameraId.get() < 0) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "openCamera: failed to open camera " + this.mPendingCameraId.get(), e);
                        return;
                    }
                } else {
                    return;
            ...
            case 5:
                if (this.mCamera2Device == null) {
                    ...
                    setManagerState(2);
                    int i = message.arg1;
                    Log.e(TAG, "force close start reason " + i);
            ...
            case 3:
                ...
                if (DataRepository.dataItemFeature().gR() && this.mPopCameraTimeStamp.get() > 0 && this.mPendingCameraId.get() == -1) {
                    CompatibilityUtils.takebackMotor();
                }
                setManagerState(1);
                this.mCameraHandler.sendEmptyMessage(1);
    ...
    public void release(boolean z) {
        ...
        this.mCamera2Device.setCaptureBusyCallback(new Camera2Proxy.CaptureBusyCallback(z) {
            ...
            public final void onCaptureCompleted(boolean z) {
                Camera2OpenManager.lambda$release$2(Camera2OpenManager.this, this.f$1, z);
            }
        });
    }
}
