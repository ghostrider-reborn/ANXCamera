...
public class CameraSettings {
    ...
    private static final String CAMERA_WATER_MARK_FILE = (Util.WATERMARK_STORAGE_DIRECTORY + Util.WATERMARK_FILE_NAME);
    private static final String CAMERA_WATER_MARK_FILE_ULTRA_PIXEL = (Util.WATERMARK_STORAGE_DIRECTORY + Util.WATERMARK_ULTRA_PIXEL_FILE_NAME);
    ...
    public static boolean checkLensAvailability(Context context) {
        return !Util.isGlobalVersion() ? DataRepository.dataItemFeature().gb() && Util.isPackageAvailable(context, AI_LENS_PACKAGE) : DataRepository.dataItemGlobal().getBoolean(KEY_AI_DETECT_ENABLE, Boolean.valueOf(getString(R.bool.pref_ai_detect_enable)).booleanValue()) && Util.isPackageAvailable(context, "com.google.ar.lens") && sGoolgeLensAvilability;
    }
    ...
    public static int[] getBeautifyValueRange() {
        return b.isMTKPlatform() ? new int[]{-12, 12} : b.iW() ? new int[]{0, 7} : new int[]{0, 10};
    }
    ...
    public static String getDefaultWatermarkStr() {
        return b.kE() ? getString(R.string.device_india_watermark_default_text) : getString(R.string.device_watermark_default_text);
    }
    ...
    public static final String getDualCameraWaterMarkFilePathVendor(boolean z) {
        return (!b.sz || !"india".equalsIgnoreCase(SystemProperties.get("ro.boot.hwc"))) ? DataRepository.dataItemFeature().fR() ? z ? CAMERA_WATER_MARK_FILE_ULTRA_PIXEL : CAMERA_WATER_MARK_FILE : DUAL_CAMERA_WATER_MARK_FILE : DUAL_CAMERA_WATER_MARK_FILE_FROM_VENDOR_INDIA;
    }
    ...
    public static int getScreenLightBrightness() {
        ...
        return screenLightBrightness <= 0 ? SystemProperties.getInt("camera_screen_light_brightness", DataRepository.dataItemFeature().gh()) : screenLightBrightness;
    }
    ...
    public static boolean is960WatermarkOn(int i) {
        return DataRepository.dataItemFeature().iq() && DataRepository.dataItemGlobal().getBoolean(KEY_960_WATERMARK_STATUS, CameraAppImpl.getAndroidContext().getResources().getBoolean(R.bool.pref_960_watermark_default));
    }
    ...
    public static boolean isAgeGenderAndMagicMirrorWaterOpen() {
        return DataRepository.dataItemFeature().fQ() && isFrontCamera() && (isAgeGenderWaterMarkOpen() || isMagicMirrorWaterMarkOpen());
    }
    ...
    public static boolean isAsdMotionEnable() {
        return b.ji() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(R.bool.pref_camera_asd_night_default)).booleanValue());
    }

    public static boolean isAsdNightEnable() {
        return b.jk() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_ASD_NIGHT, Boolean.valueOf(getString(R.bool.pref_camera_asd_night_default)).booleanValue());
    }
    ...
    public static boolean isBurstShootingEnable() {
        return b.iK() && "burst".equals(DataRepository.dataItemGlobal().getString(KEY_LONG_PRESS_SHUTTER_FEATURE, getString(R.string.pref_camera_long_press_shutter_feature_default)));
    }
    ...
    public static boolean isCameraLyingHintOn() {
        return DataRepository.dataItemFeature().hF() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_LYING_TIP_SWITCH, true);
    }

    public static boolean isCameraParallelProcessEnable() {
        return DataRepository.dataItemFeature().gi() && DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_PARALLEL_PROCESS_ENABLE, CameraAppImpl.getAndroidContext().getResources().getBoolean(R.bool.pref_camera_parallel_process_enable_default));
    }
    ...
    public static boolean isCameraSoundOpen() {
        return !b.iI() || DataRepository.dataItemGlobal().getBoolean(KEY_CAMERA_SOUND, true);
    }
    ...
    public static boolean isDualCameraWaterMarkOpen() {
        ...
        return DataRepository.dataItemGlobal().getBoolean("pref_dualcamera_watermark_key", b.s(getBool(R.bool.pref_device_watermark_default)));
    }

    public static boolean isEdgePhotoEnable() {
        return b.jG() && sEdgePhotoEnable;
    }
    ...
    public static boolean isEvAdjustable() {
        ...
        return b.kt() ? string.equals(getString(R.string.pref_camera_exposuretime_default)) : string.equals(getString(R.string.pref_camera_exposuretime_default)) || instance.getString(KEY_QC_ISO, getString(R.string.pref_camera_iso_default)).equals(getString(R.string.pref_camera_iso_default));
    }
    ...
    public static boolean isFPS960(int i) {
        return i == 172 && DataRepository.dataItemFeature().gm() && DataRepository.dataItemConfig().getComponentConfigSlowMotion().isSlowMotionFps960();
    }
    ...
    public static boolean isFrontMirror() {
        DataItemGlobal dataItemGlobal = DataRepository.dataItemGlobal();
        String string = dataItemGlobal.getString(KEY_FRONT_MIRROR, b.kD() ? getString(R.string.pref_front_mirror_entryvalue_off) : getString(R.string.pref_front_mirror_default));
    ...
    public static boolean isMiMovieOpen(int i) {
        return DataRepository.dataItemFeature().ga() && i == 171 && DataRepository.dataItemConfig().getComponentConfigMiMovie().isMiMovieOn(i);
    }

    public static boolean isMovieSolidOn() {
        return b.iE() && DataRepository.dataItemGlobal().getBoolean(KEY_MOVIE_SOLID, Boolean.valueOf(getString(R.string.pref_camera_movie_solid_default)).booleanValue());
    }
    ...
    public static boolean isPictureFlawCheckOn() {
        return DataRepository.dataItemFeature().in() && DataRepository.dataItemGlobal().getBoolean(KEY_PICTURE_FLAW_TIP, CameraAppImpl.getAndroidContext().getResources().getBoolean(R.bool.pref_pic_flaw_tip_default));
    }

    public static boolean isPopupTipBeautyIntroEnable() {
        return b.ko() && !DataRepository.dataItemGlobal().getBoolean(KEY_POPUP_TIP_BEAUTY_INTRO_CLICKED, false) && DataRepository.dataItemGlobal().getInt(KEY_POPUP_TIP_BEAUTY_INTRO_SHOW_TIMES, 0) < 3;
    }
    ...
    public static boolean isPressDownCapture() {
        if (b.jo()) {
            return isFrontCamera() || !"focus".equals(DataRepository.dataItemGlobal().getString(KEY_LONG_PRESS_SHUTTER_FEATURE, getString(R.string.pref_camera_long_press_shutter_feature_default)));
        }
        return false;
    }
    ...
    public static boolean isRecordLocation() {
        return b.iN() && DataRepository.dataItemGlobal().getBoolean(KEY_RECORD_LOCATION, false);
    }
    ...
    public static boolean isScanQRCode(Context context) {
        return !isFrontCamera() && isQRCodeReceiverAvailable(context) && b.jC() && !b.gQ() && DataRepository.dataItemGlobal().getBoolean(KEY_SCAN_QRCODE, Boolean.valueOf(getString(R.string.pref_scan_qrcode_default)).booleanValue());
    }
    ...
    public static boolean isSupportQuickShot() {
        return DataRepository.dataItemFeature().gf() || (DEBUG_FAST_SHOT && !b.sV);
    }
    ...
    public static boolean isSupportedMetadata() {
        return b.jg() || isSupportedPortrait();
    }
    ...
    public static boolean isSupportedPortrait() {
        return DataRepository.dataItemFeature().hv() && Camera2DataContainer.getInstance().hasPortraitCamera();
    }

    public static boolean isSupportedZslShutter() {
        return DataRepository.dataItemFeature().hJ();
    }
    ...
    public static void setMiMovieOpen(int i, boolean z) {
        DataRepository.dataItemConfig().getComponentConfigMiMovie().setMiMovie(i, z);
    }
    ...
    public static boolean shouldUltraWideLDCBeVisibleInMode(int i) {
        return (i == 163 || i == 165 || i == 167) && DataRepository.dataItemFeature().isSupportUltraWideLDC() && isBackCamera();
    }
