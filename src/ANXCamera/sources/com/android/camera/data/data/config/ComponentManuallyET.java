...
public class ComponentManuallyET extends ComponentData {
    ...
    private ComponentDataItem[] getFullItems() {
        ...
        this.mFullItems = new ComponentDataItem[]{new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_auto, "0"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_1000, "1000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_500, "2000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_250, "4000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_125, "8000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_60, "16667000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_30, "33333000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_15, "66667000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_8, "125000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_4, "250000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_2, "500000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_1, "1000000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_0_5, "2000000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_4s, "4000000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_8s, "8000000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_16s, "16000000000"), new ComponentDataItem(-1, -1, (int) R.string.pref_camera_exposuretime_entry_32s, "32000000000")};
