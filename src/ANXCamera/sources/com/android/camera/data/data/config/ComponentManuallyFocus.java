...
public class ComponentManuallyFocus extends ComponentData {
    ...
    private List<ComponentDataItem> initItems() {
        ...
        arrayList.add(new ComponentDataItem(-1, -1, (int) R.string.pref_camera_focusmode_entry_auto, "1000"));
        arrayList.add(new ComponentDataItem(-1, -1, (int) R.string.pref_camera_focusmode_entry_auto, "manual"));
        return arrayList;
    }
