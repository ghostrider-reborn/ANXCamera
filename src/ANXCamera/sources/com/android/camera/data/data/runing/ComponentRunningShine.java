...
public class ComponentRunningShine extends ComponentData {
    ...
    private ComponentDataItem generateBeautyLevelItem(boolean z) {
        return b.kq() ? new ComponentDataItem((int) R.drawable.ic_beauty_off, (int) R.drawable.ic_beauty_on, (int) R.string.beauty_fragment_tab_name_3d_beauty, "1") : new ComponentDataItem((int) R.drawable.ic_beauty_off, (int) R.drawable.ic_beauty_on, (int) R.string.beauty_fragment_tab_name_beauty, "1");
    }
    ...
    public int getTopConfigEntryRes(int i) {
        ...
        switch (this.mShineEntry) {
            case 1:
                return this.mCurrentStatus ? R.drawable.ic_shine_on : R.drawable.ic_shine_off;
            case 2:
                return this.mCurrentStatus ? R.drawable.ic_beauty_on : R.drawable.ic_beauty_off;
            case 3:
                ...
                if (!CameraSettings.isUltraPixelRearOn()) {
                    ...
                    if (i2 == 0) {
                        ...
                        if (!DataRepository.dataItemFeature().hz()) {
                            ...
                            if (DataRepository.dataItemFeature().gg() && cameraCapabilities.isSupportBeautyMakeup()) {
