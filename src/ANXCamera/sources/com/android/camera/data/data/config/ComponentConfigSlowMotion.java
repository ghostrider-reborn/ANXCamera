...
public class ComponentConfigSlowMotion extends ComponentData {
    ...
    static {
        if (DataRepository.dataItemFeature().gm()) {
        ...
        } else if (DataRepository.dataItemFeature().gn()) {
            SLOW_MOTION_MODE = new String[]{DATA_CONFIG_NEW_SLOW_MOTION_120, DATA_CONFIG_NEW_SLOW_MOTION_240};
        } else if (DataRepository.dataItemFeature().go()) {
            SLOW_MOTION_MODE = new String[]{DATA_CONFIG_NEW_SLOW_MOTION_120};
        } else {
            SLOW_MOTION_MODE = new String[0];
        }
    }
    ...
    public String getDefaultValue(int i) {
        return SLOW_MOTION_MODE.length == 0 ? "" : SLOW_MOTION_MODE[0];
    }
