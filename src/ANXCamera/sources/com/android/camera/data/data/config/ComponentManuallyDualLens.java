...
public class ComponentManuallyDualLens extends ComponentData {
    ...
    private List<ComponentDataItem> initItems() {
        ...
        if (DataRepository.dataItemFeature().ec()) {
            arrayList.add(new ComponentDataItem(-1, -1, (int) R.string.pref_camera_zoom_mode_entry_tele, LENS_STANDALONE));
        }
        if (DataRepository.dataItemFeature().ad() && DataRepository.dataItemFeature().bd()) {
