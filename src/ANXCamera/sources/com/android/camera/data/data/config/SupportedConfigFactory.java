...
public class SupportedConfigFactory {
    ...
    public static final int MIMOVIE = 251;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:89:0x0151, code lost:
        if (r18.isSupportVideoBeauty() == false) goto L_0x01ea;
     */
        ...
        if (i3 != 167) {
                                ...
                                default:
                                    ...
                                    switch (i4) {
                                        case 0:
                                            ...
                                            if (z && dataItemRunning.supportMacroMode() && dataItemFeature.ig()) {
            ...
            switch (i4) {
                case 0:
                    ...
                    if (z && dataItemFeature.gw() && dataItemFeature.iy()) {
            ...
            if (dataItemFeature.gG() && z && SystemProperties.getBoolean("ro.camera.subtitle.opened", false)) {
            ...
            if (DataRepository.dataItemFeature().hQ() && cameraCapabilities.isSupportRaw()) {
    ...
    public static final SupportedConfigs getSupportedTopConfigs(int i, int i2, boolean z) {
        ...
        switch (i3) {
            ...
            case 169:
                if (i4 != 0) {
                    if (z && i3 == 162 && dataItemFeature.fP()) {
                        arrayList.add(createConfigItem(243));
                    }
                    if (dataItemRunning.supportTopShineEntry()) {
                        arrayList.add(createConfigItem(dataItemRunning.getComponentRunningShine().getTopConfigItem(), 17));
                    ...
                    if (dataItemFeature.iw()) {
                        arrayList.add(createConfigItem(218));
                    }
                    if (dataItemFeature.ix() && dataItemFeature.gw() && z) {
                        arrayList.add(createConfigItem(253, 17));
                    }
                    if (z && dataItemFeature.gF()) {
                        arrayList.add(createConfigItem(216, 17));
                    }
                    if (i3 == 162 && dataItemRunning.supportMacroMode() && dataItemFeature.ih()) {
            ...
            case 165:
                ...
                if (dataItemRunning.supportMacroMode() && dataItemFeature.ih()) {
                    arrayList.add(createConfigItem(255));
                }
                if (dataItemFeature.gz() && z) {
            ...
            case 167:
                ...
                if (b.jw() && !manuallyFocus.getComponentValue(i3).equals(manuallyFocus.getDefaultValue(i3)) && capabilitiesByBogusCameraId.isAFRegionSupported()) {
                ...
                break;
            case 171:
                if (dataItemFeature.isSupportUltraWide() && CameraSettings.isSupportedOpticalZoom() && i4 == 0 && z && dataItemFeature.id()) {
