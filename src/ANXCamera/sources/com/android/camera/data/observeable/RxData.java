...
public class RxData<T> {
    ...
    public static class DataObservable<T> extends Observable<T> implements LifecycleObserver {
        ...
        public void onLifecycleDestroy() {
            if (this.dataObserver != null && !this.dataObserver.isDisposed()) {
        ...
        public void subscribeActual(Observer<? super T> observer) {
            ...
            if (RxData.isLifecycleState(this.dataCheck.owner, Lifecycle.State.DESTROYED) && this.dataObserver != null && !this.dataObserver.isDisposed()) {
                this.dataObserver.dispose();
            }
        }
    }
