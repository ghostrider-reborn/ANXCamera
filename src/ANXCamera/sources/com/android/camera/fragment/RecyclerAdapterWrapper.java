...
public class RecyclerAdapterWrapper<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean isFooter(int i) {
        return i >= FOOTER_VIEW_TYPE && i < FOOTER_VIEW_TYPE + this.mFooters.size();
    }
    ...
    public int getItemViewType(int i) {
        return i < this.mHeaders.size() ? -1000 + i : i < this.mHeaders.size() + this.mBase.getItemCount() ? this.mBase.getItemViewType(i - this.mHeaders.size()) : ((FOOTER_VIEW_TYPE + i) - this.mHeaders.size()) - this.mBase.getItemCount();
    }
