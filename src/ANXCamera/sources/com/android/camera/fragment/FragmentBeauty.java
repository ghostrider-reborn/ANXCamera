...
public class FragmentBeauty extends BaseFragment implements View.OnClickListener, ModeProtocol.HandleBackTrace, ModeProtocol.MakeupProtocol, ModeProtocol.MiBeautyProtocol, Consumer<Integer> {
    ...
    private void initShineType() {
        ...
        ((ViewGroup.MarginLayoutParams) this.mViewPager.getLayoutParams()).height = dimensionPixelSize;
        ((ViewGroup.MarginLayoutParams) this.mBeautyExtraView.getLayoutParams()).height = dimensionPixelSize;
    ...
    private void showHideEyeLighting(boolean z) {
        ...
        if (DataRepository.dataItemFeature().gg() && CameraSettings.isSupportBeautyMakeup()) {
    ...
    private void showZoomTipImage() {
        ...
        if (dualController != null && !CameraSettings.isFrontCamera() && !CameraSettings.isUltraWideConfigOpen(this.mCurrentMode) && !CameraSettings.isUltraPixelOn()) {
            if (!CameraSettings.isMacroModeEnabled(this.mCurrentMode) || DataRepository.dataItemFeature().ii()) {
