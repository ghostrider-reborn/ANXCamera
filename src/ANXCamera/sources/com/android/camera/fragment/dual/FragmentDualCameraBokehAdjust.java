...
public class FragmentDualCameraBokehAdjust extends BaseFragment implements View.OnClickListener, ManuallyListener, ModeProtocol.BokehFNumberController, ModeProtocol.HandleBackTrace {
    ...
    public void provideAnimateElement(int i, List<Completable> list, int i2) {
        ...
        } else if (1 == this.mCurrentState && isVisible(this.mDualParentLayout)) {
            hideSlideView();
        }
    }
