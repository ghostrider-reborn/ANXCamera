...
public class BeautyValues implements Parcelable {
    ...
    public boolean isBeautyModelOn() {
        return this.mBeautySlimFace > 0 || this.mBeautyEnlargeEye > 0 || this.mBeautyNose > 0 || this.mBeautyRisorius > 0 || !(this.mBeautyLips == 0 || this.mBeautyLips == 0) || (!(this.mBeautyChin == 0 || this.mBeautyChin == 0) || this.mBeautyNeck > 0 || this.mBeautySmile > 0 || this.mBeautySlimNose > 0 || !(this.mBeautyHairLine == 0 || this.mBeautyHairLine == 0));
    }
