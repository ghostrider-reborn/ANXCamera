...
public class CameraBeautyParameterType {
    ...
    public static final CameraBeautyParameterType BODY_SMOOTH_STRENGTH;
    ...
    public static final CameraBeautyParameterType ENLARGE_EYE_RATIO;
    ...
    public static final CameraBeautyParameterType FACE_3D_ENLARGE_EYE_RATIO;
    ...
    public static final CameraBeautyParameterType FACE_3D_SHRINK_FACE_RATIO;
    ...
    public static final CameraBeautyParameterType FACE_3D_SMOOTH_STRENGTH;
    ...
    public static final CameraBeautyParameterType SHRINK_FACE_RATIO;
    public static final CameraBeautyParameterType SMOOTH_STRENGTH;
    ...
    static {
        ...
        SMOOTH_STRENGTH = new CameraBeautyParameterType(2, str);
        String str2 = "pref_beautify_enlarge_eye_ratio_key";
        ENLARGE_EYE_RATIO = new CameraBeautyParameterType(2, str2);
        String str3 = "pref_beautify_slim_face_ratio_key";
        SHRINK_FACE_RATIO = new CameraBeautyParameterType(2, str3);
        FACE_3D_SMOOTH_STRENGTH = new CameraBeautyParameterType(2, str);
        FACE_3D_SHRINK_FACE_RATIO = new CameraBeautyParameterType(2, str3);
        FACE_3D_ENLARGE_EYE_RATIO = new CameraBeautyParameterType(2, str2);
        BODY_SMOOTH_STRENGTH = new CameraBeautyParameterType(5, str);
    }
