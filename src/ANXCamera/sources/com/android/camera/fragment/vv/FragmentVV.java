...
public class FragmentVV extends BaseFragment implements View.OnClickListener, ResourceSelectedListener, ModeProtocol.HandleBackTrace, ModeProtocol.LiveVVChooser {
    ...
    public void startShot() {
        if (this.mSelectedItem != null) {
            ...
            if (configChanges != null) {
                CameraStatUtil.trackVVStartClick(this.mSelectedItem.name, isPreviewShow());
