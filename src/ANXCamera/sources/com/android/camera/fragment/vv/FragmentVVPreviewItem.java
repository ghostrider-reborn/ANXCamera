...
public class FragmentVVPreviewItem extends BaseViewPagerFragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        this.mGlideOptions.m(false);
        this.mGlideOptions.b(g.gV);
        c.g(getContext()).m(this.mVVItem.coverPath).b(this.mGlideOptions).a(imageView);
        textView.setText(getResources().getString(R.string.vv_duartion_hint, new Object[]{this.mVVItem.name, Integer.valueOf(this.mVVItem.getEssentialFragmentSize()), getDurationString(this.mVVItem.getTotalDuration())}));
    }
