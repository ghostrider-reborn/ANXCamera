...
public class ExtraSlideFNumberAdapter extends HorizontalDrawAdapter implements OnPositionSelectListener {
    ...
    public void draw(int i, Canvas canvas, boolean z) {
        ...
        if (F_NUMBERS[i].equals(DataRepository.dataItemFeature().i(CameraSettings.isFrontCamera())) && !z) {
        ...
        if (this.mEnable) {
            ...
            if (!mapPositionToFNumber.equals(this.mCurrentValue)) {
                ...
                if (manuallyListener != null) {
                    manuallyListener.onManuallyDataChanged(this.mComponentData, this.mCurrentValue, mapPositionToFNumber, false);
                }
