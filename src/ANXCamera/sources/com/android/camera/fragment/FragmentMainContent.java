...
public class FragmentMainContent extends BaseFragment implements ModeProtocol.AutoZoomViewProtocol, ModeProtocol.HandleBackTrace, ModeProtocol.MainContentProtocol, ModeProtocol.SnapShotIndicator {
    ...
    private boolean isMiMovieOpen() {
        return CameraSettings.isMiMovieOpen(this.mCurrentMode);
    }
    ...
    private boolean isSquareModule() {
        return DataRepository.dataItemConfig().getComponentConfigRatio().isSquareModule();
    }
    ...
    private void updateReferenceGradienterSwitched() {
        if (this.mPreviewFrame != null) {
            this.mPreviewFrame.updateReferenceGradienterSwitched(isReferenceLineEnabled() && !((ActivityBase) getContext()).getCameraIntentManager().isScanQRCodeIntent() && needReferenceLineMode(), isGradienterEnabled(), isSquareModule());
        }
    }
    ...
    public void initView(View view) {
        ...
        adjustViewHeight();
        this.mNormalCoverHeight = Util.sWindowHeight - Util.getBottomHeight(getResources());
        ...
        this.mLeftCover.getLayoutParams().width = Util.getMiMovieMargin();
        this.mRightCover.getLayoutParams().width = Util.getMiMovieMargin();
    ...
    public void lightingStart() {
        this.mLightingView.setMiMovie(CameraSettings.isMiMovieOpen(this.mCurrentMode));
    ...
    public void notifyAfterFrameAvailable(int i) {
        ...
        updateMiMovieSwitched(isMiMovieOpen());
    ...
    public void provideAnimateElement(int i, List<Completable> list, int i2) {
        ...
        CoverState coverState2 = i != 165 ? i != 171 ? CoverState.NONE : (!CameraSettings.isMiMovieOpen(i) || i2 == 3) ? CoverState.NONE : CoverState.LR : CoverState.TB;
    ...
    public void setCenterHint(int i, String str, String str2, int i2) {
        ...
        if (i == 0) {
            ...
            if (str2 == null || str2.equals("")) {
                ...
                c.a((Fragment) this).m(str2).a(this.mCenterHintIcon);
    ...
    public void updateMiMovieSwitched(boolean z) {
        Log.i(TAG, "updateMiMovieSwitched isSwitchOn : " + z);
        if (z) {
            if (this.mCoverParent.getLayoutParams().height == this.mNormalCoverHeight) {
