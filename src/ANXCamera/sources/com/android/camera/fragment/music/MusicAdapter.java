...
public class MusicAdapter extends RecyclerView.Adapter<CommonRecyclerViewHolder> {
    ...
    public void onBindViewHolder(CommonRecyclerViewHolder commonRecyclerViewHolder, int i) {
        ...
        c.g(this.mContext).m(liveMusicInfo.mThumbnailUrl).b(f.a((i<Bitmap>) new RoundedCornersTransformation(10, 1))).a((ImageView) commonRecyclerViewHolder.getView(R.id.music_thumbnail));
