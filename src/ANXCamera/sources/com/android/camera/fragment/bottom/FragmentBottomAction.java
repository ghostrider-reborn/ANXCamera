...
public class FragmentBottomAction extends BaseFragment implements View.OnClickListener, ModeProtocol.ActionProcessing, ModeProtocol.BottomMenuProtocol, ModeProtocol.HandleBackTrace, ModeProtocol.HandleBeautyRecording, ModeProtocol.HandlerSwitcher, ModeProtocol.ModeChangeController, CameraSnapView.SnapListener, ModeSelectView.onModeClickedListener {
    ...
    private boolean isFPS960() {
        if (this.mCurrentMode != 172 || !DataRepository.dataItemFeature().gm()) {
            return false;
        }
    ...
    private void updateBottomInRecording(final boolean z, boolean z2) {
        ...
        if (i == 162) {
            ...
            if (!b.iS() || CameraSettings.isVideoBokehOn()) {
                z3 = false;
            }
    ...
    public boolean canSwipeChangeMode() {
        return !this.mVideoRecordingStarted && DataRepository.dataItemLive().getMimojiStatusManager().IsInMimojiPreview() && isVisible() && this.mCurrentMode != 179;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x004a A[EDGE_INSN: B:27:0x004a->B:17:0x004a ?: BREAK  , SYNTHETIC] */
    ...
    public void changeModeByNewMode(int i, int i2) {
        if (i == 166 && CameraSettings.isFrontCamera() && DataRepository.dataItemFeature().gJ()) {
            i = 176;
        }
    ...
    public void notifyAfterFrameAvailable(int i) {
        ...
        if (this.mPostProcess != null && this.mPostProcess.getVisibility() == 0) {
            ...
            if (this.mShutterButton != null) {
                this.mShutterButton.setParameters(this.mCurrentMode, false, isFPS960());
            }
        }
        if (DataRepository.dataItemLive().getMimojiStatusManager().IsInMimojiCreate()) {
            ((ModeProtocol.MainContentProtocol) ModeCoordinatorImpl.getInstance().getAttachProtocol(166)).mimojiStart();
    ...
    public Animation provideExitAnimation(int i) {
        if (i == 65523) {
            ...
            ViewCompat.setTranslationY(getView(), (float) ((getResources().getDimensionPixelSize(R.dimen.vv_start_layout_height) + getResources().getDimensionPixelSize(R.dimen.vv_list_height)) - height));
        }
    ...
    public void showOrHideBottomViewWithAnim(boolean z) {
        ...
        duration.alpha(f).setListener((ViewPropertyAnimatorListener) null).start();
    }
