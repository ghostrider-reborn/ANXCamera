...
public class FragmentBottomAction extends BaseFragment implements OnClickListener, ModeChangeController, ActionProcessing, HandleBeautyRecording, HandlerSwitcher, HandleBackTrace, onModeClickedListener, SnapListener, BottomMenuProtocol {
    ...
    private boolean isFPS960() {
        if (this.mCurrentMode != 172 || !DataRepository.dataItemFeature().pc()) {
            return false;
        }
    ...
    private void updateBottomInRecording(final boolean z, boolean z2) {
        ...
        if (i == 162) {
            ...
            if (!b.Bj() || CameraSettings.isVideoBokehOn()) {
                z3 = false;
            }
...
EDGE_INSN: B:26:0x0045->B:17:0x0045 ?: BREAK  , SYNTHETIC] */
    ...
    public void notifyAfterFrameAvailable(int i) {
        ...
        if (fragmentLighting == null) {
            this.mFragmentLighting = new FragmentLighting();
            FragmentManager childFragmentManager = getChildFragmentManager();
            FragmentLighting fragmentLighting2 = this.mFragmentLighting;
            FragmentUtils.addFragmentWithTag(childFragmentManager, (int) R.id.fragment_bottom_extra2, (Fragment) fragmentLighting2, fragmentLighting2.getFragmentTag());
        } else if (fragmentLighting.isAdded()) {
    ...
    public void updateLoading(boolean z) {
        if (z) {
            ...
            int i = this.mCurrentMode;
            if (i == 161 || i == 162 || i == 166 || i == 172 || i == 174 || i == 176) {
