        ...
        public void setData(AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo, int i) {
            ...
            if (aSAvatarConfigInfo != null) {
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    com.bumptech.glide.c.i(this.itemView.getContext()).g(aSAvatarConfigInfo.thum).b(new f().i(this.imageView.getDrawable())).b(f.a((j<Bitmap>) new RoundedCornersTransformation(20, 1))).a(this.imageView);
            ...
            Log.i(simpleName2, "fmoji MimojiThumbnailAdapter getView position: " + i);
        }
    }
