...
public class ConfigInfoThumUtils {
    ...
    public void renderThumb(AvatarEngine avatarEngine, AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo, int i, float[] fArr) {
        ...
        if (this.mNoHair) {
            ...
            if (this.mHairList.size() > 0) {
                avatarEngine2.setConfig(this.mHairList.get(this.mHairList.size() - 1));
            }
        }
        if (this.mNoEyeWear) {
    ...
    public void reset(AvatarEngine avatarEngine, AvatarConfig.ASAvatarConfigValue aSAvatarConfigValue) {
        ...
        AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo2 = null;
        if (this.mNoHair) {
        ...
        if (this.mNoEyeWear) {
            ...
            while (true) {
                ...
                AvatarConfig.ASAvatarConfigInfo next = it2.next();
                if (next.configID == currentConfigIdWithType2) {
                    aSAvatarConfigInfo2 = next;
                    break;
                }
            }
