...
public class FragmentTopConfigExtra extends BaseFragment implements View.OnClickListener {
    ...
    private void addContentDescriptionForConfigs(int i) {
        ...
        switch (i) {
            ...
            case 233:
                boolean isSwitchOn5 = dataItemRunning.isSwitchOn("pref_video_speed_fast_key");
            ...
            case 234:
                boolean isSwitchOn6 = dataItemRunning.isSwitchOn("pref_camera_scenemode_setting_key");
            ...
            case 235:
                boolean isSwitchOn7 = dataItemRunning.isSwitchOn("pref_camera_groupshot_mode_key");
            ...
            case 236:
                boolean isSwitchOn8 = dataItemRunning.isSwitchOn("pref_camera_magic_mirror_key");
            ...
            case 238:
                boolean isSwitchOn9 = dataItemRunning.isSwitchOn("pref_camera_show_gender_age_key");
            ...
            case 239:
                ...
                boolean isSwitchOn10 = componentConfigBeauty.isSwitchOn(currentMode);
    ...
    private void adjustViewBackground(boolean z) {
        ...
        if (z) {
            ...
            if (hashCode == 1517352) {
                if (componentValue.equals(ComponentConfigRatio.RATIO_FULL_18X9)) {
                    c = 3;
                    switch (c) {
                        case 0:
                        case 1:
            ...
            } else if (hashCode == 1518313) {
                if (componentValue.equals(ComponentConfigRatio.RATIO_FULL_19X9)) {
                    c = 2;
                    switch (c) {
                        case 0:
                        case 1:
                ...
                if (componentValue.equals(ComponentConfigRatio.RATIO_FULL_20X9)) {
                    c = 1;
                    switch (c) {
                        case 0:
                        case 1:
            ...
            } else if (hashCode == 1456894192 && componentValue.equals(ComponentConfigRatio.RATIO_FULL_195X9)) {
                c = 0;
                switch (c) {
                    case 0:
                    case 1:
