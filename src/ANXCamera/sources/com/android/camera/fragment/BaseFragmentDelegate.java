...
public class BaseFragmentDelegate implements ModeProtocol.BaseDelegate {
    ...
    public static final int EYE_LIGHT_POPU_TIP_FRAGMENT_CONTAINER_ID = 2131624310;
    ...
    public static final int MAKE_UP_POPU_FRAGMENT_CONTAINER_ID = 2131624309;
        ...
        switch (i) {
            ...
            case 6:
                if (getActiveFragment(R.id.bottom_action) == 4083) {
                    ...
                    if (b.isSupportedOpticalZoom() || b.jU() || HybridZoomingSystem.IS_3_OR_MORE_SAT) {
    ...
    public void init(FragmentManager fragmentManager, int i, BaseLifecycleListener baseLifecycleListener) {
        ...
        BaseFragment constructFragment9 = (b.isSupportedOpticalZoom() || HybridZoomingSystem.IS_3_OR_MORE_SAT) ? constructFragment(true, 4084, 240, baseLifecycleListener2) : b.jU() ? constructFragment(true, 4085, 240, baseLifecycleListener2) : null;
        if (constructFragment9 != null) {
            this.originalFragments.put(R.id.bottom_popup_dual_camera_adjust, constructFragment9.getFragmentInto());
            this.animationComposite.put(constructFragment9.getFragmentInto(), constructFragment9);
            beginTransaction.replace(R.id.bottom_popup_dual_camera_adjust, constructFragment9, constructFragment9.getFragmentTag());
        } else {
