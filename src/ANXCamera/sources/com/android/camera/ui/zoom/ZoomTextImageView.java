        ...
        switch (this.mCurrentType) {
            case 0:
                if (this.mCurrentText != null) {
                    ...
                    float measureText2 = this.mXTextPaint.measureText("X");
                    float ascent2 = this.mXTextPaint.ascent() + this.mXTextPaint.descent();
                    canvas.save();
                    canvas.translate(0.0f, (float) (getHeight() / 2));
                    canvas.drawText(replaceAll, ((float) (getWidth() / 2)) - ((measureText + measureText2) / 2.0f), ((-ascent) / 2.0f) + 1.0f, this.mTextPaint);
                    canvas.drawText("X", ((((float) getWidth()) + measureText) - measureText2) / 2.0f, ((-ascent2) / 2.0f) + 1.0f, this.mXTextPaint);
                    canvas.restore();
                    return;
                }
                return;
