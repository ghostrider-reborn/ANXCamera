...
public class ToggleSwitch extends CompoundButton implements Checkable {
    ...
    public ToggleSwitch(Context context, AttributeSet attributeSet) {
        ...
        this.mThumbShadowRadius = obtainStyledAttributes.getDimension(6, dp2pxFloat(DEFAULT_SHADOW_RADIUS));
        ...
        this.mTextOffShadowRadius = obtainStyledAttributes.getDimension(13, dp2pxFloat(DEFAULT_SHADOW_RADIUS));
    ...
    private float[] compThumbRoundRectAttr(float f) {
        ...
        float f3 = (((float) (this.mThumbPadding + this.mStrokeWidth)) * (1.0f - f)) + (((((float) this.mThumbPadding) / 2.0f) + f2) * f);
        float f4 = (float) (this.mThumbPadding + this.mStrokeWidth);
        float f5 = (((float) height) + f4) - ((float) (this.mStrokeWidth * 2));
        return new float[]{f3, f4, ((f2 - ((float) this.mStrokeWidth)) - ((((float) this.mThumbPadding) * 3.0f) / 2.0f)) + f3, f5, (f5 - f4) * 0.5f};
    }
    ...
    private void drawRoundRectStroke(Canvas canvas, int i) {
        if (this.mStrokeWidth > 0) {
            ...
            float f2 = ((float) this.mStrokeWidth) / 2.0f;
