...
public abstract class CameraPaintBase {
    ...
    public void updateValue(@FloatRange(from = 0.0d, to = 1.0d) float f) {
        float f2 = this.mDstMiddleX - this.mSrcMiddleX;
        float f3 = this.mDstMiddleY - this.mSrcMiddleY;
        float f4 = this.mDstBaseRadius - this.mSrcBaseRadius;
        this.mMiddleX = this.mSrcMiddleX + (f2 * f);
        this.mMiddleY = this.mSrcMiddleY + (f3 * f);
        this.mBaseRadius = this.mSrcBaseRadius + (f4 * f);
