...
public class CameraSnapPaintCircle extends CameraPaintBase {
    ...
    public long removeLastSegmentAndGetLastTime() {
        ...
        this.timeAngle = this.mSegmentRatios.get(this.mSegmentRatios.size() - 1).floatValue();
        if (this.mSegmentTimes.isEmpty()) {
            return 0;
        }
        return this.mSegmentTimes.get(this.mSegmentTimes.size() - 1).longValue();
    }
    ...
    public void setNeedProcessShade(boolean z) {
        ...
        if (z) {
            ...
            float f2 = this.mDstWidthPercent;
