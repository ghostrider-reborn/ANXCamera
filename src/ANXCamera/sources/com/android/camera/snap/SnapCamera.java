...
public class SnapCamera implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener {
    ...
    public SnapCamera(Context context, SnapStatusListener snapStatusListener) {
        try {
            ...
            String str = TAG;
            Log.e(str, "init failed " + e.getMessage());
        }
    }
    ...
    public synchronized void capture() {
        if (this.mFocused) {
            try {
                ...
                String str2 = TAG;
                Log.e(str2, "takeSnap: " + e.getMessage(), e);
            }
    ...
    private void initCamera() {
        ...
        try {
            ...
            String str2 = TAG;
            Log.e(str2, "initCamera: " + e.getMessage(), e);
        }
    }
    ...
    private void initOrientationListener() {
        this.mOrientationListener = new OrientationEventListener(this.mContext, b.kv() ? 2 : 3) {
            public void onOrientationChanged(int i) {
                int unused = SnapCamera.this.mOrientation = Util.roundOrientation(i, SnapCamera.this.mOrientation);
            }
        };
    ...
    public void onPictureTaken(byte[] bArr) {
        try {
            ...
            String str = TAG;
            Log.e(str, "save picture failed " + e.getMessage());
        }
    }
    ...
    private void setupMediaRecorder() {
        ...
        if (VideoModule.VIDEO_MAX_SINGLE_FILE_SIZE < availableSpace && DataRepository.dataItemFeature().gd()) {
        ...
        try {
            ...
            if (!Storage.isUseDocumentMode()) {
                ...
                try {
                    ...
                    try {
                        Log.e(TAG, "prepare failed for " + str, e);
            ...
            this.mCameraDevice.createCaptureSession(asList, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    try {
                            ...
                            public void onCaptureStarted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, long j, long j2) {
                                if (!SnapCamera.this.mRecording) {
                                    try {
                                        ...
                                        String access$100 = SnapCamera.TAG;
                                        Log.e(access$100, "failed to start media recorder: " + e.getMessage(), e);
                                        e.printStackTrace();
                                        SnapCamera.this.stopCamcorder();
                                    }
                        ...
                        String access$100 = SnapCamera.TAG;
                        Log.e(access$100, "videoSessionCb::onConfigured: " + e.getMessage(), e);
                    }
                }
            }, this.mCameraHandler);
        } catch (CameraAccessException e) {
            String str = TAG;
            Log.e(str, "failed to startCamcorder: " + e.getMessage(), e);
        }
        return;
    }
    ...
    public synchronized void takeSnap() {
        if (this.mCameraDevice == null) {
            ...
            try {
                ...
                String str = TAG;
                Log.e(str, "takeSnap: " + e.getMessage(), e);
            }
        } else {
            capture();
        }
