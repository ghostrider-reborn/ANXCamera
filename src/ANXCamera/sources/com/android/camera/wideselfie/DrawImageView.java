...
public class DrawImageView extends View {
    ...
    private Rect convertBorderRect(Rect rect) {
        ...
        if (this.mOrientation % 180 == 0) {
            ...
            int i2 = (this.mStillPreviewHeight / 2) + 1;
            rect2.left = rect.top;
            rect2.top = (rect.left - 1) + (((this.mThumbBgHeightVertical - 2) - this.mStillPreviewHeight) / 2);
            rect2.right = rect.bottom;
            rect2.bottom = rect2.top + rect.width() + 1;
            rect2.offset(i2, i2);
            rect2.left = i2;
            rect2.right = i2 + this.mStillPreviewWidth + 1;
        }
        return rect2;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mBitmap != null && this.mImageRect != null) {
            canvas.drawBitmap(this.mBitmap, (Rect) null, this.mImageRect, this.mBitmapPaint);
