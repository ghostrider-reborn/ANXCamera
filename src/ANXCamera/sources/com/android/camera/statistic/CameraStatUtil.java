...
public class CameraStatUtil {
    ...
    static {
        ...
        sCameraModeIdToName.put(179, "VV视频");
    ...
    private static String addCameraSuffix(String str) {
        ...
        sb.append(str);
        sb.append("_");
        sb.append(CameraSettings.isFrontCamera() ? PictureInfo.SENSOR_TYPE_FRONT : "back");
        return sb.toString();
    }
    ...
    private static void addUltraPixelParameter(boolean z, Map<String, String> map) {
        ...
        if (!z) {
            ...
            if (gV == 1) {
                ...
                map.put(CameraStat.PARAM_ULTRA_PIXEL_64MP, isUltraPixelOn ? "on" : "off");
            }
        } else if (DataRepository.dataItemFeature().gW() == 0) {
    ...
    private static String antiBandingToName(String str) {
        ...
        switch (c) {
            ...
            default:
                String str2 = TAG;
                Log.e(str2, "unexpected antiBanding " + str);
                return OTHERS;
        }
    }
    ...
    private static String flashModeToName(String str) {
        ...
        switch (c) {
            ...
            case 5:
                return "off";
            case 6:
                return "backsoftlight";
            default:
                String str2 = TAG;
                Log.e(str2, "unexpected flash mode " + str);
                return OTHERS;
        }
    }
    ...
    private static String getSATZoomRange(float f) {
        return (f < 0.6f || f >= 5.0f) ? (f < 5.0f || f >= 10.0f) ? (f < 10.0f || f >= 20.0f) ? (f < 20.0f || f >= 30.0f) ? (f < 30.0f || f >= 40.0f) ? (f < 40.0f || f > 50.0f) ? "0-5" : "40-50" : "30-40" : "20-30" : "10-20" : "5-10" : "0-5";
    }
    ...
    public static void trackAsdDirtyTip(int i) {
        String str = i == 0 ? CameraStat.PARAM_BACK_CAMERA : 1 == i ? CameraStat.PARAM_FRONT_CAMERA : null;
        if (!TextUtils.isEmpty(str)) {
            HashMap hashMap = new HashMap();
            hashMap.put(CameraStat.PARAM_ASD_DIRTY_TIP_LENS, str);
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, "asd_dirty_tip", hashMap);
        }
    }
    ...
    public static void trackBacklitTip(String str) {
        HashMap hashMap = new HashMap();
        hashMap.put(CameraStat.PARAM_ASD_DETECT_TIP, CameraStat.VALUE_ASD_BACKLIT_TIP);
        if (CameraStat.CATEGORY_CAMERA.equals(str)) {
            CameraStat.recordCalculateEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_PICTURE_TAKEN, 1, hashMap);
        } else if (CameraStat.CATEGORY_COUNTER.equals(str)) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_CAPTURE_ASD_DETECT_TIP, hashMap);
        }
    }

    public static void trackBeautyBodyCapture() {
        trackBeautyBodySlim(CameraStat.CATEGORY_CAMERA, "6", (String) null);
    }
    ...
    public static void trackBeautyBodyCounterPort(@ComponentRunningShine.ShineType String str) {
        if (str != null) {
            trackBeautyBodySlim(CameraStat.CATEGORY_COUNTER, str, (String) null);
        }
    }
    ...
    private static void trackBeautyBodySlim(String str, @ComponentRunningShine.ShineType String str2, String str3) {
        boolean z;
        String str4;
        HashMap hashMap = new HashMap();
        int hashCode = str.hashCode();
    ...
    public static void trackBeautyInfo(int i, String str, BeautyValues beautyValues) {
        ...
        if (b.kq()) {
            ...
            for (String str2 : BeautyConstant.BEAUTY_CATEGORY_LEVEL) {
                String str3 = sBeautyTypeToName.get(str2);
                if (str3 != null) {
            ...
            if (CameraStat.VALUE_FRONT_CAMERA.equals(str)) {
                for (String str4 : BeautyConstant.BEAUTY_CATEGORY_FRONT_MAKEUP) {
                    String str5 = sBeautyTypeToName.get(str4);
                    if (str5 != null) {
                ...
                while (i2 < length) {
                    ...
                    String str7 = sBeautyTypeToName.get(str6);
                    if (str7 != null) {
                ...
                while (i2 < length2) {
                    ...
                    String str9 = sBeautyTypeToName.get(str8);
                    if (str9 != null) {
    ...
    public static void trackGeneralInfo(int i, boolean z, int i2, int i3, boolean z2, MutexModeManager mutexModeManager, String str) {
        ...
        if (z2) {
            ...
            if (DataRepository.dataItemRunning().supportUltraPixelPortrait()) {
                hashMap.put(CameraStat.PARAM_ULTRAPIXEL_PORTRAIT, CameraSettings.isUltraPixelPortraitFrontOn() ? "on" : "off");
            }
        ...
        if (HybridZoomingSystem.IS_4_SAT && i2 == 163) {
            hashMap.put(CameraStat.PARAM_SAT_ZOOM_RANG, getSATZoomRange(CameraSettings.readZoom()));
        }
    ...
    public static void trackLiveRecordingParams(boolean z, String str, boolean z2, String str2, boolean z3, String str3, String str4, boolean z4, int i, int i2, int i3, int i4, boolean z5) {
        if (!CameraStat.isCounterEventDisabled()) {
            ...
            if (z) {
                hashMap.put(CameraStat.PARAM_LIVE_MUSIC_NAME + str5, str);
            }
            hashMap.put(CameraStat.PARAM_LIVE_FILTER_SEGMENT_ON, z2 ? "on" : "off");
            if (z2) {
                hashMap.put(CameraStat.PARAM_LIVE_FILTER_NAME + str5, str2);
            }
            hashMap.put(CameraStat.PARAM_LIVE_STICKER_SEGMENT_ON, z3 ? "on" : "off");
            if (z3) {
                hashMap.put(CameraStat.PARAM_LIVE_STICKER_NAME + str5, str3);
            }
            hashMap.put(CameraStat.PARAM_LIVE_SPEED_LEVEL + str5, str4);
            hashMap.put(CameraStat.PARAM_LIVE_BEAUTY_SEGMENT_ON, z4 ? "on" : "off");
            hashMap.put(CameraStat.PARAM_LIVE_SHRINK_FACE_RATIO + str5, divideTo10Section(i));
            hashMap.put(CameraStat.PARAM_LIVE_ENLARGE_EYE_RATIO + str5, divideTo10Section(i2));
            hashMap.put(CameraStat.PARAM_LIVE_SMOOTH_RATIO + str5, divideTo10Section(i3));
            hashMap.put(CameraStat.PARAM_CAMERA_ID, cameraIdToName(z5));
            hashMap.put(CameraStat.PARAM_QUALITY, videoQualityToName("" + i4));
    ...
    private static void trackMacroModeTaken(int i) {
        if (DataRepository.dataItemRunning().supportMacroMode()) {
            ...
            if (DataRepository.dataItemFeature().hH()) {
                hashMap.put(CameraStat.PARAM_STANDALONE_MACRO_MODE, str);
            } else {
    ...
    public static void trackManuallyResetClick() {
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_MANUALLY_RESET_CLICK);
    }

    public static void trackManuallyResetDialogCancel() {
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_MANUALLY_RESET_DIALOG_CANCEL_CLICK);
    }

    public static void trackManuallyResetDialogOk() {
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_MANUALLY_RESET_DIALOG_OK_CLICK);
    }

    public static void trackManuallyResetShow() {
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_MANUALLY_RESET_SHOW);
    }

    public static void trackMeterClick() {
        if (!CameraStat.isCounterEventDisabled()) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.PARAM_METER_ICON_CLICK);
        }
    }
    ...
    public static void trackPhotoAssistanceTip() {
        CameraStat.recordCountEvent(CameraStat.CATEGORY_SETTINGS, CameraStat.KEY_PHOTO_ASSISTANCE_TIP);
    }
    ...
    public static void trackPictureTaken(int i, boolean z, int i2, boolean z2, boolean z3, String str) {
        ...
        hashMap.put(CameraStat.PARAM_LOCATION, z3 ? CameraStat.LOCATION_WITH : CameraSettings.isRecordLocation() ? CameraStat.LOCATION_WITHOUT : CameraStat.LOCATION_CLOSED);
        if (str != null) {
            hashMap.put(CameraStat.PARAM_AI_SCENE_DETECTED, str);
        }
        if (i2 == 171 && !z2) {
    ...
    public static void trackPortraitTip(String str) {
        HashMap hashMap = new HashMap();
        hashMap.put(CameraStat.PARAM_ASD_DETECT_TIP, CameraStat.VALUE_ASD_PORTART_TIP);
        if (CameraStat.CATEGORY_CAMERA.equals(str)) {
            CameraStat.recordCalculateEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_PICTURE_TAKEN, 1, hashMap);
        } else if (CameraStat.CATEGORY_COUNTER.equals(str)) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_CAPTURE_ASD_DETECT_TIP, hashMap);
        ...
        if (str != null) {
            ...
            switch (c) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    str = CameraStat.KEY_CAMERA_LYING_TIP_SWITCH;
                    break;
                case 11:
                    str = CameraStat.KEY_6MW_STATUS;
                    break;
            }
    ...
    public static void trackRawPictureTaken() {
        if (ModuleManager.isManualModule() && DataRepository.dataItemConfig().getComponentConfigRaw().isSwitchOn(167)) {
            CameraStat.recordCalculateEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_MANUALLY_RAW_TAKEN, 1);
        }
    }
    ...
    public static void trackShowZoomBarByScroll(boolean z) {
        if (z) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_SHOW_ZOOM_BAR_BY_SCROLL);
        }
    }

    private static void trackSlowMotionMacro(String str, String str2, String str3) {
        HashMap hashMap = new HashMap();
        if (CameraStat.CATEGORY_COUNTER.equals(str)) {
            if (!TextUtils.isEmpty(str3)) {
                hashMap.put(CameraStat.PARAM_SLOW_MOTION_MACRO, str3);
                CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_NEW_SLOW_MOTION, hashMap);
            }
        } else if (CameraStat.CATEGORY_CAMERA.equals(str) && !TextUtils.isEmpty(str2)) {
            hashMap.put(CameraStat.PARAM_SLOW_MOTION_MACRO, str2);
            CameraStat.recordCalculateEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_NEW_SLOW_MOTION, 1, hashMap);
        }
    }

    public static void trackSlowMotionMacroCapture(String str) {
        trackSlowMotionMacro(CameraStat.CATEGORY_CAMERA, str, (String) null);
    }

    public static void trackSlowMotionMacroCount(boolean z) {
        trackSlowMotionMacro(CameraStat.CATEGORY_COUNTER, (String) null, z ? "on" : "off");
    }

    public static void trackSlowMotionQuality(String str, String str2, String str3) {
        HashMap hashMap = new HashMap();
        hashMap.put(CameraStat.KEY_NEW_SLOW_MOTION, str2);
        hashMap.put(CameraStat.PARAM_VIDEO_QUALITY, slowMotionQualityIdToName(str3));
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, str, hashMap);
    }

    public static void trackSnapInfo(boolean z) {
        HashMap hashMap = new HashMap();
        hashMap.put("mode", z ? VEEditor.MVConsts.TYPE_VIDEO : "photo");
    ...
    public static void trackSuperNightInCaptureMode(boolean z) {
        if (z && DataRepository.dataItemFeature().il()) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_SUPERNIGHT_IN_CAPTUREMODE);
        }
    }
    ...
    public static void trackVVIconClick() {
        if (!CameraStat.isCounterEventDisabled()) {
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.PARAM_VV_ICON_CLICK);
        }
    }
    ...
    public static void trackVVRecordingParams(String str, boolean z) {
        if (!CameraStat.isCounterEventDisabled()) {
            HashMap hashMap = new HashMap();
            hashMap.put(CameraStat.PARAM_CAMERA_ID, cameraIdToName(z));
            hashMap.put(CameraStat.PARAM_VV_TEMPLATE_NAME, str);
            CameraStat.recordCountEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_VV_VIDEO, hashMap);
        }
    }
    ...
    public static void trackVVStartClick(String str, boolean z) {
        if (!CameraStat.isCounterEventDisabled()) {
            HashMap hashMap = new HashMap();
            hashMap.put(CameraStat.PARAM_VV_TEMPLATE_NAME, str);
            hashMap.put(CameraStat.PARAM_VV_CLICK_TEMPLATE_PREVIEW, z ? CameraStat.VALUE_YES : CameraStat.VALUE_NO);
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_VV_START, hashMap);
        }
    }
    ...
    public static void trackVVTemplateThumbnailClick(String str) {
        if (!CameraStat.isCounterEventDisabled()) {
            HashMap hashMap = new HashMap();
            hashMap.put(CameraStat.PARAM_VV_TEMPLATE_NAME, str);
            CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, CameraStat.KEY_VV_TEMPLATE_THUMBNAIL, hashMap);
        }
    }
    ...
    public static void trackVideoQuality(String str, boolean z, String str2) {
        HashMap hashMap = new HashMap();
        hashMap.put(CameraStat.PARAM_CAMERA_ID, z ? CameraStat.VALUE_FRONT_CAMERA : CameraStat.VALUE_BACK_CAMERA);
        hashMap.put(CameraStat.PARAM_VIDEO_QUALITY, videoQualityToName(str2));
        CameraStat.recordCountEvent(CameraStat.CATEGORY_COUNTER, str, hashMap);
    }
    ...
    public static void trackVideoRecorded(boolean z, int i, boolean z2, boolean z3, boolean z4, String str, int i2, int i3, int i4, int i5, BeautyValues beautyValues, long j) {
        ...
        hashMap.put(CameraStat.PARAM_CAMERA_ID, z ? CameraStat.VALUE_FRONT_CAMERA : CameraStat.VALUE_BACK_CAMERA);
        hashMap.put("模式", str2);
        hashMap.put(CameraStat.PARAM_QUALITY, videoQualityToName("" + i2));
        hashMap.put(CameraStat.PARAM_FLASH_MODE, i3 == 2 ? "torch" : "off");
        hashMap.put(CameraStat.PARAM_VIDEO_FPS, String.valueOf(i4));
        int i6 = i;
        if (i6 == 162 && !z) {
            if (z2) {
                hashMap.put(CameraStat.PARAM_AUTO_ZOOM, z4 ? CameraStat.VALUE_AUTOZOOM_ULTRA : CameraStat.VALUE_AUTOZOOM_NOT_ULTRA);
            } else {
                hashMap.put(CameraStat.PARAM_AUTO_ZOOM, "off");
            }
            hashMap.put(CameraStat.PARAM_SUPER_EIS, z3 ? "on" : "off");
        }
        if (beautyValues2 != null) {
            hashMap.put(CameraStat.PARAM_BEAUTY_LEVEL, String.valueOf(BeautyConstant.getLevelInteger(beautyValues2.mBeautyLevel)));
        }
        hashMap.put(CameraStat.PARAM_VIDEO_TIME, String.valueOf(j));
        CameraStat.recordCountEvent(CameraStat.CATEGORY_CAMERA, CameraStat.KEY_VIDEO_TAKEN, hashMap);
        if (i5 > 0 && CameraSettings.VIDEO_SPEED_FAST.equals(str2)) {
            HashMap hashMap2 = new HashMap();
    ...
    public static void trackZoomAdjusted(String str, boolean z) {
        ...
        hashMap.put("isRecording", z ? "on" : "off");
