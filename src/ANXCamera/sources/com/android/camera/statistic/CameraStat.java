...
public class CameraStat {
    ...
    public static final String KEY_6MW_STATUS = "6mw_status";
    ...
    public static final String KEY_ASD_DIRTY_TIP = "asd_dirty_tip";
    ...
    public static final String KEY_CAMERA_LYING_TIP_SWITCH = "camera_lying_tip_switch";
    public static final String KEY_CAPTURE_ASD_DETECT_TIP = "capture_asd_detect_tip";
    ...
    public static final String KEY_LENS_DIRTY_TIP = "asd_dirty_tip";
    ...
    public static final String KEY_MANUALLY_RAW_TAKEN = "manally_raw_taken";
    public static final String KEY_MANUALLY_RESET_CLICK = "manally_reset_click";
    public static final String KEY_MANUALLY_RESET_DIALOG_CANCEL_CLICK = "manally_reset_dialog_cancel_click";
    public static final String KEY_MANUALLY_RESET_DIALOG_OK_CLICK = "manally_reset_dialog_ok_click";
    public static final String KEY_MANUALLY_RESET_SHOW = "manally_reset_show";
    ...
    public static final String KEY_PHOTO_ASSISTANCE_TIP = "photo_assistance_tip";
    ...
    public static final String KEY_REFERENCE_LINE_CHANGED = "reference_line_changed";
    public static final String KEY_SELECT_OBJECT = "select_object";
    public static final String KEY_SHOW_ZOOM_BAR_BY_SCROLL = "show_zoom_bar_by_scroll";
    public static final String KEY_SNAP_CAMERA = "snap_camera";
    public static final String KEY_START_APP_COST = "start_app_cost";
    public static final String KEY_SUPERNIGHT_IN_CAPTUREMODE = "supernight_in_capturemode";
    ...
    public static final String KEY_VV_START = "vv_start";
    public static final String KEY_VV_TEMPLATE_THUMBNAIL = "vv_template_thumbnail";
    public static final String KEY_VV_VIDEO = "vv_video";
    ...
    public static final String PARAM_960_MACRO_MODE = "960微距模式";
    public static final String PARAM_AI_SCENE_DETECTED = "智能场景发现";
    public static final String PARAM_AI_SCENE_SWITCHED = "智能场景开关";
    public static final String PARAM_ASD_DETECT_TIP = "智能检测提示";
    public static final String PARAM_ASD_DIRTY_TIP_LENS = "脏污镜头";
    ...
    public static final String PARAM_REFERENCE_LINE = "参考线";
    public static final String PARAM_SAT_ZOOM = "SAT";
    public static final String PARAM_SAT_ZOOM_RANG = "SAT_ZOOM_RANG";
    public static final String PARAM_SELECT_OBJECT = "选取主体物";
    public static final String PARAM_SLOW_MOTION_MACRO = "慢动作微距";
    ...
    public static final String PARAM_VV_CLICK_EXIT = "vv退出";
    public static final String PARAM_VV_CLICK_EXIT_CONFIRM = "vv退出确认";
    public static final String PARAM_VV_CLICK_FINISH_EXIT = "vv录制完成后退出";
    public static final String PARAM_VV_CLICK_FINISH_EXIT_CONFIRM = "vv录制完成后退出确认";
    public static final String PARAM_VV_CLICK_PLAY_ALL = "vv预览全部";
    public static final String PARAM_VV_CLICK_PLAY_ALL_PAUSE = "vv预览全部暂停";
    public static final String PARAM_VV_CLICK_PLAY_ALL_RESUME = "vv预览全部继续";
    public static final String PARAM_VV_CLICK_PLAY_SAVE = "vv预览保存";
    public static final String PARAM_VV_CLICK_PLAY_SEGMENT = "vv预览片段";
    public static final String PARAM_VV_CLICK_PLAY_SEGMENT_EXIT = "vv预览片段退出";
    public static final String PARAM_VV_CLICK_PLAY_SHARE = "vv预览分享";
    public static final String PARAM_VV_CLICK_PLAY_SHARE_SHEET = "live预览分享_";
    public static final String PARAM_VV_CLICK_REVERSE = "vv录制回退";
    public static final String PARAM_VV_CLICK_REVERSE_CONFIRM = "vv录制回退确认";
    public static final String PARAM_VV_CLICK_START_SEGMENT = "vv开始录制片段";
    public static final String PARAM_VV_CLICK_TEMPLATE_PREVIEW = "vv大图预览中";
    public static final String PARAM_VV_ICON_CLICK = "vvIcon点击";
    public static final String PARAM_VV_TEMPLATE_NAME = "vv模板类型";
    ...
    public static final String VALUE_ASD_BACKLIT_TIP = "逆光人像";
    public static final String VALUE_ASD_PORTART_TIP = "人物提示";
    ...
    public static void recordCalculateEvent(String str, String str2, long j) {
        ...
        if (sDumpStatEvent) {
            dumpEvent("CalculateEvent", str, str2, String.valueOf(j), (Map<String, String>) null);
        }
    }
    ...
    public static void recordCountEvent(String str, String str2) {
        ...
        if (sDumpStatEvent) {
            dumpEvent("CountEvent", str, str2, (String) null, (Map<String, String>) null);
        }
    }
    ...
    public static void recordCountEvent(String str, String str2, Map<String, String> map) {
        ...
        if (sDumpStatEvent) {
            dumpEvent("CountEvent", str, str2, (String) null, map);
        }
    }
    ...
    public static void recordStringPropertyEvent(String str, String str2, String str3) {
        ...
        if (sDumpStatEvent) {
            dumpEvent("PropertyEvent", str, str2, str3, (Map<String, String>) null);
        }
    }
}
