...
public class SensorStateManager {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (access$000 != null) {
                ...
                if (f != SensorStateManager.this.mOrientation) {
                    ...
                    float unused = SensorStateManager.this.mOrientation = f;
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (access$000 != null && access$000.isWorking()) {
                ...
                if (abs >= SensorStateManager.EVENT_PROCESS_INTERVAL) {
                    ...
                    int unused3 = SensorStateManager.this.mAngleSpeedIndex = SensorStateManager.access$404(SensorStateManager.this) % SensorStateManager.this.mAngleSpeed.length;
    ...
    public boolean isStable() {
        ...
        if (this.mAngleSpeedIndex >= 0) {
            ...
            Log.v(TAG, "isStable mAngleSpeed=" + length + " lastSpeed=" + d + " threshold=" + GYROSCOPE_STABLE_THRESHOLD);
            return length <= GYROSCOPE_STABLE_THRESHOLD && d <= GYROSCOPE_STABLE_THRESHOLD;
        }
