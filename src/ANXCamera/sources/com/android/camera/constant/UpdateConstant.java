...
public class UpdateConstant {
    ...
    @UpdateType
    public static final int[] CAMERA_TYPES_ON_PREVIEW_SUCCESS = {24, 2, 26, 27, 28, 29, 46, 47, 7, 8, 10, 11, 14, 19, 4, 13, 45, 5, 9, 20, 21, 34, 23, 25, 36, 37, 42, 43, 48, 49, 52, 56, 30, 57, 61};
    @UpdateType
    ...
    public static final int TYPE_MIMOVIE = 60;
