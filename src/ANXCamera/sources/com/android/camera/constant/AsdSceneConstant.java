...
public class AsdSceneConstant {
    private static final float AEC_LUX_HEIGHT_LIGHT = ((float) DataRepository.dataItemFeature().xa());
    private static final float AEC_LUX_LAST_LIGHT = ((float) DataRepository.dataItemFeature().ya());
    ...
    public static int parseRtbSceneResult(CaptureResult captureResult, boolean z, boolean z2) {
        ...
        if (!z) {
            ...
            float f2 = ModuleManager.isFunARModule() ? AEC_LUX_HEIGHT_LIGHT * 0.7f : AEC_LUX_HEIGHT_LIGHT;
