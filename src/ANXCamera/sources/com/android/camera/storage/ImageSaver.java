...
public class ImageSaver implements SaverCallback, ParallelCallback, CircularMediaRecorder.VideoClipSavingCallback {
    ...
    private void dealExif(ParallelTaskData parallelTaskData, CaptureResult captureResult) {
        if (captureResult != null) {
            ...
            sb.append(" hdrEnable:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.IS_HDR_ENABLE)));
            String hdrEvValue = new HdrEvValue((byte[]) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.HDR_CHECKTER_EV_VALUES)).toString();
            if (!TextUtils.isEmpty(hdrEvValue)) {
                sb.append(" hdrEv:" + hdrEvValue);
            }
            sb.append(" superResolution:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.SUPER_RESOLUTION_ENABLED)));
            sb.append(" mfnrEnable:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.MFNR_ENABLED)));
            sb.append(" swMfnrEnable:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.SW_MFNR_ENABLED)));
            int satMasterCameraId = CaptureResultParser.getSatMasterCameraId(captureResult);
            sb.append(" 180cameraID:" + satMasterCameraId);
            sb.append(" superNight:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.SUPER_NIGHT_SCENE_ENABLED)));
            sb.append(" frontPortraitBokeh:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.FRONT_SINGLE_CAMERA_BOKEH)));
            if (b.isMTKPlatform()) {
                sb.append(" remosaic:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.CONTROL_ENABLE_REMOSAIC)));
            } else {
                sb.append(" remosaic:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.REMOSAIC_DETECTED)));
            }
            if (pictureInfo.getOperateMode() == 36864) {
                sb.append(" bokehEnable:true");
            } else {
                sb.append(" bokehEnable:" + ((Boolean) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.REAR_BOKEH_ENABLE)));
            }
            Byte b2 = (Byte) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.DEPURPLE);
            if (b2 == null || b2.byteValue() != 1) {
                sb.append(" Depurple:false ");
            } else {
                sb.append(" Depurple:true ");
            }
            Byte b3 = (Byte) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.ULTRA_WIDE_LENS_DISTORTION_CORRECTION_LEVEL);
            if (b3 == null || b3.byteValue() != 1) {
                sb.append(" uwldc:false ");
            } else {
                sb.append(" uwldc:true ");
            }
            sb.append(" beautyLevel: " + ((String) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_LEVEL)));
            sb.append(" beautySkinColor: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SKIN_COLOR)));
            sb.append(" beautySlimFace: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SLIM_FACE)));
            sb.append(" beautySlimSmooth: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SKIN_SMOOTH)));
            sb.append(" beautyEnlargeEye: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_ENLARGE_EYE)));
            sb.append(" beautyNose: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_NOSE)));
            sb.append(" beautyRisorius: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_RISORIUS)));
            sb.append(" beautyLips: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_LIPS)));
            sb.append(" beautyChin: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_CHIN)));
            sb.append(" beautySmile: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SMILE)));
            sb.append(" beautySlimNose: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SLIM_NOSE)));
            sb.append(" beautyHairLine: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_HAIRLINE)));
            sb.append(" beautyEyebowDye: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_EYEBROW_DYE)));
            sb.append(" beautyPupilLine: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_PUPIL_LINE)));
            sb.append(" beautyJellyLips: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_JELLY_LIPS)));
            sb.append(" beautyBluser: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_BLUSHER)));
            sb.append(" beautyEyeLight: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.EYE_LIGHT_TYPE)));
            sb.append(" beautyEyeLightStrength: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.EYE_LIGHT_STRENGTH)));
            sb.append(" beautyHeadSlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_HEAD_SLIM)));
            sb.append(" beautyBodySlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_BODY_SLIM)));
            sb.append(" beautyShoulderSlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_SHOULDER_SLIM)));
            sb.append(" beautyLegSlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BEAUTY_LEG_SLIM)));
            sb.append(" beautyWholeBodySlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.WHOLE_BODY_SLIM)));
            sb.append(" beautyButtSlim: " + ((Integer) VendorTagHelper.getValueSafely(captureResult, CaptureResultVendorTags.BUTT_SLIM)));
    ...
    public void addImage(byte[] bArr, boolean z, String str, String str2, long j, Uri uri, Location location, int i, int i2, ExifInterface exifInterface, int i3, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, String str3, PictureInfo pictureInfo, int i4) {
        ...
        ImageSaveRequest imageSaveRequest = new ImageSaveRequest(bArr2, z, str, str2, j, uri2, location, i, i2, exifInterface, i3, z2, z3, z4, z5, z7, str3, pictureInfo, i4);
