...
public abstract class SurfaceTextureScreenNail implements SurfaceTexture.OnFrameAvailableListener, Rotatable, ScreenNail {
    private static final float MOVIE_SOLID_CROPPED_X = (b.iW() ? 0.9f : 0.8f);
    ...
    private void initializePreviewTexture() {
        ...
        if (b.jD() && !sFrameListener.isAlive()) {
        ...
        if (Build.VERSION.SDK_INT < 21 || !b.jD()) {
    ...
    public void draw(GLCanvas gLCanvas) {
        ...
        if (!this.mIsFullScreen || b.iO() || Util.isNotchDevice || Util.isLongRatioScreen || Util.sIsnotchScreenHidden) {
