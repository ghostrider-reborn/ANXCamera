...
public class ImageLoader {
    ...
    public ImageContainer get(String str, ImageListener imageListener, int i, int i2, ImageView.ScaleType scaleType) {
        ...
        if (bitmap != null) {
            ImageContainer imageContainer = new ImageContainer(bitmap, str2, (String) null, (ImageListener) null);
            imageListener2.onResponse(imageContainer, true);
            return imageContainer;
        }
        ImageContainer imageContainer2 = new ImageContainer((Bitmap) null, str2, cacheKey, imageListener2);
        ...
        Request<Bitmap> makeImageRequest = makeImageRequest(str2, i3, i4, scaleType2, cacheKey);
