...
public abstract class MiCamera2Shot<T> {
    ...
    public final ParallelTaskData generateParallelTaskData(long j) {
        ...
        ParallelTaskData parallelTaskData = new ParallelTaskData(this.mMiCamera.getId(), j, this.mMiCamera.getCameraConfigs().getShotType(), this.mMiCamera.getCameraConfigs().getShotPath());
