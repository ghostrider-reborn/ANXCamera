...
public class MiCameraCompatBaseImpl {
    ...
    public void applyMiMovie(CaptureRequest.Builder builder, byte b2) {
        VendorTagHelper.setValue(builder, CaptureRequestVendorTags.MiMOVIE_ENABLED, Byte.valueOf(b2));
    }
