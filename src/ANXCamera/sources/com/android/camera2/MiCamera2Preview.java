...
public abstract class MiCamera2Preview {
    ...
    public boolean needForVideo() {
        return this.mCurrentModule == 162 || this.mCurrentModule == 169 || this.mCurrentModule == 161 || this.mCurrentModule == 174 || this.mCurrentModule == 172;
    }

    public boolean needResumePreviewAfterCapture(CameraConfigs cameraConfigs) {
        return cameraConfigs.isNeedFlash() || needForSuperNight() || cameraConfigs.isForceBackSoftLight();
    }
}
