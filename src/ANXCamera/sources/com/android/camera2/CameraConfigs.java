...
public class CameraConfigs {
    ...
    private boolean isMiMovieEnabled;
    ...
    private boolean mForceBackSoftLight;
    ...
    public String getShotPath() {
        ...
        String poll = this.mShotPath.poll();
        String str = TAG;
    ...
    public boolean isForceBackSoftLight() {
        return this.mForceBackSoftLight;
    }
    ...
    public boolean isMiMovieEnabled() {
        return this.isMiMovieEnabled;
    }
    ...
    public boolean setForceBackSoftLight(boolean z) {
        if (this.mForceBackSoftLight == z) {
            return false;
        }
        this.mForceBackSoftLight = z;
        return true;
    }
    ...
    public void setMiMovieEnabled(boolean z) {
        this.isMiMovieEnabled = z;
    }
