...
public class VideoStreamsView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private void texImage2D(VideoRenderer.I420Frame i420Frame, int[] iArr) {
        ...
        GLES20.glVertexAttribPointer(this.tcLocation, 2, 5126, false, 0, floatBuffer);
        checkNoGLES2Error();
    }
    ...
    public void generateTexture(int i, int i2) {
        ...
        for (int i5 = 3; i3 < i5; i5 = 3) {
            ...
            checkNoGLES2Error();
            GLES20.glTexImage2D(3553, 0, 6409, i6, i7, 0, 6409, 5121, i3 == 0 ? allocate : allocate2);
            checkNoGLES2Error();
    ...
    public void onDrawFrame(GL10 gl10) {
        synchronized (this) {
            ...
            Boolean bool = false;
            FloatBuffer directNativeFloatBuffer = directNativeFloatBuffer(new float[]{0.0f - ((float) ((((double) this.debug_increment) * 0.01d) + 0.5d)), 0.0f - ((float) ((((double) this.debug_increment) * 0.01d) + 0.5d)), 0.0f - ((float) ((((double) this.debug_increment) * 0.01d) + 0.5d)), 0.0f - ((float) ((((double) this.debug_increment) * 0.01d) + 0.5d)), (float) ((((double) this.debug_increment) * 0.01d) + 0.5d), (float) ((((double) this.debug_increment) * 0.01d) + 0.5d), (float) ((((double) this.debug_increment) * 0.01d) + 0.5d), 0.0f - ((float) (0.5d + (((double) this.debug_increment) * 0.01d)))});
            ...
            if (this.lastFPSLogTime == -1 || ((double) (nanoTime - this.lastFPSLogTime)) > 1.0E9d) {
                long j = this.numFramesSinceLastLog;
                long j2 = this.lastFPSLogTime;
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        try {
            ...
            Log.i(TAG, " dalvikPrivateDirty: " + r10.dalvikPrivateDirty + "");
            Log.i(TAG, " nativePss: " + r10.nativePss + "");
            Log.i(TAG, " otherSharedDirty: " + r10.otherSharedDirty + "");
            Log.i(TAG, " totalPrivate: " + r10.getTotalPrivateDirty() + ", " + " totalPss:" + r10.getTotalPss() + " totalShared" + r10.getTotalSharedDirty() + "");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0068, code lost:
        if (r3.framesToRender != null) goto L_0x0072;
     */
