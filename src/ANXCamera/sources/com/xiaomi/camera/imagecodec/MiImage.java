    ...
    private void fromImage(Image image) {
        ...
        while (i3 < planes2.length) {
            ...
            if (planes[i3].getPixelStride() == planes2[i3].getPixelStride()) {
                    ...
                    while (true) {
                        ...
                        if (i7 == effectivePlaneSizeForImage.getHeight() - 1) {
                            ...
                            if (i4 > remaining2) {
                                ...
                                i = i3;
                                i2 = 0;
                                Log.d(str, String.format(locale, "dstPlane[%d].remain=%d", new Object[]{valueOf, Integer.valueOf(remaining2)}));
                                i4 = remaining2;
                ...
                int i9 = i3;
                throw new IllegalArgumentException("source plane image pixel stride " + planes[i9].getPixelStride() + " must be same as destination image pixel stride " + planes2[i9].getPixelStride());
            }
        }
        long j2 = currentTimeMillis;
        String str2 = TAG;
        Log.d(str2, "fromImage: cost=" + (System.currentTimeMillis() - j2));
    }
