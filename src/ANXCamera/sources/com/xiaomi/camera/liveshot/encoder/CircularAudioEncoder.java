    ...
    public void doRelease() {
        if (this.mIsInitialized) {
            ...
            try {
                ...
                String str = TAG;
                Log.d(str, "Meet exception when mAudioRecord.release(): " + e);
            }
    ...
    public void doStart() {
        ...
        if (!this.mIsInitialized) {
            ...
            try {
                ...
                String str = TAG;
                Log.e(str, "startRecording(): failed " + e);
            }
        }
    }
    ...
    public void doStop() {
        ...
        if (!this.mIsInitialized) {
            ...
            try {
                ...
                String str = TAG;
                Log.d(str, "Meet exception when mAudioRecord.stop(): " + e);
            }
            if (DEBUG) {
            ...
            for (CircularMediaEncoder.Snapshot putEos : arrayList) {
                try {
                    ...
                    String str3 = TAG;
                    Log.d(str3, "Failed to putEos: " + e2);
                }
            }
            if (DEBUG) {
