...
public class CaptureData {
    ...
    public static class CaptureDataBean {
        ...
        public boolean isDataReady() {
            return 2 == this.mStreamNum ? (this.mResult == null || this.mMainImage == null || this.mSubImage == null) ? false : true : (1 != this.mStreamNum || this.mResult == null || this.mMainImage == null) ? false : true;
        }
