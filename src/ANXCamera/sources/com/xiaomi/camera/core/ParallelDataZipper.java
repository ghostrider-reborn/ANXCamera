...
public class ParallelDataZipper {
    ...
    public void tryToCallback(CaptureData.CaptureDataBean captureDataBean) {
        ...
        CaptureData captureData = this.mCaptureDataArray.get(Long.valueOf(getFirstFrameTimestamp(timeStamp)));
        if (captureData != null) {
        ...
        String str = "No task found with sequenceId: " + valueOf + " timestamp: " + timeStamp + "|" + r3;
