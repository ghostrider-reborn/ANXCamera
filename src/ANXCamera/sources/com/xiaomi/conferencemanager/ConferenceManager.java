...
public class ConferenceManager {
    ...
    private int getAudioManagerMode() {
        return ConferenceEngine.getInstance().getAECType() == 2 ? 3 : 3;
    }
    ...
    public boolean joinRoom(String str, String str2, boolean z, boolean z2, boolean z3, String str3, String str4, String str5, ConferenceManagerRole conferenceManagerRole, String str6, String str7) {
        ...
        this.audioManager = (AudioManager) this.mContext.getSystemService(VEEditor.MVConsts.TYPE_AUDIO);
        ...
        if (!ConferenceEngine.getInstance().Join(str9, str8, z, z2, z3, str3, str4, str5, conferenceManagerRole.ordinal(), false, str6, str7)) {
