...
public class WideSelfieEngine {
    ...
    private static final String f81a = WideSelfieEngine.class.getName();

    /* renamed from: b  reason: collision with root package name */
    private static WideSelfieEngine f82b = null;
    ...
    public static synchronized WideSelfieEngine getSingleInstance() {
        ...
        synchronized (WideSelfieEngine.class) {
            if (f82b == null) {
                synchronized (WideSelfieEngine.class) {
                    if (f82b == null) {
                        f82b = new WideSelfieEngine();
                    }
                }
            }
            wideSelfieEngine = f82b;
        }
