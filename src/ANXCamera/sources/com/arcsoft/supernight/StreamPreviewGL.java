...
public class StreamPreviewGL extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private void c() {
        this.f = ShaderUtils.loadFromAssetsFile("arcsoft/vertex.sh", this.f88a.getResources());
        this.g = ShaderUtils.loadFromAssetsFile("arcsoft/frag.sh", this.f88a.getResources());
