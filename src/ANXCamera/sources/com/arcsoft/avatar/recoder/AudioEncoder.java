...
public class AudioEncoder extends BaseEncoder {
    ...
    private boolean b() {
        ...
        try {
            ...
            if (this.o != null) {
                this.o.onRecordingListener(NotifyMessage.MSG_MEDIA_RECORDER_ERROR_AUDIO_RECORD_CREATE, 0);
            }
            e.printStackTrace();
        }
    ...
    private boolean c() {
        ...
        try {
            ...
            this.i = null;
            if (this.o != null) {
                this.o.onRecordingListener(NotifyMessage.MSG_MEDIA_RECORDER_ERROR_ENCODER_AUDIO_CREATE, 0);
            }
            e.printStackTrace();
        }
        if (this.i == null) {
        ...
        try {
            ...
            e2.printStackTrace();
            if (this.o != null) {
                this.o.onRecordingListener(NotifyMessage.MSG_MEDIA_RECORDER_ERROR_ENCODER_AUDIO_CONFIGURE, 0);
            }
        }
        return true;
    }
                ...
                this.w = new Thread(u) {
                    public void run() {
                        ...
                        try {
                            ...
                            if (AudioEncoder.this.o != null) {
                                AudioEncoder.this.o.onRecordingListener(NotifyMessage.MSG_MEDIA_RECORDER_ERROR_ENCODER_AUDIO_START, 0);
                            }
                        }
