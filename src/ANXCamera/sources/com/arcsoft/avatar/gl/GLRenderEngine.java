...
public class GLRenderEngine {
    ...
    public void initNv21TextureIds() {
        ...
        this.k[0] = GLES20.glGetUniformLocation(this.o, f84b);
        this.k[1] = GLES20.glGetUniformLocation(this.o, f85c);
        this.m = GLES20.glGetUniformLocation(this.o, f87e);
        this.n = GLES20.glGetUniformLocation(this.o, f88f);
    }

    public void initRgbaTextureIds() {
        this.o = ShaderManager.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_RGBA8);
        this.l[0] = GLES20.glGetUniformLocation(this.o, f86d);
        this.m = GLES20.glGetUniformLocation(this.o, f87e);
        this.n = GLES20.glGetUniformLocation(this.o, f88f);
    }
