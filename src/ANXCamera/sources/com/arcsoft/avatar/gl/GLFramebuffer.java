...
public class GLFramebuffer {
    ...
    public void bind(boolean z, boolean z2) {
        ...
        GLES20.glGetIntegerv(36006, this.f18a, 0);
        GLES20.glBindFramebuffer(36160, this.f19b[0]);
        if (z2) {
    ...
    public void init(int i, int i2, boolean z) {
        ...
        this.c[0] = 0;
        GLES20.glGetIntegerv(36006, this.f18a, 0);
        GLES20.glGenFramebuffers(1, this.f19b, 0);
        GLES20.glBindFramebuffer(36160, this.f19b[0]);
        ...
        GLES20.glBindFramebuffer(36160, this.f18a[0]);
    ...
    public void unInit() {
        ...
        this.c[0] = 0;
        GLES20.glDeleteFramebuffers(1, this.f19b, 0);
        this.f19b[0] = 0;
        if (this.e) {
