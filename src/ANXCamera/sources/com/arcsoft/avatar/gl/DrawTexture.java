...
public class DrawTexture {
    ...
    private void a(boolean z) {
        ...
        this.f57e = GLES30.glGetAttribLocation(this.f56d, "aPosition");
        GLES30.glBindBuffer(34962, this.g[0]);
        GLES30.glBufferData(34962, this.k.length * 4, asFloatBuffer, 35044);
        GLES30.glEnableVertexAttribArray(this.f57e);
        GLES30.glVertexAttribPointer(this.f57e, 2, 5126, false, 8, 0);
        ...
        this.i.position(0);
        this.j = false;
        this.f58f = GLES30.glGetAttribLocation(this.f56d, "arc_tex_coord");
        GLES30.glBindBuffer(34962, this.g[1]);
        GLES30.glBufferData(34962, fArr.length * 4, this.i, 35048);
        GLES30.glEnableVertexAttribArray(this.f58f);
        GLES30.glVertexAttribPointer(this.f58f, 2, 5126, false, 8, 0);
    ...
    public void DrawSurfaceWithTex(int i2) {
        GLES30.glUseProgram(this.f56d);
        GLES30.glBindVertexArray(this.h[0]);
        GLES30.glActiveTexture(33984);
        GLES30.glBindTexture(3553, i2);
        GLES30.glUniform1i(this.f55c, 0);
    ...
    public void initGLFun(boolean z) {
        ...
        this.f56d = GLES30.glCreateProgram();
        int i2 = this.f56d;
        if (i2 != 0) {
            GLES30.glAttachShader(i2, glCreateShader);
            GLES30.glAttachShader(this.f56d, glCreateShader2);
            GLES30.glLinkProgram(this.f56d);
            int[] iArr3 = new int[1];
            GLES30.glGetProgramiv(this.f56d, 35714, iArr3, 0);
            if (iArr3[0] == 0) {
                this.f56d = 0;
            }
        }
        a(z);
        this.f55c = GLES30.glGetUniformLocation(this.f56d, "sTexture");
    }
