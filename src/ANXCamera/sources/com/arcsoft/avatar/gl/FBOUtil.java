...
public class FBOUtil {
    ...
    public void bindFramebuff() {
        ...
        GLES20.glGetIntegerv(36006, this.f16a, 0);
        GLES20.glBindFramebuffer(36160, this.f17b[0]);
    ...
    public void initFramebuff(int i2, int i3) {
        ...
        this.c[0] = 0;
        GLES20.glGetIntegerv(36006, this.f16a, 0);
        GLES20.glGenFramebuffers(1, this.f17b, 0);
        GLES20.glBindFramebuffer(36160, this.f17b[0]);
        ...
        GLES20.glTexImage2D(3553, 0, 6408, i4, i5, 0, 6408, 5121, (Buffer) null);
        ...
        GLES20.glBindFramebuffer(36160, this.f16a[0]);
    ...
    public void uninitFramebuff() {
        ...
        this.c[0] = 0;
        GLES20.glDeleteFramebuffers(1, this.f17b, 0);
        this.f17b[0] = 0;
