...
public class WatermarkRenderPipeline {
    ...
    private void checkPostFrameBuffer(int i, int i2) {
        if (this.mPostFrameBuffer == null || this.mPostFrameBuffer.getWidth() != i || this.mPostFrameBuffer.getHeight() != i2) {
            if (this.mPostFrameBuffer != null) {
                this.mPostFrameBuffer.release();
            }
    ...
    private void checkPreFrameBuffer(int i, int i2) {
        if (this.mPreFrameBuffer == null || this.mPreFrameBuffer.getWidth() != i || this.mPreFrameBuffer.getHeight() != i2) {
            if (this.mPreFrameBuffer != null) {
                this.mPreFrameBuffer.release();
            }
    ...
    public void init(int i, int i2, Bitmap bitmap, float[] fArr, int i3) {
        ...
        this.mWatermarkW = this.mWatermarkRange[2];
        this.mWatermarkH = this.mWatermarkRange[3];
        ...
        if ((this.mWatermarkRotation + MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 90 || (this.mWatermarkRotation + MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT) % MiuiSettings.ScreenEffect.SCREEN_PAPER_MODE_TWILIGHT_START_DEAULT == 270) {
            i4 = i;
            i5 = i2;
        } else {
            i5 = i;
        ...
        calcDualCameraWatermarkLocation[0] = calcDualCameraWatermarkLocation[0] - this.mWatermarkRange[4];
        calcDualCameraWatermarkLocation[1] = calcDualCameraWatermarkLocation[1] - this.mWatermarkRange[5];
        this.mWatermarkTextureRenderExt = new WatermarkTextureRenderExt(this.mWatermarkW > this.mWatermarkH ? this.mWatermarkW : this.mWatermarkH, this.mWatermarkW > this.mWatermarkH ? this.mWatermarkH : this.mWatermarkW, calcDualCameraWatermarkLocation);
    ...
    public void process(byte[] bArr) {
        ...
        YuvTextureJNI.merge(this.mWatermarkW, this.mWatermarkH, (this.mWatermarkRange[1] * this.mParentW) + this.mWatermarkRange[0] + 0, ((this.mWatermarkRange[1] >> 1) * this.mParentW) + this.mWatermarkRange[0] + 0);
        GLES20.glBindFramebuffer(36160, 0);
        this.mRenderSurface.makeNothingCurrent();
    }
