...
public class ColorLookupFilter4x4 extends BaseOriginalFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ColorLookupFilter4x4 colorLookupFilter4x4 = ColorLookupFilter4x4.this;
                colorLookupFilter4x4.mLookupSourceTexture = OpenGlUtils.loadTexture(BeautificationSDK.sContext, colorLookupFilter4x4.mTable);
            }
        });
    }
