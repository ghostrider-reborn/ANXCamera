...
public class CameraInstance {
    ...
    public synchronized void focusAtPoint(float f, float f2, float f3) {
        ...
        if (this.mParams.getMaxNumMeteringAreas() > 0) {
            ...
            try {
                ...
                VELogUtil.e(TAG, "Error: focusAtPoint failed: " + e.toString());
            }
        } else {
    ...
    public void initCamera(int i) {
        ...
        VELogUtil.i(TAG, String.format("Camera Picture Size: %d x %d", new Object[]{Integer.valueOf(pictureSize.width), Integer.valueOf(pictureSize.height)}));
