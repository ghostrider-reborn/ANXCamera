...
public class SharedContext {
    ...
    public static final String LOG_TAG = SharedContext.class.getSimpleName();
    ...
    private boolean initEGL(EGLContext eGLContext, int i, int i2, int i3, Object obj) {
        ...
        if (eglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            ...
            if (this.mSurface == EGL14.EGL_NO_SURFACE) {
                ...
                return false;
            } else if (!EGL14.eglMakeCurrent(this.mDisplay, this.mSurface, this.mSurface, this.mContext)) {
                String str2 = LOG_TAG;
    ...
    public String getConfigAttrib(int i) {
        if (!isInitialized() || this.mConfig == null) {
            return "Not initialized";
        }
        int[] iArr = new int[1];
        EGL14.eglGetConfigAttrib(this.mDisplay, this.mConfig, i, iArr, 0);
