...
public class FaceBeautyInvoker implements MessageCenter.Listener {
    ...
    private AVCEncoderInterface mAVCEncoderInterface = new AVCEncoderInterface() {
        ...
        public Surface onInitHardEncoder(int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
            ...
            Surface initAVCEncoder = FaceBeautyInvoker.this.mAVCEncoder.initAVCEncoder(i7, i8, i3, i4, i5, i6, z);
        ...
        public void onSetCodecConfig(ByteBuffer byteBuffer) {
            ...
            if (FaceBeautyInvoker.this.mHandler != 0) {
                int unused = FaceBeautyInvoker.this.nativeSetCodecConfig(FaceBeautyInvoker.this.mHandler, byteBuffer, byteBuffer.remaining());
            }
        }
        ...
        public void onWriteFile(ByteBuffer byteBuffer, int i, int i2, int i3) {
            if (FaceBeautyInvoker.this.mHandler != 0) {
                int unused = FaceBeautyInvoker.this.nativeWriteFile(FaceBeautyInvoker.this.mHandler, byteBuffer, byteBuffer.remaining(), i, i3);
            }
        }

        public void onWriteFile(ByteBuffer byteBuffer, long j, long j2, int i, int i2) {
            if (FaceBeautyInvoker.this.mHandler != 0) {
                int unused = FaceBeautyInvoker.this.nativeWriteFile2(FaceBeautyInvoker.this.mHandler, byteBuffer, byteBuffer.remaining(), j, j2, i2);
            }
        }

        public void setColorFormat(int i) {
            if (FaceBeautyInvoker.this.mHandler != 0) {
                int unused = FaceBeautyInvoker.this.nativeSetColorFormat(FaceBeautyInvoker.this.mHandler, i);
            }
        }
    };
    ...
    public int concat(String str, String str2, String str3, String str4) {
        ...
        return nativeConcat(this.mHandler, str, str2, 0, str3, str4);
    }
    ...
    public int enableTTFaceDetect(boolean z) {
        return this.mHandler == 0 ? INVALID_HANDLE : nativeEnableTTFaceDetect(this.mHandler, z);
    }
    ...
    public int initAudioConfig(int i, int i2) {
        return this.mHandler == 0 ? INVALID_HANDLE : nativeInitAudioConfig(this.mHandler, i, i2);
    }
    ...
    public void onFirstFrameRenderInfo(int i, double d) {
        if (i == 0) {
            ...
            LogUtil.w(TAG, "Camera Preview First Frame Cost: " + (d - ((double) VEMonitorUtils.sbeforeCameraOpenTimeStamp)));
        } else if (i == 1) {
            ...
            LogUtil.w(TAG, "Camera Change Cost: " + (d - ((double) VEMonitorUtils.sbeforeSwitchCameraTimeStamp)));
        }
    }
    ...
    public int onNativeCallback_onOpenGLRunning(double d) {
        VELogUtil.d(TAG, "onNativeCallback_onOpenGLRunning, timestamp = " + d);
        int onOpenGLRunning = this.mOpenGLCallback != null ? this.mOpenGLCallback.onOpenGLRunning() : 0;
        if (this.mGetTimestampCallback != null) {
            this.mGetTimestampCallback.getTimestamp(d);
        }
    ...
    public int renderPicture(ImageFrame imageFrame, int i, int i2, OnPictureCallbackV2 onPictureCallbackV2) {
        ...
        if (Build.VERSION.SDK_INT < 19 || imageFrame.getPlans() == null) {
            return imageFrame.getBitmap() != null ? nativeRenderPicture3(this.mHandler, imageFrame.getBitmap(), i, i2, onPictureCallbackV2) : nativeRenderPicture(this.mHandler, (byte[]) null, 0, 0, 0, (OnPictureCallbackV2) null);
        }
        Image.Plane[] plans = imageFrame.getPlans();
        if (plans == null) {
            return -1;
    ...
    public void setDeviceRotation(float[] fArr) {
        if (isRenderReady() && this.mHandler != 0) {
            nativeSetDeviceRotation(this.mHandler, fArr);
        }
    }
    ...
    public int setFilterIntensity(float f) {
        return !isRenderReady() ? INVALID_ENV : this.mHandler == 0 ? INVALID_HANDLE : nativeSetFilterIntensity(this.mHandler, f);
    }

    @Deprecated
    public int setFilterPos(float f) {
        return !isRenderReady() ? INVALID_ENV : this.mHandler == 0 ? INVALID_HANDLE : nativeSetFilterPos(this.mHandler, f);
    }
    ...
    public int setFrameCallback(OnFrameCallback onFrameCallback, boolean z) {
        return this.mHandler == 0 ? INVALID_HANDLE : nativeSetFrameCallback(this.mHandler, onFrameCallback, z);
    }
    ...
    public void setPreviewSizeRatio(float f) {
        if (this.mHandler != 0) {
            nativeSetPreviewSizeRatio(this.mHandler, f);
        }
    }
    ...
    public int startRecord(double d, boolean z, float f, int i, int i2) {
        ...
        return nativeStartRecord(this.mHandler, d, z, i4, i, i2);
    }

    public int stopPlay() {
        this.mIsRenderRady = false;
        return this.mHandler == 0 ? INVALID_HANDLE : nativeStopPlay(this.mHandler);
    }
