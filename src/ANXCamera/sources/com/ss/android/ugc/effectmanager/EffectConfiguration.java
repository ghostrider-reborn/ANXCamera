...
public class EffectConfiguration {
    ...
    private EffectConfiguration(Builder builder) {
        ...
        this.mChannel = (TextUtils.equals(EffectConstants.CHANNEL_TEST, builder.channel) || TextUtils.equals(EffectConstants.CHANNEL_LOCAL_TEST, builder.channel)) ? EffectConstants.CHANNEL_TEST : EffectConstants.CHANNEL_ONLINE;
