...
public class VERuntime {
            ...
            public void run() {
                ...
                if (VERuntime.this.mUseCloudConfig && "on".equals("on")) {
                    try {
                        ...
                        Log.e(VERuntime.TAG, "PerformanceConfig restoreFromCache failed", e2);
                    }
    ...
    public boolean setAssetManagerEnable(boolean z) {
        ...
        if (this.mContext != null) {
            VEEffectConfig.enableAssetManager(this.mContext.getAssets());
    ...
    public int setEffectModelsPath(@NonNull String str) {
        ...
        this.mEnv.setDetectModelsDir(str);
