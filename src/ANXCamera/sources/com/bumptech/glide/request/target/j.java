...
public class j extends m<Bitmap> {
    ...
    public j(Context context2, int i, int i2, int i3, RemoteViews remoteViews2, Notification notification2, int i4, String str) {
        super(i, i2);
        i.a(context2, "Context must not be null!");
        this.context = context2;
        i.a(notification2, "Notification object can not be null!");
    ...
    private void update() {
        ...
        notificationManager.notify(this.zl, this.notificationId, this.notification);
    }
