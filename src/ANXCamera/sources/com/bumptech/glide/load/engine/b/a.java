...
public final class a implements ExecutorService {
    ...
    private static final class C0006a implements ThreadFactory {
        ...
        public synchronized Thread newThread(@NonNull Runnable runnable) {
            AnonymousClass1 r0;
            r0 = new Thread(runnable, "glide-" + this.name + "-thread-" + this.jU) {
                public void run() {
    ...
    public static a a(int i, b bVar) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, i, jN, TimeUnit.MILLISECONDS, new PriorityBlockingQueue(), new C0006a(jM, bVar, true));
    ...
    public static a ct() {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, jN, TimeUnit.MILLISECONDS, new SynchronousQueue(), new C0006a(jL, b.jZ, false));
        return new a(threadPoolExecutor);
    }

    public static a cu() {
        return a(cv() >= 4 ? 2 : 1, b.jZ);
    }
