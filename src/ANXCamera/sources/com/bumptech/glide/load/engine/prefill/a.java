...
public final class a {
    ...
    public void b(c.a... aVarArr) {
        ...
        for (int i = 0; i < aVarArr.length; i++) {
            ...
            if (aVar.getConfig() == null) {
                aVar.e((this.kk == DecodeFormat.PREFER_ARGB_8888 || this.kk == DecodeFormat.PREFER_ARGB_8888_DISALLOW_HARDWARE) ? Bitmap.Config.ARGB_8888 : Bitmap.Config.RGB_565);
            }
            cVarArr[i] = aVar.cA();
        }
    ...
    public b generateAllocationOrder(c... cVarArr) {
        long maxSize = (this.bn.getMaxSize() - this.bn.ci()) + this.bm.getMaxSize();
        int i = 0;
