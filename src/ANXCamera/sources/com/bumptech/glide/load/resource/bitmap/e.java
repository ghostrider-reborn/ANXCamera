...
public class e implements i<Bitmap> {
    ...
    public static final f<Integer> ri = f.a("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
    public static final f<Bitmap.CompressFormat> ti = f.q("com.bumptech.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");
    @Nullable
    private final b qa;
    ...
    private Bitmap.CompressFormat b(Bitmap bitmap, g gVar) {
        Bitmap.CompressFormat compressFormat = (Bitmap.CompressFormat) gVar.a(ti);
    ...
    public boolean a(@NonNull A<Bitmap> a2, @NonNull File file, @NonNull g gVar) {
        ...
        try {
            ...
            try {
                cVar = this.qa != null ? new c(fileOutputStream, this.qa) : fileOutputStream;
        ...
        if (Log.isLoggable(TAG, 2)) {
            Log.v(TAG, "Compressed with type: " + b2 + " of size " + l.j(bitmap) + " in " + com.bumptech.glide.util.e.g(Gh) + ", options format: " + gVar.a(ti) + ", hasAlpha: " + bitmap.hasAlpha());
        }
        return z;
    }
}
