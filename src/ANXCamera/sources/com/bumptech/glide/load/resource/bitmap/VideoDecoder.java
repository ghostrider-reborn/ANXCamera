...
public class VideoDecoder<T> implements h<T, Bitmap> {
    ...
    public static final f<Long> Bj = f.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", -1L, new B());
    public static final f<Integer> Cj = f.a("com.bumptech.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption", 2, new C());
    @VisibleForTesting
