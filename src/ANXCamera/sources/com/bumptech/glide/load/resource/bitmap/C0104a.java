...
public class C0104a<DataType> implements h<DataType, BitmapDrawable> {
    ...
    public C0104a(Context context, h<DataType, Bitmap> hVar) {
        this(context.getResources(), hVar);
    }

    @Deprecated
    public C0104a(Resources resources2, d dVar, h<DataType, Bitmap> hVar) {
        this(resources2, hVar);
    }

    public C0104a(@NonNull Resources resources2, @NonNull h<DataType, Bitmap> hVar) {
