...
public final class o {
    ...
    public static final f<Boolean> _i = f.a("com.bumptech.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
    ...
    private static final Set<ImageHeaderParser.ImageType> fj = Collections.unmodifiableSet(EnumSet.of(ImageHeaderParser.ImageType.JPEG, ImageHeaderParser.ImageType.PNG_A, ImageHeaderParser.ImageType.PNG));
    private static final Queue<BitmapFactory.Options> gj = l.createQueue(0);
    private final d Bb;
    ...
    private static synchronized BitmapFactory.Options Gk() {
    ...
    private Bitmap a(InputStream inputStream, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, boolean z, int i, int i2, boolean z2, a aVar) throws IOException {
        ...
        ImageHeaderParser.ImageType b3 = com.bumptech.glide.load.b.b(this.ne, inputStream2, this.Yd);
        d dVar = this.Bb;
    ...
    private static void a(ImageHeaderParser.ImageType imageType, InputStream inputStream, a aVar, d dVar, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, BitmapFactory.Options options) throws IOException {
        ...
        if (b2 > 0.0f) {
            ...
            if (a2 != null) {
                ...
                if (Build.VERSION.SDK_INT > 23 || !dj.contains(options2.outMimeType)) {
