...
public class o {
    ...
    private static class a {
        private final Map<Class<?>, C0009a<?>> lc = new HashMap();
        ...
        public <Model> void a(Class<Model> cls, List<m<Model, ?>> list) {
            if (this.lc.put(cls, new C0009a(list)) != null) {
    ...
    private <Model, Data> void d(@NonNull List<n<? extends Model, ? extends Data>> list) {
        for (n<? extends Model, ? extends Data> cB : list) {
            cB.cB();
        }
    }
