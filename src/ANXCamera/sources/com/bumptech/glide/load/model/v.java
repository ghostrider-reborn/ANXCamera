...
public class v<Data> implements m<Uri, Data> {
    private static final Set<String> lr = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{ComposerHelper.COMPOSER_PATH, "android.resource", ComposerHelper.COMPOSER_CONTENT})));
    private final c<Data> ls;
    ...
    public m.a<Data> b(@NonNull Uri uri, int i, int i2, @NonNull f fVar) {
        return new m.a<>(new com.bumptech.glide.e.d(uri), this.ls.l(uri));
    }
