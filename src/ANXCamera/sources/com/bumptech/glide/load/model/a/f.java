...
public class f implements m<URL, InputStream> {
    private final m<g, InputStream> lx;
    ...
    /* renamed from: a */
    public m.a<InputStream> b(@NonNull URL url, int i, int i2, @NonNull com.bumptech.glide.load.f fVar) {
        return this.lx.b(new g(url), i, i2, fVar);
    }
