...
public class FeatureParser {
    ...
    private static final String SYSTEM_DIR = "/system/etc/ANXCamera/features";
    ...
    private static final String VENDOR_DIR = "/system/etc/ANXCamera/features";
    ...
    public static String getDeviceFeaturesDir() {
        return (("umi".equals(Build.ANXDEVICE) || "cmi".equals(Build.ANXDEVICE) || "lmi".equals(Build.ANXDEVICE) || "picasso".equals(Build.ANXDEVICE) || "picassoin".equals(Build.ANXDEVICE)) && Build.VERSION.SDK_INT >= 29) ? "/system/etc/ANXCamera/features" : "/system/etc/ANXCamera/features";
    }
