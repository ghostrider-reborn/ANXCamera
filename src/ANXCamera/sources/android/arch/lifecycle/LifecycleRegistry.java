...
public class LifecycleRegistry extends Lifecycle {
    ...
    private boolean isSynced() {
        ...
        Lifecycle.State state2 = this.mObserverMap.U().getValue().mState;
    ...
    private void sync() {
        ...
        while (!isSynced()) {
            ...
            Map.Entry<LifecycleObserver, ObserverWithState> U = this.mObserverMap.U();
            if (!this.mNewEventOccurred && U != null && this.mState.compareTo(U.getValue().mState) > 0) {
