...
public final class CameraCharacteristics extends CameraMetadata<Key<?>> {
    ...
    @PublicKey
    public static final Key<Integer> SENSOR_ORIENTATION = new Key<>("android.sensor.orientation", (Class<Integer>) Integer.TYPE);
    @PublicKey
    ...
    private <TKey> List<TKey> getAvailableKeyList(Class<?> metadataClass, Class<TKey> keyClass, int[] filterTags) {
        if (metadataClass.equals(CameraMetadata.class)) {
            ...
            return Collections.unmodifiableList(getKeys(metadataClass, keyClass, (CameraMetadata) null, filterTags));
        } else {
