...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, this.mCornerRadius + this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, f, 1.0f}, Shader.TileMode.CLAMP);
