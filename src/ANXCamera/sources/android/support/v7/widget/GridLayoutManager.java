    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i17 = 0; i17 < i13; i17++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i14) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    int childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, 1073741824, i19, layoutParams.width, false);
                    i8 = View.MeasureSpec.makeMeasureSpec(i14 - i18, 1073741824);
                    i7 = childMeasureSpec;
                } else {
                    i7 = View.MeasureSpec.makeMeasureSpec(i14 - i19, 1073741824);
