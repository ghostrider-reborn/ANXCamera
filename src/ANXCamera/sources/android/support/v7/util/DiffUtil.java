...
public class DiffUtil {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x00e3, code lost:
        if (r4[r9 - 1] < r4[(r29 + r7) + 1]) goto L_0x00f6;
     */
    private static Snake diffPartial(Callback callback, int i, int i2, int i3, int i4, int[] iArr, int[] iArr2, int i5) {
        ...
        while (i19 <= i16) {
            ...
            while (i21 <= i19) {
                if (i21 != i20) {
                    if (i21 != i19) {
                        if (iArr3[r15 - 1] < iArr3[i5 + i21 + i14]) {
                        }
                    }
                    i8 = iArr3[(i5 + i21) - 1] + 1;
                    z3 = true;
                    ...
                    int i23 = i5 + i21;
                    iArr3[i23] = i8;
                    if (z5 || i21 < (i15 - i19) + 1 || i21 > (i15 + i19) - 1 || iArr3[i23] < iArr4[i23]) {
                        i21 += 2;
                        z4 = false;
                        i16 = i22;
                        i12 = i11;
            ...
            while (i28 <= i19) {
                ...
                if (i29 != i19 + i15) {
                    ...
                    int i30 = i5 + i29;
                    iArr4[i30] = i6;
                    if (!z5 || i29 < i20 || i29 > i19 || iArr3[i30] < iArr4[i30]) {
                        i28 += 2;
                        z6 = false;
                    } else {
                        Snake snake2 = new Snake();
                        ...
                        snake2.size = iArr3[i30] - iArr4[i30];
                        snake2.removal = z;
                        snake2.reverse = true;
                        return snake2;
                    }
