    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                childAt.measure(layoutParams.width == -2 ? View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, Integer.MIN_VALUE) : layoutParams.width == -1 ? View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, 1073741824) : View.MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824), layoutParams.height == -2 ? View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE) : layoutParams.height == -1 ? View.MeasureSpec.makeMeasureSpec(i3, 1073741824) : View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824));
                int measuredWidth = childAt.getMeasuredWidth();
                ...
                if (childAt2.getVisibility() != i5) {
                    ...
                    if (childAt2.getVisibility() != i5) {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    if (!z2) {
                                        ...
                                        i6 = i15;
                                        childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i12))) / f)), 1073741824), i7);
                                        i16++;
                                        i15 = i6;
                                        i5 = 8;
                                    }
                                } else {
                                    i8 = layoutParams2.height == -1 ? View.MeasureSpec.makeMeasureSpec(i3, 1073741824) : View.MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824);
                                }
                                i7 = i8;
                                if (!z2) {
                                }
                            ...
                            childAt2.measure(View.MeasureSpec.makeMeasureSpec(i15, i9), i10);
                        }
                    }
                }
                i6 = i15;
