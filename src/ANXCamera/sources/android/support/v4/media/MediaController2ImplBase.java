...
class MediaController2ImplBase implements MediaController2.SupportLibraryImpl {
    ...
    /* access modifiers changed from: package-private */
    public void onConnectedNotLocked(IMediaSession2 iMediaSession2, SessionCommandGroup2 sessionCommandGroup2, int i, MediaItem2 mediaItem2, long j, long j2, float f, long j3, MediaController2.PlaybackInfo playbackInfo, int i2, int i3, List<MediaItem2> list, PendingIntent pendingIntent) {
        IMediaSession2 iMediaSession22 = iMediaSession2;
        final SessionCommandGroup2 sessionCommandGroup22 = sessionCommandGroup2;
        if (DEBUG) {
            Log.d(TAG, "onConnectedNotLocked sessionBinder=" + iMediaSession22 + ", allowedCommands=" + sessionCommandGroup22);
        }
