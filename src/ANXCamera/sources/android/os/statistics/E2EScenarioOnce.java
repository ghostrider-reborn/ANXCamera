...
public class E2EScenarioOnce extends MacroscopicEvent<E2EScenarioOnceDetails> {
    ...
    public static class E2EScenarioOnceDetails extends PerfEvent.DetailFields {
        ...
        public void readFromParcel(Parcel source) {
            ...
            this.scenario = (E2EScenario) source.readParcelable((ClassLoader) null);
            this.settings = (E2EScenarioSettings) source.readParcelable((ClassLoader) null);
            this.tag = source.readString();
            this.payload = (E2EScenarioPayload) source.readParcelable((ClassLoader) null);
            boolean z = true;
            if (source.readInt() != 1) {
                z = false;
            }
