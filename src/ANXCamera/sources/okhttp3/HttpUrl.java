    ...
    public static final class Builder {
        ...
        public ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset(str2, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace) != -1) {
                ...
                } else if (!str2.regionMatches(true, skipLeadingAsciiWhitespace, "http:", 0, 5)) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z) {
                                    ...
                                    i3 = delimiterOffset;
                                    String canonicalize = HttpUrl.canonicalize(str2, i4, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                    if (z2) {
                                        canonicalize = this.encodedUsername + "%40" + canonicalize;
                                    }
                                    this.encodedUsername = canonicalize;
                                    if (i5 != i3) {
                                        this.encodedPassword = HttpUrl.canonicalize(str2, i5 + 1, i3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                        z = true;
                                    }
                                    z2 = true;
                                } else {
                                    i3 = delimiterOffset;
                                    this.encodedPassword += "%40" + HttpUrl.canonicalize(str2, i4, i3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                }
                                i4 = i3 + 1;
                                continue;
                        }
            ...
            if (delimiterOffset3 >= skipTrailingAsciiWhitespace || str2.charAt(delimiterOffset3) != '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str2, delimiterOffset3 + 1, i2, HttpUrl.QUERY_ENCODE_SET, true, false, true, true, (Charset) null));
            }
            if (i2 < skipTrailingAsciiWhitespace && str2.charAt(i2) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str2, i2 + 1, skipTrailingAsciiWhitespace, "", true, false, false, false, (Charset) null);
            }
