...
public enum NotificationLite {
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onError(((ErrorNotification) obj).f342e);
            return true;
        } else {
            observer.onNext(obj);
            return false;
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        if (obj == COMPLETE) {
            ...
            subscriber.onError(((ErrorNotification) obj).f342e);
            return true;
        } else {
    ...
    public static <T> boolean acceptFull(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onSubscribe(((DisposableNotification) obj).f341d);
            return false;
        } else {
            observer.onNext(obj);
            return false;
    ...
    public static Disposable getDisposable(Object obj) {
        return ((DisposableNotification) obj).f341d;
    }

    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f342e;
    }
