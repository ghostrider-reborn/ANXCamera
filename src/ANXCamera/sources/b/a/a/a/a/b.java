...
public final class b {
    ...
    public final boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        return this.value == bVar.value && HidlSupport.deepEquals(this.yA, bVar.yA);
    }

    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.value))), Integer.valueOf(HidlSupport.deepHashCode(this.yA))});
    }
    ...
    public final String toString() {
        return "{" + ".value = " + e.toString(this.value) + ", .fileList = " + this.yA + "}";
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        for (int i = 0; i < size; i++) {
            this.yA.get(i).writeEmbeddedToBlob(hwBlob2, (long) (i * 32));
        }
