...
.method private check(ZLjava/lang/String;)V
    ...
    new-instance v1, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$1;

    invoke-direct {v1, p0}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$1;-><init>(Lorg/webrtc/videocodec/MediaCodecVideoEncoder;)V
...
.method private dequeueFrame()Lorg/webrtc/videocodec/MediaCodecVideoEncoder$Frame;
    ...
    check-cast v1, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$Frame;
...
.method private hasFrame()Z
    ...
    :try_start_1
    iget-object v2, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->frameQueue:Ljava/util/LinkedList;
    ...
    const-string v3, "frameQueue.wait exception"
...
.method private logInfoEnable()Z
    ...
    iget-wide v4, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->frameNum:J
...
.method private pushBuffer([BIJJIII)V
    ...
    invoke-direct {v0}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->logInfoEnable()Z
    ...
    invoke-virtual {v1, v2}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$EncodeHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private setCodecState(IILorg/webrtc/videocodec/MediaCodecVideoEncoder$CodecName;II)Z
    ...
    const-string p1, "setCodecState"

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "Init---framerate:"
    ...
    invoke-virtual {p3}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$CodecName;->ordinal()I
    ...
    invoke-virtual {p2, p3, v0}, Landroid/media/MediaFormat;->setString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p3, p5, p5, p4}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    sget-object p3, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->TAG:Ljava/lang/String;

    const-string p4, "Failed to create MediaCodec for VP8."
...
.method private start(IIII)Z
    ...
    iget-object p1, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->pushhandler:Lorg/webrtc/videocodec/MediaCodecVideoEncoder$EncodeHandler;

    iget-object p2, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->pushhandler:Lorg/webrtc/videocodec/MediaCodecVideoEncoder$EncodeHandler;

    const/4 p3, 0x1

    invoke-virtual {p2, p3}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$EncodeHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p2

    invoke-virtual {p1, p2}, Lorg/webrtc/videocodec/MediaCodecVideoEncoder$EncodeHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private validCodec(Landroid/media/MediaCodec;)Z
    ...
    const-string v0, "validCodec codec is null."
...
.method public dispose()V
    ...
    iget-object v1, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->timeMap:Ljava/util/Map;
...
.method public getView()Landroid/view/SurfaceView;
    ...
    iget-object v0, p0, Lorg/webrtc/videocodec/MediaCodecVideoEncoder;->surfaceView:Landroid/view/SurfaceView;
