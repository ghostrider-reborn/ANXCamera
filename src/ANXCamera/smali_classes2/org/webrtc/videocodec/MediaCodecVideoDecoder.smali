...
.method private check(ZLjava/lang/String;)V
    ...
    new-instance v1, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$1;

    invoke-direct {v1, p0}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$1;-><init>(Lorg/webrtc/videocodec/MediaCodecVideoDecoder;)V
...
.method private dequeueFrame()Lorg/webrtc/videocodec/MediaCodecVideoDecoder$Frame;
    ...
    check-cast v1, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$Frame;
...
.method private hasFrame()Z
    ...
    :try_start_1
    iget-object v2, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->frameQueue:Ljava/util/LinkedList;
...
.method private logInfoEnable()Z
    ...
    iget-wide v4, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->frameNum:J
...
.method private pushBuffer(Ljava/nio/ByteBuffer;IJJIII)V
    ...
    invoke-direct {v0}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->logInfoEnable()Z
    ...
    invoke-virtual {v0, v2}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {v1, v0}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private setCodecState(IILorg/webrtc/videocodec/MediaCodecVideoDecoder$CodecName;)Z
    ...
    invoke-virtual {p3}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$CodecName;->ordinal()I
    ...
    invoke-virtual {p3, v2, v3}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V
    ...
    sget-object p2, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->TAG:Ljava/lang/String;
...
.method private start(II)Z
    ...
    iget-object p1, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->pushhandler:Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;

    iget-object p2, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->pushhandler:Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;

    const/4 v0, 0x1

    invoke-virtual {p2, v0}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p2

    invoke-virtual {p1, p2}, Lorg/webrtc/videocodec/MediaCodecVideoDecoder$DecodeHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public dispose()V
    ...
    iget-object v1, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->timeMap:Ljava/util/Map;
...
.method public getView()Landroid/view/SurfaceView;
    ...
    iget-object v0, p0, Lorg/webrtc/videocodec/MediaCodecVideoDecoder;->surfaceView:Landroid/view/SurfaceView;
