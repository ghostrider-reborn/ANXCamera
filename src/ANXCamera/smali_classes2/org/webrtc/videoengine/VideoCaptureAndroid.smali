...
.method public constructor <init>(Landroid/content/Context;IJ)V
    ...
    iput-boolean v2, p0, Lorg/webrtc/videoengine/VideoCaptureAndroid;->firstFrame:Z
    ...
    invoke-virtual {p2}, Lorg/webrtc/videoengine/VideoCaptureAndroid$CameraThread;->start()V
...
.method private getCurrentVideoZoomFactorOnCameraThread(Ljava/util/concurrent/Exchanger;)V
    ...
    const-string v2, "setVideoZoomFactor is not suppored."
    ...
    const-string v3, "The current zoom value is: "
...
.method private getSupportedVideoZoomMaxFactorOnCameraThread(Ljava/util/concurrent/Exchanger;)V
    ...
    const-string v2, "setVideoZoomFactor is not supported."
    ...
    const-string v3, "The max zoom value is: "
...
.method private setExposurePointOfInterestOnCameraThread(FF)V
    ...
    const-string p2, "SettingMeteringArea is not supported."
    ...
    invoke-direct {p0, v3, v1}, Lorg/webrtc/videoengine/VideoCaptureAndroid;->clamp(II)I
    ...
    invoke-direct {p0, v2, v1}, Lorg/webrtc/videoengine/VideoCaptureAndroid;->clamp(II)I
    ...
    add-int/lit16 p2, v3, 0x12c

    add-int/lit16 v2, v1, 0x12c

    invoke-direct {p1, v3, v1, p2, v2}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    const-string p2, "Unable to setExposurePointOfInterest."
...
.method private setFlashStateOnCameraThread(Z)V
    ...
    const-string v0, "Flash mode setting is not supported."
    ...
    const-string v0, "Failed to turn the flash on!"
...
.method private setFocusPointOfInterestOnCameraThread(FF)V
    ...
    const-string p2, "SetFocusArea is not supported"
    ...
    const-string p2, "Unable to setFocusPointOfInterest."
...
.method private setPreviewDisplayOnCameraThread(Landroid/view/SurfaceHolder;Ljava/util/concurrent/Exchanger;)V
    ...
    invoke-static {p2, p1}, Lorg/webrtc/videoengine/VideoCaptureAndroid;->exchange(Ljava/util/concurrent/Exchanger;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private setVideoZoomFactorOnCameraThread(I)V
    ...
    const-string v0, "setVideoZoomFactor is not supported."
    ...
    const-string v1, ", and the set zoom value is: "
    ...
    const-string v0, "setVideoZoomFacor failed."
...
.method private startCapture(IIII)Z
    ...
    invoke-static {v7, p1}, Lorg/webrtc/videoengine/VideoCaptureAndroid;->exchange(Ljava/util/concurrent/Exchanger;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private startCaptureOnCameraThread(IIIILjava/util/concurrent/Exchanger;)V
    ...
    iget-object v2, p0, Lorg/webrtc/videoengine/VideoCaptureAndroid;->dummySurfaceTexture:Landroid/graphics/SurfaceTexture;
    ...
    :goto_2
    const-string p2, "WEBRTC-JC-VideoCaptureAndroid"
...
.method private stopCaptureOnCameraThread(Ljava/util/concurrent/Exchanger;)V
    ...
    iget-object v0, p0, Lorg/webrtc/videoengine/VideoCaptureAndroid;->deviceRotationNotifier:Landroid/view/OrientationEventListener;
