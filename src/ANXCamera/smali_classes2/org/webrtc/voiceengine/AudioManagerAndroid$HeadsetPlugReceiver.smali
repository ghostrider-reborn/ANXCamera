...
.method constructor <init>(Lorg/webrtc/voiceengine/AudioManagerAndroid;Lorg/webrtc/voiceengine/HeadsetPlugHandler;Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object p2, p0, Lorg/webrtc/voiceengine/AudioManagerAndroid$HeadsetPlugReceiver;->mProfileListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;

    const/4 v0, 0x1

    invoke-virtual {p1, p3, p2, v0}, Landroid/bluetooth/BluetoothAdapter;->getProfileProxy(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;I)Z
    :try_end_0
...
.method public HeadsetMessageHandler(I)V
    ...
    const-string v1, "updateAudioDevice: MSG_SCO_AUDIO_STATE_DISCONNECTED"
    ...
    iput-boolean v0, p0, Lorg/webrtc/voiceengine/AudioManagerAndroid$HeadsetPlugReceiver;->mIsBluetoothHeadsetAvailable:Z
    ...
    invoke-interface {p1, v0}, Lorg/webrtc/voiceengine/HeadsetPlugHandler;->onBluetoothHeadsetPlugChange(Z)V
    ...
    const-string v0, "updateAudioDevice: MSG_SCO_AUDIO_STATE_CONNECTED"
    ...
    invoke-interface {p1, v1}, Lorg/webrtc/voiceengine/HeadsetPlugHandler;->onBluetoothHeadsetPlugChange(Z)V
    ...
    const-string v0, "updateAudioDevice: MSG_BLUETOOTH_HEADSET_DISCONNECTED"
    ...
    const-string v0, "updateAudioDevice: MSG_BLUETOOTH_HEADSET_CONNECTED"
    ...
    const-string v1, "updateAudioDevice: MSG_EARPHONE_UNPLUGGED"
    ...
    invoke-interface {p1, v0}, Lorg/webrtc/voiceengine/HeadsetPlugHandler;->onHeadsetPlugChange(Z)V
    ...
    const-string v0, "updateAudioDevice: MSG_EARPHONE_PLUGGED"

    invoke-static {p1, v0}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object p1, p0, Lorg/webrtc/voiceengine/AudioManagerAndroid$HeadsetPlugReceiver;->callback:Lorg/webrtc/voiceengine/HeadsetPlugHandler;

    invoke-interface {p1, v1}, Lorg/webrtc/voiceengine/HeadsetPlugHandler;->onHeadsetPlugChange(Z)V
...
.method public destroy()V
    ...
    iget-object v0, p0, Lorg/webrtc/voiceengine/AudioManagerAndroid$HeadsetPlugReceiver;->mAudioManager:Landroid/media/AudioManager;
